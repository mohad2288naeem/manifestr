!function (e) {
    ...
    function e(r, n) {
        if (!(this instanceof e))
            return new e(r, n);
        this.options = n = n ? Ri(n) : {},
            Ri(rl, n, !1),
            d(n);
        var i = n.value;
        "string" == typeof i && (i = new kl(i, n.mode, null, n.lineSeparator)),
            this.doc = i;
        ...
        xo && 11 > Co && setTimeout(function () {
            ...
            Zn(this, i),
            n.autofocus && !Oo || a.hasFocus() ? setTimeout(Bi(mr, this), 20) : yr(this);
        for (var c in nl)
            nl.hasOwnProperty(c) && nl[c](this, n[c], il);
        C(this),
            n.finishInit && n.finishInit(this);
        for (var h = 0; h < al.length; ++h)
            al[h](this);
        St(this),
            So && n.lineWrapping && "optimizelegibility" == getComputedStyle(l.lineDiv).textRendering && (l.lineDiv.style.textRendering = "auto")
    }
    function t(e, t, r) {
        var n = this;
        this.input = r,
            n.scrollbarFiller = Ki("div", null, "CodeMirror-scrollbar-filler"),
            n.scrollbarFiller.setAttribute("cm-not-content", "true"),
            n.gutterFiller = Ki("div", null, "CodeMirror-gutter-filler"),
            n.gutterFiller.setAttribute("cm-not-content", "true"),
            n.lineDiv = Ki("div", null, "CodeMirror-code"),
            n.selectionDiv = Ki("div", null, null, "position: relative; z-index: 1"),
            n.cursorDiv = Ki("div", null, "CodeMirror-cursors"),
            n.measure = Ki("div", null, "CodeMirror-measure"),
            n.lineMeasure = Ki("div", null, "CodeMirror-measure"),
            n.lineSpace = Ki("div", [n.measure, n.lineMeasure, n.selectionDiv, n.cursorDiv, n.lineDiv], null, "position: relative; outline: none"),
            n.mover = Ki("div", [Ki("div", [n.lineSpace], "CodeMirror-lines")], null, "position: relative"),
            n.sizer = Ki("div", [n.mover], "CodeMirror-sizer"),
            n.sizerWidth = null,
            n.heightForcer = Ki("div", null, null, "position: absolute; height: " + zl + "px; width: 1px;"),
            n.gutters = Ki("div", null, "CodeMirror-gutters"),
            n.lineGutter = null,
            n.scroller = Ki("div", [n.sizer, n.heightForcer, n.gutters], "CodeMirror-scroll"),
            n.scroller.setAttribute("tabIndex", "-1"),
            n.wrapper = Ki("div", [n.scrollbarFiller, n.gutterFiller, n.scroller], "CodeMirror"),
            xo && 8 > Co && (n.gutters.style.zIndex = -1,
                n.scroller.style.paddingRight = 0),
            So || yo && Oo || (n.scroller.draggable = !0),
    ...
    function i(e) {
        e.options.lineWrapping ? (es(e.display.wrapper, "CodeMirror-wrap"),
            e.display.sizer.style.minWidth = "",
            e.display.sizerWidth = null) : (Jl(e.display.wrapper, "CodeMirror-wrap"),
                f(e)),
            l(e),
            It(e),
            at(e),
    ...
    function g(e, t, r) {
        ...
        e(n),
            ...
            xo && 8 > Co && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px")
    }
    function v() { }
    function m(t) {
        t.display.scrollbars && (t.display.scrollbars.clear(),
            t.display.scrollbars.addClass && Jl(t.display.wrapper, t.display.scrollbars.addClass)),
            t.display.scrollbars = new e.scrollbarModel[t.options.scrollbarStyle](function (e) {
                ...
                , t),
            t.display.scrollbars.addClass && es(t.display.wrapper, t.display.scrollbars.addClass)
    }
    function y(e, t) {
        t || (t = p(e));
    ...
    function w(e, t, r) {
        ...
        if (r && r.ensure) {
            var s = r.ensure.from.line
                , a = r.ensure.to.line;
            o > s ? (o = s,
                l = ni(t, ii(Qn(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = ni(t, ii(Qn(t, a)) - e.wrapper.clientHeight),
                    l = a)
        }
        return {
            from: o,
    ...
    function k(e) {
        ...
        !t.scrollbarsClipped && t.scroller.offsetWidth && (t.nativeBarWidth = t.scroller.offsetWidth - t.scroller.clientWidth,
            t.heightForcer.style.height = Xe(e) + "px",
            t.sizer.style.marginBottom = -t.nativeBarWidth + "px",
            t.sizer.style.borderRightWidth = Xe(e) + "px",
    ...
    function M(e, t) {
        ...
        if (t.editorIsHidden)
            return Ft(e),
                !1;
        if (!t.force && t.visible.from >= r.viewFrom && t.visible.to <= r.viewTo && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo) && r.renderedView == r.view && 0 == Ut(e))
            return !1;
        C(e) && (Ft(e),
            t.dims = H(e));
        ...
        Gt(e, o, l),
            r.viewOffset = ii(Qn(e.doc, r.viewFrom)),
        ...
        return a > 4 && (r.lineDiv.style.display = "none"),
            P(e, r.updateLineNumbers, t.dims),
            a > 4 && (r.lineDiv.style.display = ""),
            r.renderedView = r.view,
            u && Yi() != u && u.offsetHeight && u.focus(),
            ji(r.cursorDiv),
            ji(r.selectionDiv),
    ...
    function N(e, t) {
        for (var r = t.viewport, n = !0; (n && e.options.lineWrapping && t.oldDisplayWidth != Ye(e) || (r && null != r.top && (r = {
            top: Math.min(e.doc.height + Ke(e.display) - _e(e), r.top)
        }),
            t.visible = w(e.display, e.doc, r),
            !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && M(e, t); n = !1) {
            O(e);
            var i = p(e);
            Pe(e),
                y(e, i),
    ...
    function A(e, t) {
        e.display.sizer.style.minHeight = t.docHeight + "px",
            ...
            e.display.gutters.style.height = t.docHeight + e.display.barHeight + Xe(e) + "px"
    }
    function O(e) {
    ...
    function P(e, t, r) {
        function n(t) {
            var r = t.nextSibling;
            return So && Do && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
                r
        }
        for (var i = e.display, o = e.options.lineNumbers, l = i.lineDiv, s = l.firstChild, a = i.view, u = i.viewFrom, c = 0; c < a.length; c++) {
            ...
            if (h.hidden)
                ...
                h.changes && (Pi(h.changes, "gutter") > -1 && (f = !1),
                    E(e, h, u, r)),
                    f && (ji(h.lineNumber),
                        h.lineNumber.appendChild(document.createTextNode(S(e.options, u)))),
    ...
    function I(e) {
        return e.node == e.text && (e.node = Ki("div", null, null, "position: relative"),
            e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text),
            e.node.appendChild(e.text),
            xo && 8 > Co && (e.node.style.zIndex = 2)),
            e.node
    }
    function z(e) {
    ...
    function G(e, t, r, n) {
        if (t.gutter && (t.node.removeChild(t.gutter),
            ...
            t.line.gutterClass) {
            var i = I(t);
            t.gutterBackground = Ki("div", null, "CodeMirror-gutter-background " + t.line.gutterClass, "left: " + (e.options.fixedGutter ? n.fixedPos : -n.gutterTotalWidth) + "px; width: " + n.gutterTotalWidth + "px"),
        ...
        if (e.options.lineNumbers || o) {
            ...
            if (e.display.input.setUneditable(l),
                ...
                !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(Ki("div", S(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                o)
        ...
        if (l && n.ranges.length > 1)
            if (Uo && Uo.text.join("\n") == t) {
                if (n.ranges.length % Uo.text.length == 0) {
                    a = [];
                    for (var u = 0; u < Uo.text.length; u++)
                        a.push(o.splitLines(Uo.text[u]))
                }
            } else
                s.length == n.ranges.length && (a = Ei(s, function (e) {
                    return [e]
                }));
            ...
            for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
                ...
                if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(Qn(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Br(e, i.head.line, "smart"));
    ...
    function ne() {
        ...
        return So ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
            Ao && (e.style.border = "1px solid black"),
            te(e),
            t
    }
    function ie(e) {
    ...
    function se(e, t, r) {
        ...
        if (t == e.display.lineDiv) {
            if (n = e.display.lineDiv.childNodes[r],
                !n)
                return le(e.clipPos(Bo(e.display.viewTo - 1)), !0);
            t = null,
                r = 0
        } else
    ...
    function ae(e, t, r) {
        function n(t, r, n) {
            for (var i = -1; i < (c ? c.length : 0); i++)
                for (var o = 0 > i ? u.map : c[i], l = 0; l < o.length; l += 3) {
                    var s = o[l + 2];
                    if (s == t || s == r) {
                        var a = ri(0 > i ? e.line : e.rest[i])
                            , h = o[l] + n;
                        return (0 > n || s != t) && (h = o[l + (n ? 1 : 0)]),
                            Bo(a, h)
                    }
                }
        }
        ...
        for (s || 1 != t.childNodes.length || 3 != t.firstChild.nodeType || (s = t.firstChild,
            r && (r = s.nodeValue.length)); a.parentNode != i;)
            a = a.parentNode;
        var u = e.measure
            , c = u.maps
            , h = n(s, a, r);
    ...
    function ue(e, t, r, n, i) {
        ...
        for (var s = "", a = !1, u = e.doc.lineSeparator(); l(t),
            t != r;)
            t = t.nextSibling;
        return s
    }
    ...
    function fe(e, t) {
        ...
        for (var n = 1; n < e.length; n++) {
            ...
            if (Go(o.to(), i.from()) >= 0) {
                ...
                t >= n && --t,
                    e.splice(--n, 2, new he(a ? s : l, a ? l : s))
            }
        }
        return new ce(e, t)
    }
    ...
    function ve(e, t) {
        var r = e.ch;
        return null == r || r > t ? Bo(e.line, t) : 0 > r ? Bo(e.line, 0) : e
    }
    function me(e, t) {
    ...
    function xe(e, t, r) {
        for (var n = [], i = 0; i < e.sel.ranges.length; i++)
            n[i] = be(e, e.sel.ranges[i], t[i], null);
        ...
        var n = {
            ...
            update: function (t) {
                ...
                for (var r = 0; r < t.length; r++)
                    this.ranges[r] = new he(ge(e, t[r].anchor), ge(e, t[r].head))
            },
            origin: r && r.origin
        };
        return El(e, "beforeSelectionChange", e, n),
            e.cm && El(e.cm, "beforeSelectionChange", e.cm, n),
    ...
    function ke(e, t, r) {
        Me(e, t, r),
            fi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r)
    }
    function Me(e, t, r) {
            ...
            for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if ((null == s.from || (a.inclusiveLeft ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (a.inclusiveRight ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (r) {
                        ...
                        if ((0 > n ? a.inclusiveRight : a.inclusiveLeft) && (c = He(e, c, -n, c && c.line == t.line ? o : null)),
                            c && c.line == t.line && (u = Go(c, r)) && (0 > n ? 0 > u : u > 0))
                            return Oe(e, c, t, n, i)
                    }
                    var h = a.find(0 > n ? -1 : 1);
                    return (0 > n ? a.inclusiveLeft : a.inclusiveRight) && (h = He(e, h, n, h.line == t.line ? o : null)),
                        h ? Oe(e, h, t, n, i) : null
                }
            }
        return t
    ...
    function He(e, t, r, n) {
        return 0 > r && 0 == t.ch ? t.line > e.first ? ge(e, Bo(t.line - 1)) : null : r > 0 && t.ch == (n || Qn(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? Bo(t.line + 1, 0) : null : new Bo(t.line, t.ch + r)
    }
    function Pe(e) {
        ...
        for (var r = e.doc, n = {}, i = n.cursors = document.createDocumentFragment(), o = n.selection = document.createDocumentFragment(), l = 0; l < r.sel.ranges.length; l++)
            if (t !== !1 || l != r.sel.primIndex) {
                ...
                if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
                    var a = s.empty();
                    (a || e.options.showCursorWhenSelecting) && Ie(e, s.head, i),
                        a || ze(e, s, o)
                }
            }
        return n
    ...
    function ze(e, t, r) {
        function n(e, t, r, n) {
            0 > t && (t = 0),
                t = Math.round(t),
                n = Math.round(n),
                s.appendChild(Ki("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == r ? c - e : r) + "px; height: " + (n - t) + "px"))
        }
        function i(t, r, i) {
            function o(r, n) {
                return dt(e, Bo(t, r), "div", h, n)
            }
            var s, a, h = Qn(l, t), f = h.text.length;
            return ro(oi(h), r || 0, null == i ? f : i, function (e, t, l) {
                ...
                null == r && 0 == e && (d = u),
                    h.top - g.top > 3 && (n(d, g.top, null, g.bottom),
                        d = u,
                        g.bottom < h.top && n(d, g.bottom, null, h.top)),
                    null == i && t == f && (p = c),
                    (!s || g.top < s.top || g.top == s.top && g.left < s.left) && (s = g),
                    (!a || h.bottom > a.bottom || h.bottom == a.bottom && h.right > a.right) && (a = h),
                    u + 1 > d && (d = u),
                    n(d, h.top, p - d, h.bottom)
            }),
            {
                start: s,
                end: a
        ...
        if (h.line == f.line)
            ...
            g && (v.top < m.top - 2 ? (n(v.right, v.top, null, v.bottom),
                n(u, m.top, m.left, m.bottom)) : n(v.right, v.top, m.left - v.right, v.bottom)),
            ...
            t.iter(t.frontier, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                if (t.frontier >= e.display.viewFrom) {
                    ...
                    for (var h = !l || l.length != o.styles.length || u != c && (!u || !c || u.bgClass != c.bgClass || u.textClass != c.textClass), f = 0; !h && f < l.length; ++f)
                        h = l[f] != o.styles[f];
                    h && i.push(t.frontier),
                        o.stateAfter = s ? n : cl(t.mode, n)
                } else
                    o.text.length <= e.options.maxHighlightLength && zn(e, o.text, n),
                        o.stateAfter = t.frontier % 5 == 0 ? cl(t.mode, n) : null;
                return ++t.frontier,
                    +new Date > r ? (Re(e, e.options.workDelay),
                        !0) : void 0
            }),
    ...
    function Ue(e, t, r) {
        ...
        return l = l ? cl(n.mode, l) : hl(n.mode),
            n.iter(o, t, function (r) {
                zn(e, r.text, l);
                var s = o == t - 1 || o % 5 == 0 || o >= i.viewFrom && o < i.viewTo;
                r.stateAfter = s ? cl(n.mode, l) : null,
                    ++o
            }),
            r && (n.frontier = o),
            l
    ...
    function Ze(e, t) {
        ...
        return n.text = i.pre,
            Xi(e.display.lineMeasure, i.pre),
            n
    }
    function Qe(e, t, r, n) {
    ...
    function et(e, t) {
        var r = ri(t)
            , n = Je(e, r);
        n && !n.text ? n = null : n && n.changes && (E(e, n, r, H(e)),
    ...
    function tt(e, t, r, n, i) {
        ...
        return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
            t.hasHeights || (qe(e, t.view, t.rect),
                t.hasHeights = !0),
            o = it(e, t, r, n),
            o.bogus || (t.cache[l] = o)),
        {
    ...
    function rt(e, t, r) {
        for (var n, i, o, l, s = 0; s < e.length; s += 3) {
            ...
            if (a > t ? (i = 0,
                o = 1,
                l = "left") : u > t ? (i = t - a,
                    o = i + 1) : (s == e.length - 3 || t == u && e[s + 3] > t) && (o = u - a,
                        i = o - 1,
                        t >= u && (l = "right")),
                null != i) {
                if (n = e[s + 2],
    ...
    function it(e, t, r, n) {
        ...
        if (3 == l.nodeType) {
            for (var c = 0; 4 > c; c++) {
                for (; s && Vi(t.line.text.charAt(o.coverStart + s));)
                    --s;
                for (; o.coverStart + a < o.coverEnd && Vi(t.line.text.charAt(o.coverStart + a));)
                    ++a;
                if (i = xo && 9 > Co && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : nt(Xl(l, s, a).getClientRects(), n),
                    i.left || i.right || 0 == s)
                    break;
                a = s,
                    s -= 1,
    ...
    function ot(e, t) {
        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !to(e))
            return t;
    ...
    function ht(e, t, r, n) {
        ...
        n || (n = "local");
        var l = ii(t);
        if ("local" == n ? l += Ve(e.display) : l -= e.display.viewOffset,
            "page" == n || "window" == n) {
    ...
    function dt(e, t, r, n, i) {
        return n || (n = Qn(e.doc, t.line)),
            ht(e, n, Qe(e, n, t.ch, i), r)
    }
    function pt(e, t, r, n, i, o) {
        ...
        function s(e, t) {
            var r = a[t]
                , n = r.level % 2;
            return e == no(r) && t && r.level < a[t - 1].level ? (r = a[--t],
                e = io(r) - (r.level % 2 ? 0 : 1),
                n = !0) : e == io(r) && t < a.length - 1 && r.level < a[t + 1].level && (r = a[++t],
                    e = no(r) - r.level % 2,
                    n = !1),
    ...
    function mt(e, t, r) {
        var n = e.doc;
        if (r += e.display.viewOffset,
            0 > r)
            return vt(n.first, 0, !0, -1);
        var i = ni(n, r)
            , o = n.first + n.size - 1;
        if (i > o)
            return vt(n.first + n.size - 1, Qn(n, o).text.length, !0, 1);
        0 > t && (t = 0);
        for (var l = Qn(n, i); ;) {
            var s = yt(e, l, i, t, r)
                , a = mn(l)
    ...
    function yt(e, t, r, n, i) {
        ...
        if (n > v)
            return vt(r, d, m, 1);
        for (; ;) {
            if (c ? d == f || d == po(t, f, 1) : 1 >= d - f) {
                var y = p > n || v - n >= n - p ? f : d
                    , b = y == f ? g : m
                    , w = n - (y == f ? p : v);
                if (m && !c && !/\s/.test(t.text.charAt(y)) && w > 0 && y < t.text.length && u.view.measure.heights.length > 1) {
                    var x = tt(e, u, y, "right");
                    l <= x.bottom && l >= x.top && Math.abs(n - x.right) < w && (b = !1,
                        y++,
                        w = n - x.right)
                }
                for (; Vi(t.text.charAt(y));)
                    ++y;
                var C = vt(r, y, b, -1 > w ? -1 : w > 1 ? 1 : 0);
                return C
            }
            var S = Math.ceil(h / 2)
                , L = f + S;
    ...
    function Tt(e) {
        ...
        k(t),
            ...
            e.update = e.mustUpdate && new T(t, e.mustUpdate && {
                top: e.scrollTop,
    ...
    function Mt(e) {
        ...
        e.updatedDisplay && O(t),
            e.barMeasure = p(t),
            r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Qe(t, r.maxLine, r.maxLine.text.length).left + 3,
                t.display.sizerWidth = e.adjustWidthTo,
                e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Xe(t) + t.display.barWidth),
                e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Ye(t))),
            (e.updatedDisplay || e.selectionChanged) && (e.preparedSelection = r.input.prepareSelection(e.focus))
    }
    function Nt(e) {
        var t = e.cm;
        null != e.adjustWidthTo && (t.display.sizer.style.minWidth = e.adjustWidthTo + "px",
            e.maxScrollLeft < t.doc.scrollLeft && or(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
        ...
        e.preparedSelection && t.display.input.showSelection(e.preparedSelection, r),
            ...
            e.updatedDisplay && A(t, e.barMeasure),
            e.selectionChanged && Fe(t),
    ...
    function Wt(e) {
        ...
        if (e.updatedDisplay && N(t, e.update),
            ...
            null == e.scrollLeft || r.scroller.scrollLeft == e.scrollLeft && !e.forceScroll || (n.scrollLeft = Math.max(0, Math.min(r.scroller.scrollWidth - r.scroller.clientWidth, e.scrollLeft)),
        ...
        if (o)
            for (var s = 0; s < o.length; ++s)
                o[s].lines.length || El(o[s], "hide");
        if (l)
            for (var s = 0; s < l.length; ++s)
                l[s].lines.length && El(l[s], "unhide");
    ...
    function Pt(e, t, r) {
        this.line = t,
            this.rest = wn(t),
            this.size = this.rest ? ri(Hi(this.rest)) - r + 1 : 1,
    ...
    function It(e, t, r, n) {
        ...
        if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t),
            ...
            t >= i.viewTo)
            Ro && xn(e.doc, t) < i.viewTo && Ft(e);
        else if (r <= i.viewFrom)
            Ro && Cn(e.doc, r + n) > i.viewFrom ? Ft(e) : (i.viewFrom += n,
                i.viewTo += n);
            ...
            var l = Bt(e, t, t, -1)
                , s = Bt(e, r, r + n, 1);
            l && s ? (i.view = i.view.slice(0, l.index).concat(Et(e, l.lineN, s.lineN)).concat(i.view.slice(s.index)),
                i.viewTo += n) : Ft(e)
        }
    ...
    function Bt(e, t, r, n) {
        var i, o = Rt(e, t), l = e.display.view;
        if (!Ro || r == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: r
            };
    ...
    function Gt(e, t, r) {
        var n = e.display
            , i = n.view;
        0 == i.length || t >= n.viewTo || r <= n.viewFrom ? (n.view = Et(e, t, r),
            n.viewFrom = t) : (n.viewFrom > t ? n.view = Et(e, t, n.viewFrom).concat(n.view) : n.viewFrom < t && (n.view = n.view.slice(Rt(e, t))),
                n.viewFrom = t,
                n.viewTo < r ? n.view = n.view.concat(Et(e, n.viewTo, r)) : n.viewTo > r && (n.view = n.view.slice(0, Rt(e, r)))),
            n.viewTo = r
    }
    function Ut(e) {
    ...
    function Vt(e) {
        ...
        var i = e.display;
        Dl(i.scroller, "mousedown", Ot(e, _t)),
            xo && 11 > Co ? Dl(i.scroller, "dblclick", Ot(e, function (t) {
                if (!Mi(e, t)) {
                    var r = Yt(e, t);
        ...
        Dl(i.scroller, "touchstart", function (t) {
            ...
            Dl(i.scroller, "touchend", function (r) {
                ...
                if (o && !Xt(i, r) && null != o.left && !o.moved && new Date - o.start < 300) {
                    ...
                    l = !o.prev || n(o, o.prev) ? new he(s, s) : !o.prev.prev || n(o, o.prev.prev) ? e.findWordAt(s) : new he(Bo(s.line, 0), ge(e.doc, Bo(s.line + 1, 0))),
            ...
            Dl(i.scroller, "touchcancel", t),
            Dl(i.scroller, "scroll", function () {
                i.scroller.clientHeight && (ir(e, i.scroller.scrollTop),
                    or(e, i.scroller.scrollLeft, !0),
                    El(e, "scroll", e))
            }),
        ...
        Dl(s, "keyup", function (t) {
            ...
            Dl(s, "keydown", Ot(e, fr)),
            Dl(s, "keypress", Ot(e, gr)),
            Dl(s, "focus", Bi(mr, e)),
            Dl(s, "blur", Bi(yr, e))
    }
    function Kt(t, r, n) {
    ...
    function Yt(e, t, r, n) {
        var i = e.display;
        if (!r && "true" == Ci(t).getAttribute("cm-not-content"))
            return null;
    ...
    function _t(e) {
        ...
        if (!(Mi(t, e) || r.activeTouch && r.input.supportsTouch())) {
            if (r.shift = e.shiftKey,
                Xt(r, e))
                return void (So || (r.scroller.draggable = !1,
                    setTimeout(function () {
            ...
            if (!Jt(t, e)) {
                ...
                Si(e)) {
                    case 1:
                        ...
                        break;
                    case 2:
                        So && (t.state.lastMiddleDown = +new Date),
                            n && we(t.doc, n),
                            setTimeout(function () {
                                r.input.focus()
                            }, 20),
    ...
    function qt(e, t, r) {
        ...
        var n, i = +new Date;
        jo && jo.time > i - 400 && 0 == Go(jo.pos, r) ? n = "triple" : Ko && Ko.time > i - 400 && 0 == Go(Ko.pos, r) ? (n = "double",
            jo = {
                time: i,
                pos: r
            }) : (n = "single",
    ...
    function $t(e, t, r, n) {
        var i = e.display
            ...
            , l = Ot(e, function (s) {
                So && (i.scroller.draggable = !1),
                    ...
                    Pl(document, "mouseup", l),
                    Pl(i.scroller, "drop", l),
                    Math.abs(t.clientX - s.clientX) + Math.abs(t.clientY - s.clientY) < 10 && (Wl(s),
                        !n && +new Date - 200 < o && we(e.doc, r),
                        So || xo && 9 == Co ? setTimeout(function () {
                            document.body.focus(),
                                i.input.focus()
                        }, 20) : i.input.focus())
            });
        So && (i.scroller.draggable = !0),
            ...
            l.copy = Do ? t.altKey : t.ctrlKey,
            i.scroller.dragDrop && i.scroller.dragDrop(),
            Dl(document, "mouseup", l),
            Dl(i.scroller, "drop", l)
    }
    function Zt(e, t, r, n, i) {
        function o(t) {
            if (0 != Go(v, t))
                if (v = t,
                    "rect" == n) {
                    for (var i = [], o = e.options.tabSize, l = Ul(Qn(u, r.line).text, r.ch, o), s = Ul(Qn(u, t.line).text, t.ch, o), a = Math.min(l, s), d = Math.max(l, s), p = Math.min(r.line, t.line), g = Math.min(e.lastLine(), Math.max(r.line, t.line)); g >= p; p++) {
                        var m = Qn(u, p).text
                            , y = Vl(m, a, o);
                        a == d ? i.push(new he(Bo(p, y), Bo(p, y))) : m.length > y && i.push(new he(Bo(p, y), Bo(p, Vl(m, d, o))))
                    }
                    i.length || i.push(new he(r, r)),
                        ke(u, fe(f.ranges.slice(0, h).concat(i), h), {
                            origin: "*mouse",
                            scroll: !1
                        }),
                        e.scrollIntoView(t)
                    ...
                    if ("single" != n) {
                        if ("double" == n)
                            ...
                            var C = new he(Bo(t.line, 0), ge(u, Bo(t.line + 1, 0)));
                        Go(C.anchor, w) > 0 ? (x = C.head,
                            w = q(b.from(), C.anchor)) : (x = C.anchor,
                                w = _(b.to(), C.head))
                    }
        ...
        function s(t) {
            e.state.selectingText = !1,
                ...
                Wl(t),
                a.input.focus(),
                Pl(document, "mousemove", b),
                Pl(document, "mouseup", x),
        ...
        if (i && !t.shiftKey ? (h = u.sel.contains(r),
            c = h > -1 ? d[h] : new he(r, r)) : (c = u.sel.primary(),
                h = u.sel.primIndex),
            Ho ? t.shiftKey && t.metaKey : t.altKey)
            n = "rect",
                i || (c = new he(r, r)),
                r = Yt(e, t, !0, !0),
                h = -1;
        ...
        e.state.selectingText = x,
            Dl(document, "mousemove", b),
            Dl(document, "mouseup", x)
    }
    function Qt(e, t, r, n) {
        try {
            var i = t.clientX
                        ...
                        if (o) {
                            ...
                            if (Me(t.doc, de(r, r)),
                                ...
                                for (var a = 0; a < u.length; ++a)
                                    Dr(t.doc, "", u[a].anchor, u[a].head, "drag");
    ...
    function tr(e, t) {
        if (xo && (!e.state.draggingText || +new Date - qo < 100))
            return void Ol(t);
        if (!Mi(e, t) && !Xt(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
            t.dataTransfer.effectAllowed = "copyMove",
            t.dataTransfer.setDragImage && !Mo)) {
    ...
    function rr(e, t) {
        ...
        if (r) {
            ...
            Ie(e, r, n),
                e.display.dragCursor || (e.display.dragCursor = Ki("div", null, "CodeMirror-cursors CodeMirror-dragcursors"),
                    e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)),
                Xi(e.display.dragCursor, n)
        }
    }
    function nr(e) {
    ...
    function lr(e, t) {
        ...
        if (n && s || i && a) {
            ...
            if (n && !yo && !ko && null != Zo)
                return i && a && ir(e, Math.max(0, Math.min(l.scrollTop + i * Zo, l.scrollHeight - l.clientHeight))),
                    or(e, Math.max(0, Math.min(l.scrollLeft + n * Zo, l.scrollWidth - l.clientWidth))),
                    (!i || i && a) && Wl(t),
            ...
            if (i && null != Zo) {
                ...
                0 > f ? d = Math.max(0, d + f - 50) : p = Math.min(e.doc.height, p + f + 50),
                    W(e, {
                        top: d,
                        bottom: p
                    })
            }
            20 > $o && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    function ur(e, t, r, n) {
        ...
        return "multi" == o && (e.state.keySeq = t),
            "handled" == o && Ti(e, "keyHandled", e, t, r),
            "handled" != o && "multi" != o || (Wl(r),
                Fe(e)),
            i && !o && /\'$/.test(t) ? (Wl(r),
                !0) : !!o
    }
    function cr(e, t) {
        ...
        return r ? t.shiftKey && !e.state.keySeq ? ur(e, "Shift-" + r, t, function (t) {
            ...
            return ("string" == typeof t ? /^go[A-Z]/.test(t) : t.motion) ? sr(e, t) : void 0
        }) : ur(e, r, t, function (t) {
            return sr(e, t)
        }) : !1
    }
    ...
    function fr(e) {
        ...
        if (t.curOp.focus = Yi(),
            !Mi(t, e)) {
            xo && 11 > Co && 27 == e.keyCode && (e.returnValue = !1);
            var r = e.keyCode;
            t.display.shift = 16 == r || e.shiftKey;
            var n = cr(t, e);
            ko && (el = n ? r : null,
                !n && 88 == r && !os && (Do ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || dr(t)
        }
    }
    function dr(e) {
        function t(e) {
            18 != e.keyCode && e.altKey || (Jl(r, "CodeMirror-crosshair"),
                Pl(document, "keyup", t),
                Pl(document, "mouseover", t))
        }
        var r = e.display.lineDiv;
        es(r, "CodeMirror-crosshair"),
            Dl(document, "keyup", t),
            Dl(document, "mouseover", t)
    }
    function pr(e) {
    ...
    function mr(e) {
        e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1),
            "nocursor" != e.options.readOnly && (e.state.focused || (El(e, "focus", e),
                e.state.focused = !0,
                es(e.display.wrapper, "CodeMirror-focused"),
    ...
    function yr(e) {
        e.state.delayingBlurEvent || (e.state.focused && (El(e, "blur", e),
            e.state.focused = !1,
    ...
    function wr(e, t) {
        return Wi(e, "gutterContextMenu") ? Qt(e, t, "gutterContextMenu", !1) : !1
    }
    function xr(e, t) {
        if (Go(e, t.from) < 0)
            return e;
        ...
        var r = e.line + t.text.length - (t.to.line - t.from.line) - 1
            , n = e.ch;
        return e.line == t.to.line && (n += tl(t).ch - t.to.ch),
            Bo(r, n)
    }
    function Cr(e, t) {
    ...
    function Mr(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != Go(t.from, t.to)) {
            var r = Cr(e, t);
            ci(e, t, r, e.cm ? e.cm.curOp.id : NaN),
                Ar(e, t, r, ln(e, t));
            var n = [];
            $n(e, function (e, r) {
                r || -1 != Pi(n, e.history) || (wi(e.history, t),
                    n.push(e.history)),
                    Ar(e, t, null, ln(e, t))
            })
        }
    ...
    function Nr(e, t, r) {
        if (!e.cm || !e.cm.state.suppressEdits || r) {
            for (var n, i = e.history, o = e.sel, l = "undo" == t ? i.done : i.undone, s = "undo" == t ? i.undone : i.done, a = 0; a < l.length && (n = l[a],
                ...
                ;
            if (a != l.length) {
                for (i.lastOrigin = i.lastSelOrigin = null; n = l.pop(),
                    n.ranges;) {
                    if (di(n, s),
                        r && !n.equals(e.sel))
                        return void ke(e, n, {
                ...
                for (var c = Wi(e, "beforeChange") || e.cm && Wi(e.cm, "beforeChange"), a = n.changes.length - 1; a >= 0; --a) {
                    ...
                    var d = [];
                    $n(e, function (e, t) {
                        t || -1 != Pi(d, e.history) || (wi(e.history, h),
                            d.push(e.history)),
                            Ar(e, h, null, an(e, h))
                    })
                }
    ...
    function Wr(e, t) {
        if (0 != t && (e.first += t,
            e.sel = new ce(Ei(e.sel.ranges, function (e) {
    ...
    function Ar(e, t, r, n) {
        if (e.cm && !e.cm.curOp)
            return Ot(e.cm, Ar)(e, t, r, n);
        if (t.to.line < e.first)
            return void Wr(e, t.text.length - 1 - (t.to.line - t.from.line));
        if (!(t.from.line > e.lastLine())) {
            ...
            t.to.line > o && (t = {
                ...
                t.removed = Jn(e, t.from, t.to),
                r || (r = Cr(e, t)),
                e.cm ? Or(e.cm, t, n) : Yn(e, t, n),
                Me(e, r, Rl)
        }
    }
    function Or(e, t, r) {
        var n = e.doc
            ...
            , a = !1
            , u = l.line;
        e.options.lineWrapping || (u = ri(bn(Qn(n, l.line))),
            n.iter(u, s.line + 1, function (e) {
                return e == i.maxLine ? (a = !0,
                    !0) : void 0
            })),
            n.sel.contains(t.from, t.to) > -1 && Ni(e),
            Yn(n, t, r, o(e)),
            e.options.lineWrapping || (n.iter(u, l.line + t.text.length, function (e) {
                var t = h(e);
        ...
        if (d || f) {
            ...
            d && Ti(e, "change", e, p),
                f && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(p)
        }
    ...
    function Pr(e, t, r, n) {
        ...
        for (var i = 0; 5 > i; i++) {
            var o = !1
                ...
                , u = e.doc.scrollTop
                , c = e.doc.scrollLeft;
            if (null != a.scrollTop && (ir(e, a.scrollTop),
                Math.abs(e.doc.scrollTop - u) > 1 && (o = !0)),
                null != a.scrollLeft && (or(e, a.scrollLeft),
    ...
    function Er(e, t, r, n, i) {
        var o = Ir(e, t, r, n, i);
        null != o.scrollTop && ir(e, o.scrollTop),
            null != o.scrollLeft && or(e, o.scrollLeft)
    }
    function Ir(e, t, r, n, i) {
        ...
        var p = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : o.scroller.scrollLeft
            ...
            , v = n - t > g;
        return v && (n = t + g),
            10 > t ? u.scrollLeft = 0 : p > t ? u.scrollLeft = Math.max(0, t - (v ? 0 : 10)) : n > g + p - 3 && (u.scrollLeft = n + (v ? 0 : 10) - g),
            u
    }
    function zr(e, t, r) {
        null == t && null == r || Rr(e),
    ...
    function Fr(e) {
        ...
        var t = e.getCursor()
            , r = t
            , n = t;
        e.options.lineWrapping || (r = t.ch ? Bo(t.line, t.ch - 1) : t,
            n = Bo(t.line, t.ch + 1)),
            e.curOp.scrollToPos = {
                from: r,
                to: n,
    ...
    function Br(e, t, r, n) {
        var i, o = e.doc;
        null == r && (r = "add"),
            "smart" == r && (o.mode.indent ? i = Ue(e, t) : r = "prev");
        ...
        if (n || /\S/.test(s.text)) {
            if ("smart" == r && (u = o.mode.indent(i, s.text.slice(c.length), s.text),
                u == Fl || u > 150)) {
                if (!n)
                    return;
                r = "prev"
            ...
            u = 0,
                r = "not";
        "prev" == r ? u = t > o.first ? Ul(Qn(o, t - 1).text, null, l) : 0 : "add" == r ? u = a + e.options.indentUnit : "subtract" == r ? u = a - e.options.indentUnit : "number" == typeof r && (u = a + r),
            u = Math.max(0, u);
        var h = ""
            , f = 0;
        ...
        if (u > f && (h += Di(u - f)),
            h != c)
            return Dr(o, h, Bo(t, 0), Bo(t, c.length), "+input"),
                s.stateAfter = null,
                !0;
    ...
    function Gr(e, t, r, n) {
        var i = t
            , o = t;
        return "number" == typeof t ? o = Qn(e, pe(e, t)) : i = ri(t),
            null == i ? null : (n(o, i) && e.cm && zt(e.cm, i, r),
                o)
    }
    function Ur(e, t) {
        ...
        At(e, function () {
            for (var t = n.length - 1; t >= 0; t--)
                Dr(e.doc, "", n[t].from, n[t].to, "+delete");
            Fr(e)
        })
    }
    function Vr(e, t, r, n, i) {
        function o() {
            var t = s + r;
            return t < e.first || t >= e.first + e.size ? !1 : (s = t,
                c = Qn(e, t))
        }
        function l(e) {
            ...
            if (null == t) {
                if (e || !o())
                    return !1;
                a = i ? (0 > r ? lo : oo)(c) : 0 > r ? c.text.length : 0
            } else
                a = t;
            return !0
        }
        ...
        if ("char" == n)
            ...
            for (var h = null, f = "group" == n, d = e.cm && e.cm.getHelper(t, "wordChars"), p = !0; !(0 > r) || l(!p); p = !1) {
    ...
    function _r(e, t, r, n, i) {
        ...
        if (o.replacedWith && (o.collapsed = !0,
            o.widgetNode = Ki("span", [o.replacedWith], "CodeMirror-widget"),
            n.handleMouseEvents || o.widgetNode.setAttribute("cm-ignore-events", "true"),
            n.insertLeft && (o.widgetNode.insertLeft = !0)),
            o.collapsed) {
            if (yn(e, t.line, t, r, o) || t.line != r.line && yn(e, r.line, t, r, o))
        ...
        if (e.iter(a, r.line + 1, function (e) {
            u && o.collapsed && !u.options.lineWrapping && bn(e) == u.display.maxLine && (s = !0),
                o.collapsed && a != t.line && ti(e, 0),
                rn(e, new Jr(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null)),
                ++a
        }),
    ...
    function ln(e, t) {
        ...
        if (!u) {
            ...
            if (v > 0 && s)
                for (var h = 0; h < s.length; ++h)
                    null == s[h].to && (g || (g = [])).push(new Jr(s[h].marker, null, null));
            for (var h = 0; v > h; ++h)
                p.push(g);
            p.push(a)
        }
        ...
        if (e.iter(t.line, r.line + 1, function (e) {
            if (e.markedSpans)
                for (var t = 0; t < e.markedSpans.length; ++t) {
                    ...
                    !r.readOnly || n && -1 != Pi(n, r) || (n || (n = [])).push(r)
                }
        }),
            !n)
            return null;
    ...
    function gn(e, t) {
        ...
        if (n)
            for (var i, o = 0; o < n.length; ++o)
                i = n[o],
                    i.marker.collapsed && null == (t ? i.from : i.to) && (!r || pn(r, i.marker) < 0) && (r = i.marker);
        return r
    }
    function vn(e) {
        return gn(e, !0)
        ...
        if (l)
            for (var s = 0; s < l.length; ++s) {
                ...
                if (a.marker.collapsed) {
                    ...
                    if (!(c >= 0 && 0 >= h || 0 >= c && h >= 0) && (0 >= c && (a.marker.inclusiveRight && i.inclusiveLeft ? Go(u.to, r) >= 0 : Go(u.to, r) > 0) || c >= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? Go(u.from, n) <= 0 : Go(u.from, n) < 0)))
                        return !0
                }
            }
    }
        ...
        if (r)
            for (var n, i = 0; i < r.length; ++i)
                if (n = r[i],
                    ...
                    if (null == n.from)
                        return !0;
                    if (!n.marker.widgetNode && 0 == n.from && n.marker.inclusiveLeft && Ln(e, t, n))
                        return !0
                }
    }
    function Ln(e, t, r) {
        ...
        for (var i, o = 0; o < t.markedSpans.length; ++o)
            if (i = t.markedSpans[o],
                i.marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && Ln(e, t, i))
                return !0
    }
    function Tn(e, t, r) {
    ...
    function kn(e) {
        ...
        if (!$l(document.body, e.node)) {
            ...
            e.coverGutter && (r += "margin-left: -" + t.display.gutters.offsetWidth + "px;"),
                ...
                Xi(t.display.measure, Ki("div", [e.node], null, r))
        }
    ...
    function Hn(e, t, r, n) {
        ...
        t = ge(l, t);
        var a, u = Qn(l, t.line), c = Ue(e, t.line, r), h = new ml(u.text, e.options.tabSize);
        for (n && (a = []); (n || h.pos < t.ch) && !h.eol();)
            h.start = h.pos,
                o = Dn(s, h, c),
                n && a.push(i(!0));
        return n ? a : i()
    ...
    function Pn(e, t, r, n, i, o, l) {
        ...
        var a, u = 0, c = null, h = new ml(t, e.options.tabSize), f = e.options.addModeClass && [null];
        for ("" == t && An(On(r, n), o); !h.eol();) {
            if (h.pos > e.options.maxHighlightLength ? (s = !1,
                l && zn(e, t, n, h.pos),
                h.pos = t.length,
                a = null) : a = An(Dn(r, h, n, f), o),
                f) {
                var d = f[0].name;
                d && (a = "m-" + (a ? d + " " + a : d))
            }
    ...
    function Rn(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            n.pos = 0,
                n.addToken = Gn,
                eo(e.display.measure) && (o = oi(l)) && (n.addToken = Vn(n.addToken, o)),
                n.map = [];
            var s = t != e.display.externalMeasured && ri(l);
            jn(l, n, In(e, l, s)),
                l.styleClasses && (l.styleClasses.bgClass && (n.bgClass = qi(l.styleClasses.bgClass, n.bgClass || "")),
                    l.styleClasses.textClass && (n.textClass = qi(l.styleClasses.textClass, n.textClass || ""))),
                0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Ji(e.display.measure))),
        ...
        return El(e, "renderLine", e, t.line, n.pre),
            n.pre.className && (n.textClass = qi(n.pre.className, n.textClass || "")),
            n
    }
    function Bn(e) {
            ...
            if (a.test(t))
                for (var c = document.createDocumentFragment(), h = 0; ;) {
                    ...
                    if (d) {
                        ...
                        xo && 9 > Co ? c.appendChild(Ki("span", [p])) : c.appendChild(p),
            ...
            for (var l, s, a, u, c, h, f, d = i.length, p = 0, g = 1, v = "", m = 0; ;) {
                if (m == p) {
                    ...
                    for (var y, b = [], w = 0; w < n.length; ++w) {
                        var x = n[w]
                            , C = x.marker;
                        "bookmark" == C.type && x.from == p && C.widgetNode ? b.push(C) : x.from <= p && (null == x.to || x.to > p || C.collapsed && x.to == p && x.from == p) ? (null != x.to && x.to != p && m > x.to && (m = x.to,
                            u = ""),
                            C.className && (a += " " + C.className),
                            C.css && (s = (s ? s + ";" : "") + C.css),
                            C.startStyle && x.from == p && (c += " " + C.startStyle),
                            C.endStyle && x.to == m && (y || (y = [])).push(C.endStyle, x.to),
                            C.title && !h && (h = C.title),
                            C.collapsed && (!f || pn(f.marker, C) < 0) && (f = x)) : x.from > p && m > x.from && (m = x.from)
                    }
                    if (y)
                    ...
                    if (!f || f.from == p)
                        for (var w = 0; w < b.length; ++w)
                            Kn(t, 0, b[w]);
                    if (f && (f.from || 0) == p) {
                        if (Kn(t, (null == f.to ? d + 1 : f.to) - p, f.marker, null == f.from),
                            null == f.to)
                            return;
                        f.to == p && (f = !1)
                    }
                ...
                for (var S = Math.min(d, m); ;) {
                    ...
                    v = i.slice(o, o = r[g++]),
                        l = Fn(r[g++], t.cm.options)
                }
            }
        else
            for (var g = 1; g < r.length; g += 2)
                t.addToken(t, i.slice(o, o = r[g]), Fn(r[g + 1], t.cm.options))
    }
    function Xn(e, t) {
    ...
    function Yn(e, t, r, n) {
        ...
        if (t.full)
            ...
            if (1 == u.length)
                ...
                g.push(new Cl(f + c.text.slice(a.ch), d, n)),
    ...
    function ri(e) {
        if (null == e.parent)
            return null;
        for (var t = e.parent, r = Pi(t.lines, e), n = t.parent; n; t = n,
            n = n.parent)
    ...
    function oi(e) {
        var t = e.order;
        return null == t && (t = e.order = us(e.text)),
            t
    }
    function li(e) {
        this.done = [],
    ...
    function ui(e, t) {
        return t ? (ai(e.done),
            Hi(e.done)) : e.done.length && !Hi(e.done).ranges ? Hi(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(),
                Hi(e.done)) : void 0
    }
    function ci(e, t, r, n) {
        var i = e.history;
        ...
        if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastModTime > l - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0))) && (o = ui(i, i.lastOp == n))) {
            ...
            var a = Hi(i.done);
            for (a && a.ranges || di(e.sel, i.done),
                o = {
                    changes: [si(e, t)],
                    generation: i.generation
                },
    ...
    function fi(e, t, r, n) {
        var i = e.history
            , o = n && n.origin;
        r == i.lastSelOp || o && i.lastSelOrigin == o && (i.lastModTime == i.lastSelTime && i.lastOrigin == o || hi(e, o, Hi(i.done), t)) ? i.done[i.done.length - 1] = t : di(t, i.done),
            i.lastSelTime = +new Date,
            i.lastSelOrigin = o,
            i.lastSelOp = r,
            n && n.clearRedo !== !1 && ai(i.undone)
    }
    function di(e, t) {
        var r = Hi(t);
    ...
    function mi(e, t, r) {
        for (var n = 0, i = []; n < e.length; ++n) {
            var o = e[n];
            if (o.ranges)
                i.push(r ? ce.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes
                    , s = [];
                i.push({
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        t)
                        for (var h in c)
                            (u = h.match(/^spans_(\d+)$/)) && Pi(t, Number(u[1])) > -1 && (Hi(s)[h] = c[h],
                                delete c[h])
                }
            }
        }
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    yi(o.ranges[s].anchor, t, r, n),
                        yi(o.ranges[s].head, t, r, n)
            } else {
                for (var s = 0; s < o.changes.length; ++s) {
                    var a = o.changes[s];
                    if (r < a.from.line)
                        a.from = Bo(a.from.line + n, a.from.ch),
                            a.to = Bo(a.to.line + n, a.to.ch);
                    else if (t <= a.to.line) {
                        l = !1;
                        break
                    }
    ...
    function Ti(e, t) {
        ...
        if (n.length) {
            ...
            Yo ? i = Yo.delayedCallbacks : Il ? i = Il : (i = Il = [],
                setTimeout(ki, 0));
    ...
    function Fi(e, t) {
        var r;
        return Object.create ? r = Object.create(e) : (zi.prototype = e,
            r = new zi),
            t && Ri(t, r),
            r
    }
    ...
    function Gi(e, t) {
        return t ? t.source.indexOf("\\w") > -1 && _l(e) ? !0 : t.test(e) : _l(e)
    }
    function Ui(e) {
        for (var t in e)
    ...
    function Ji(e) {
        if (null == Zl) {
            var t = Ki("span", "​");
            Xi(e, Ki("span", [t, document.createTextNode("x")])),
                0 != e.firstChild.offsetHeight && (Zl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(xo && 8 > Co))
        }
    ...
    function eo(e) {
        ...
        return ji(e),
            r && r.left != r.right ? Ql = n.right - r.right < 3 : !1
    }
    function to(e) {
        if (null != ls)
            return ls;
    ...
    function ho(e, t) {
        ...
        for (var r, n = 0; n < e.length; ++n) {
            ...
            if (i.from == t || i.to == t) {
                if (null != r)
                    return co(e, i.level, e[r].level) ? (i.from != i.to && (as = r),
                        n) : (i.from != i.to && (as = n),
                            r);
                r = n
            }
    ...
    Eo && (Eo = Number(Eo[1])),
        Eo && Eo >= 15 && (ko = !1,
            So = !0);
    var Io = Do && (Lo || ko && (null == Eo || 12.11 > Eo))
        , zo = yo || xo && Co >= 9
        , Fo = !1
        , Ro = !1;
    g.prototype = Ri({
    ...
    re.prototype = Ri({
        init: function (e) {
                ...
                if (!Mi(n, e)) {
                    if (n.somethingSelected())
                        ...
                        Uo = {
                            ...
                            "cut" == e.type ? n.setSelections(t.ranges, null, Rl) : (r.prevInput = "",
                                o.value = t.text.join("\n"),
                                jl(o))
                    }
            ...
            e.wrapper.insertBefore(i, e.wrapper.firstChild),
                Ao && (o.style.width = "0px"),
                Dl(o, "input", function () {
                    xo && Co >= 9 && r.hasSelection && (r.hasSelection = null),
                        r.poll()
                }),
                Dl(o, "paste", function (e) {
                    Mi(n, e) || Q(e, n) || (n.state.pasteIncoming = !0,
                        r.fastPoll())
                }),
                Dl(o, "cut", t),
                Dl(o, "copy", t),
                Dl(e.scroller, "paste", function (t) {
                    Xt(e, t) || Mi(n, t) || (n.state.pasteIncoming = !0,
                        r.focus())
                }),
        ...
        showSelection: function (e) {
            var t = this.cm
                , r = t.display;
            Xi(r.cursorDiv, e.cursors),
                Xi(r.selectionDiv, e.selection),
            ...
            if (!this.contextMenuPending) {
                ...
                if (n.somethingSelected()) {
                    ...
                    this.textarea.value = l,
                        n.state.focused && jl(this.textarea),
                        xo && Co >= 9 && (this.hasSelection = l)
                } else
                    e || (this.prevInput = this.textarea.value = "",
                        xo && Co >= 9 && (this.hasSelection = null));
        ...
        focus: function () {
            if ("nocursor" != this.cm.options.readOnly && (!Oo || Yi() != this.textarea))
                try {
                    this.textarea.focus()
                } catch (e) { }
        },
        ...
        poll: function () {
            var e = this.cm
                , t = this.textarea
                , r = this.prevInput;
            if (this.contextMenuPending || !e.state.focused || is(t) && !r && !this.composing || e.isReadOnly() || e.options.disableInput || e.state.keySeq)
                return !1;
            var n = t.value;
            if (n == r && !e.somethingSelected())
                return !1;
            if (xo && Co >= 9 && this.hasSelection === n || Do && /[\uf700-\uf7ff]/.test(n))
            ...
            for (var o = 0, l = Math.min(r.length, n.length); l > o && r.charCodeAt(o) == n.charCodeAt(o);)
                ++o;
            var s = this;
            return At(e, function () {
                Z(e, n.slice(o), r.length - o, null, s.composing ? "*compose" : null),
        ...
        onContextMenu: function (e) {
            ...
            function r() {
                if (n.contextMenuPending = !1,
                    n.wrapper.style.cssText = h,
                    l.style.cssText = c,
                    xo && 9 > Co && o.scrollbars.setScrollTop(o.scroller.scrollTop = a),
            ...
            if (s && !ko) {
                ...
                u && -1 == i.doc.sel.contains(s) && Ot(i, ke)(i.doc, de(s), Rl);
                ...
                if (l.style.cssText = "position: absolute; width: 30px; height: 30px; top: " + (e.clientY - f.top - 5) + "px; left: " + (e.clientX - f.left - 5) + "px; z-index: 1000; background: " + (xo ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);",
                    So)
                    var d = window.scrollY;
                if (o.input.focus(),
                    So && window.scrollTo(null, d),
                    o.input.reset(),
        ...
        ie.prototype = Ri({
            init: function (e) {
                function t(e) {
                    if (!Mi(n, e)) {
                        ...
                        var l = ne()
                            , s = l.firstChild;
                        n.display.lineSpace.insertBefore(l, n.display.lineSpace.firstChild),
                            s.value = Uo.text.join("\n");
                ...
                var r = this
                    , n = r.cm
                    , i = r.div = e.lineDiv;
                te(i, n.options.spellcheck),
                    Dl(i, "paste", function (e) {
                        Mi(n, e) || Q(e, n) || 11 >= Co && setTimeout(Ot(n, function () {
                            r.pollContent() || It(n)
                        }), 20)
                    }),
            ...
            showPrimarySelection: function () {
                ...
                if (!r || r.bad || !n || n.bad || 0 != Go(q(r, n), t.from()) || 0 != Go(_(r, n), t.to())) {
                    ...
                    if (i || o) {
                        ...
                        c && (!yo && this.cm.state.focused ? (e.collapse(i.node, i.offset),
                            c.collapsed || e.addRange(c)) : (e.removeAllRanges(),
                                e.addRange(c)),
                            s && null == e.anchorNode ? e.addRange(s) : yo && this.startGracePeriod()),
            ...
            showMultipleSelections: function (e) {
                Xi(this.cm.display.cursorDiv, e.cursors),
                    Xi(this.cm.display.selectionDiv, e.selection)
            },
            ...
            pollContent: function () {
                var e = this.cm
                    ...
                    , n = r.from()
                    , i = r.to();
                if (n.line < t.viewFrom || i.line > t.viewTo - 1)
                    return !1;
                var o;
                if (n.line == t.viewFrom || 0 == (o = Rt(e, n.line)))
                    var l = ri(t.view[0].line)
                        , s = t.view[0].node;
                else
                    var l = ri(t.view[o].line)
                ...
                for (var d = 0, p = 0, g = h[0], v = f[0], m = Math.min(g.length, v.length); m > d && g.charCodeAt(d) == v.charCodeAt(d);)
                    ++d;
                for (var y = Hi(h), b = Hi(f), w = Math.min(y.length - (1 == h.length ? d : 0), b.length - (1 == f.length ? d : 0)); w > p && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);)
                    ++p;
                h[h.length - 1] = y.slice(0, y.length - p),
                    h[0] = h[0].slice(d);
                var x = Bo(l, d)
                    , C = Bo(u, f.length ? Hi(f).length - p : 0);
                return h.length > 1 || h[0] || Go(x, C) ? (Dr(e.doc, h, x, C, "+input"),
                    !0) : void 0
            },
            ensurePolled: function () {
        ...
        ce.prototype = {
            ...
            equals: function (e) {
                ...
                for (var t = 0; t < this.ranges.length; t++) {
                    var r = this.ranges[t]
                        , n = e.ranges[t];
                    if (0 != Go(r.anchor, n.anchor) || 0 != Go(r.head, n.head))
                        return !1
                }
                return !0
            },
            deepCopy: function () {
                for (var e = [], t = 0; t < this.ranges.length; t++)
                    e[t] = new he(Y(this.ranges[t].anchor), Y(this.ranges[t].head));
    ...
    e.prototype = {
        ...
        setOption: function (e, t) {
            var r = this.options
                , n = r[e];
            r[e] == t && "mode" != e || (r[e] = t,
                nl.hasOwnProperty(e) && Ot(this, nl[e])(this, t, n))
        },
        ...
        indentLine: Dt(function (e, t, r) {
            "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"),
                me(this.doc, e) && Br(this, e, t, r)
        }),
        indentSelection: Dt(function (e) {
            for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                var i = t[n];
                if (i.empty())
                    i.head.line > r && (Br(this, i.head.line, e, !0),
                        r = i.head.line,
                        n == this.doc.sel.primIndex && Fr(this));
                else {
                    var o = i.from()
                        , l = i.to()
                        , s = Math.max(r, o.line);
        ...
        getTokenTypeAt: function (e) {
            e = ge(this.doc, e);
            var t, r = In(this, Qn(this.doc, e.line)), n = 0, i = (r.length - 1) / 2, o = e.ch;
            if (0 == o)
                t = r[2];
            else
                for (; ;) {
        ...
        getHelpers: function (e, t) {
            ...
            for (var o = 0; o < n._global.length; o++) {
                var s = n._global[o];
                s.pred(i, this) && -1 == Pi(r, s.val) && r.push(s.val)
            }
            return r
        },
        getStateAfter: function (e, t) {
            var r = this.doc;
            return e = pe(r, null == e ? r.first + r.size - 1 : e),
                Ue(this, e + 1, t)
        },
        cursorCoords: function (e, t) {
            var r, n = this.doc.sel.primary();
            return r = null == e ? n.head : "object" == typeof e ? ge(this.doc, e) : e ? n.from() : n.to(),
                pt(this, r, t || "page")
        },
        ...
        clearGutter: Dt(function (e) {
            ...
            r.iter(function (r) {
                r.gutterMarkers && r.gutterMarkers[e] && (r.gutterMarkers[e] = null,
                    zt(t, n, "gutter"),
                    Ui(r.gutterMarkers) && (r.gutterMarkers = null)),
                    ++n
            })
        }),
        lineInfo: function (e) {
            ...
            t.style.top = l + "px",
                ...
                "right" == i ? (s = o.sizer.clientWidth - t.offsetWidth,
                    t.style.right = "0px") : ("left" == i ? s = 0 : "middle" == i && (s = (o.sizer.clientWidth - t.offsetWidth) / 2),
                        t.style.left = s + "px"),
                r && Er(this, s, l, s + t.offsetWidth, l + t.offsetHeight)
        },
        triggerOnKeyDown: Dt(fr),
        triggerOnKeyPress: Dt(gr),
        triggerOnKeyUp: pr,
        execCommand: function (e) {
            return fl.hasOwnProperty(e) ? fl[e].call(null, this) : void 0
        },
        ...
        findPosH: function (e, t, r, n) {
            ...
            0 > t && (i = -1,
                t = -t);
            for (var o = 0, l = ge(this.doc, e); t > o && (l = Vr(this.doc, l, i, r, n),
                !l.hitSide); ++o)
                ;
            return l
        },
        moveH: Dt(function (e, t) {
            ...
            r.extendSelectionsBy(function (n) {
                return r.display.shift || r.doc.extend || n.empty() ? Vr(r.doc, n.head, e, t, r.options.rtlMoveVisually) : 0 > e ? n.from() : n.to()
            }, Gl)
        }),
        ...
        moveV: Dt(function (e, t) {
            ...
            if (n.extendSelectionsBy(function (l) {
                ...
                null != l.goalColumn && (s.left = l.goalColumn),
                    i.push(s.left);
                var a = Kr(r, s, e, t);
                return "page" == t && l == n.sel.primary() && zr(r, null, dt(r, a, "div").top - s.top),
                    a
            }, Gl),
                i.length)
        ...
        toggleOverwrite: function (e) {
            null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? es(this.display.cursorDiv, "CodeMirror-overwrite") : Jl(this.display.cursorDiv, "CodeMirror-overwrite"),
        ...
        setSize: Dt(function (e, t) {
            ...
            null != e && (n.display.wrapper.style.width = r(e)),
                ...
                n.options.lineWrapping && st(this);
        ...
        refresh: Dt(function () {
            ...
            It(this),
                ...
                c(this),
                (null == e || Math.abs(e - bt(this.display)) > .5) && l(this),
    ...
    jr("value", "", function (e, t) {
        ...
        jr("indentWithTabs", !1),
        jr("smartIndent", !0),
        jr("tabSize", 4, function (e) {
            n(e),
                at(e),
                It(e)
        }, !0),
        jr("lineSeparator", null, function (e, t) {
            if (e.doc.lineSep = t,
                t) {
                var r = []
                    , n = e.doc.first;
                ...
                for (var i = r.length - 1; i >= 0; i--)
                    Dr(e.doc, t, r[i], Bo(r[i].line, r[i].ch + t.length))
            }
        }),
        ...
        jr("electricChars", !0),
        jr("inputStyle", Oo ? "contenteditable" : "textarea", function () {
            throw new Error("inputStyle can not (yet) be changed in a running editor")
        }, !0),
        jr("spellcheck", !1, function (e, t) {
            e.getInputField().spellcheck = t
        }, !0),
        jr("rtlMoveVisually", !Po),
        jr("wholeLineUpdateBefore", !0),
        jr("theme", "default", function (e) {
            s(e),
                a(e)
        }, !0),
        jr("keyMap", "default", function (t, r, n) {
            var i = Yr(r)
                , o = n != e.Init && Yr(n);
        ...
        jr("extraKeys", null),
        jr("lineWrapping", !1, i, !0),
        jr("gutters", [], function (e) {
            d(e.options),
                a(e)
        }, !0),
        jr("fixedGutter", !0, function (e, t) {
            e.display.gutters.style.left = t ? L(e.display) + "px" : "0",
                e.refresh()
        }, !0),
        jr("coverGutterNextToScrollbar", !1, function (e) {
            y(e)
        }, !0),
        jr("scrollbarStyle", "native", function (e) {
            m(e),
                y(e),
                e.display.scrollbars.setScrollTop(e.doc.scrollTop),
                e.display.scrollbars.setScrollLeft(e.doc.scrollLeft)
        }, !0),
        jr("lineNumbers", !1, function (e) {
            d(e.options),
                a(e)
        }, !0),
        jr("firstLineNumber", 1, a, !0),
        jr("lineNumberFormatter", function (e) {
            return e
        }, a, !0),
        jr("showCursorWhenSelecting", !1, Pe, !0),
        jr("resetSelectionOnContextMenu", !0),
        jr("lineWiseCopyCut", !0),
        jr("readOnly", !1, function (e, t) {
            "nocursor" == t ? (yr(e),
        ...
        jr("dragDrop", !0, Kt),
        jr("allowDropFileTypes", null),
        jr("cursorBlinkRate", 530),
        jr("cursorScrollMargin", 0),
        jr("cursorHeight", 1, Pe, !0),
        jr("singleCursorHeightPerLine", !0, Pe, !0),
        jr("workTime", 100),
        jr("workDelay", 100),
        jr("flattenSpans", !0, n, !0),
        jr("addModeClass", !1, n, !0),
        jr("pollInterval", 100),
        jr("undoDepth", 200, function (e, t) {
            e.doc.history.undoDepth = t
        }),
        jr("historyEventDelay", 1250),
        jr("viewportMargin", 10, function (e) {
            e.refresh()
        }, !0),
        jr("maxHighlightLength", 1e4, n, !0),
        jr("moveInputWithCursor", !0, function (e, t) {
    ...
    e.defineMode = function (t, r) {
        ...
        e.resolveMode = function (t) {
            if ("string" == typeof t && ll.hasOwnProperty(t))
                t = ll[t];
                ...
                if ("string" == typeof t && /^[\w\-]+\/[\w\-]+\+json$/.test(t))
                    return e.resolveMode("application/json")
            }
    ...
    dl.basic = {
        ...
        dl["default"] = Do ? dl.macDefault : dl.pcDefault,
    ...
    var pl = e.lookupKey = function (e, t, r, n) {
        ...
        , vl = e.keyName = function (e, t) {
            if (ko && 34 == e.keyCode && e["char"])
                return !1;
            var r = ss[e.keyCode]
                , n = r;
            return null == n || e.altGraphKey ? !1 : (e.altKey && "Alt" != r && (n = "Alt-" + n),
                (Io ? e.metaKey : e.ctrlKey) && "Ctrl" != r && (n = "Ctrl-" + n),
                (Io ? e.ctrlKey : e.metaKey) && "Cmd" != r && (n = "Cmd-" + n),
    ...
    ml.prototype = {
        ...
        column: function () {
            return this.lastColumnPos < this.start && (this.lastColumnValue = Ul(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                this.lastColumnPos = this.start),
                this.lastColumnValue - (this.lineStart ? Ul(this.string, this.lineStart, this.tabSize) : 0)
        },
        ...
        match: function (e, t, r) {
            if ("string" != typeof e) {
                ...
                return n && n.index > 0 ? null : (n && t !== !1 && (this.pos += n[0].length),
                    n)
            }
            var i = function (e) {
    ...
    Ai(bl),
        bl.prototype.clear = function () {
            if (!this.explicitlyCleared) {
                ...
                for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                    ...
                    e && !this.collapsed ? zt(e, ri(l), "text") : e && (null != s.to && (i = ri(l)),
                        null != s.from && (n = ri(l))),
                        l.markedSpans = tn(l.markedSpans, s),
                        null == s.from && this.collapsed && !Sn(this.doc, l) && e && ti(l, bt(e.display))
                }
                ...
                null != n && e && this.collapsed && It(e, n, i + 1),
                    this.lines.length = 0,
                    this.explicitlyCleared = !0,
                    this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1,
                        e && We(e.doc)),
                    e && Ti(e, "markerCleared", e, this),
                    t && St(e),
        ...
        bl.prototype.find = function (e, t) {
            ...
            for (var r, n, i = 0; i < this.lines.length; ++i) {
                ...
                if (null != l.from && (r = Bo(t ? o : ri(o), l.from),
                    -1 == e))
                    return r;
                if (null != l.to && (n = Bo(t ? o : ri(o), l.to),
                    1 == e))
                    return n
            }
            return r && {
    ...
    var Tl = 0
        , kl = e.Doc = function (e, t, r, n) {
            ...
            null == r && (r = 0),
                qn.call(this, [new _n([new Cl("", null)])]),
                this.first = r,
    ...
    kl.prototype = Fi(qn.prototype, {
        ...
        getLineHandle: function (e) {
            return me(this, e) ? Qn(this, e) : void 0
        },
        getLineNumber: function (e) {
            return ri(e)
        },
        getLineHandleVisualStart: function (e) {
            return "number" == typeof e && (e = Qn(this, e)),
                bn(e)
        },
        lineCount: function () {
            return this.size
        ...
        setSelections: Ht(function (e, t, r) {
            if (e.length) {
                for (var n = 0, i = []; n < e.length; n++)
                    i[n] = new he(ge(this, e[n].anchor), ge(this, e[n].head));
        ...
        addSelection: Ht(function (e, t, r) {
            ...
            n.push(new he(ge(this, e), ge(this, t || e))),
                ke(this, fe(n, n.length - 1), r)
        }),
        ...
        replaceSelections: Ht(function (e, t, r) {
            ...
            for (var s = t && "end" != t && Lr(this, n, t), o = n.length - 1; o >= 0; o--)
                kr(this, n[o]);
        ...
        setHistory: function (e) {
            ...
            t.done = mi(e.done.slice(0), null, !0),
                t.undone = mi(e.undone.slice(0), null, !0)
        },
        ...
        unlinkDoc: function (t) {
            ...
            if (t.history == this.history) {
                ...
                $n(t, function (e) {
                    ...
                    t.history = new li(null),
                    t.history.done = mi(this.history.done, i),
                    t.history.undone = mi(this.history.undone, i)
            }
        },
    ...
    for (var Nl in kl.prototype)
        kl.prototype.hasOwnProperty(Nl) && Pi(Ml, Nl) < 0 && (e.prototype[Nl] = function (e) {
            return function () {
    ...
    var Xl, Yl = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, _l = e.isWordChar = function (e) {
    ...
    !function () {
        for (var e = 0; 10 > e; e++)
            ss[e + 48] = ss[e + 96] = String(e);
        for (var e = 65; 90 >= e; e++)
            ss[e] = String.fromCharCode(e);
        for (var e = 1; 12 >= e; e++)
            ss[e + 111] = ss[e + 63235] = "F" + e
    }();
    var as, us = function () {
        function e(e) {
        ...
        return function (r) {
            if (!i.test(r))
                return !1;
            for (var n, c = r.length, h = [], f = 0; c > f; ++f)
                h.push(n = e(r.charCodeAt(f)));
            ...
            for (var f = 0; c > f; ++f) {
                ...
                if ("," == n)
                    ...
                    for (var g = f + 1; c > g && "%" == h[g]; ++g)
                        ;
                    for (var v = f && "!" == h[f - 1] || c > g && "1" == h[g] ? "1" : "N", m = f; g > m; ++m)
                        h[m] = v;
                    f = g - 1
                }
            }
            ...
            for (var f = 0; c > f; ++f)
                if (o.test(h[f])) {
                    for (var g = f + 1; c > g && o.test(h[g]); ++g)
                        ;
                    for (var y = "L" == (f ? h[f - 1] : u), b = "L" == (c > g ? h[g] : u), v = y || b ? "L" : "R", m = f; g > m; ++m)
                        h[m] = v;
                    f = g - 1
                }
            for (var w, x = [], f = 0; c > f;)
            ...
            return 1 == x[0].level && (w = r.match(/^\s+/)) && (x[0].from = w[0].length,
                ...
                x[0].level != Hi(x).level && x.push(new t(x[0].level, c, c)),
                x
        }
    }();
    return e.version = "5.18.2",
        e
});
