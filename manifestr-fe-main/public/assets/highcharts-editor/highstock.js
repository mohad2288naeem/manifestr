 ...
 */
    function (t, e) {
        ...
        "use strict";
        let t, e, i, s, o, r;
        var a, n, h, l, d, c, p, u, g, f, m, x, y, b, v, k, M, w, S, A, T, C, P, O, E = {};
        E.d = (t, e) => {
            for (var i in e)
                E.o(e, i) && !E.o(t, i) && Object.defineProperty(t, i, {
                    enumerable: !0,
                    get: e[i]
                })
        }
 ...
 - ${i}: ${e}`,
            ...
            te(D, "displayError", {
                ...
                if (e)
                    throw Error(a);
                z.console && -1 === R.messages.indexOf(a) && console.warn(a)
            }),
                R.messages.push(a)
        }
        function N(t, e) {
        ...
        function X(t, e) {
            return !!t && "object" == typeof t && (!e || !G(t))
        }
        function H(t) {
        ...
        function F(t) {
            let e = t?.constructor;
            return !!(X(t, !0) && !H(t) && e?.name && "Object" !== e.name)
        }
        function Y(t) {
        ...
        (R || (R = {})).messages = [],
            ...
            ;
        let J = Array.prototype.find ? function (t, e) {
            return t.find(e)
        }
            : function (t, e) {
                let i, s = t.length;
        ...
        function te(t, e, i, s) {
            if (i = i || {},
                I?.createEvent && (t.dispatchEvent || t.fireEvent && t !== D)) {
                let s = I.createEvent("Events");
                s.initEvent(e, !0, !0),
                    i = $(s, i),
        ...
        z.jQuery && (z.jQuery.fn.highcharts = function () {
            ...
            if (this[0])
                return t[0] ? (new D[W(t[0]) ? t.shift() : "Chart"](this[0], t[0], t[1]),
                    this) : B[U(this[0], "data-highcharts-chart")]
        }
        );
        let ts = {
            addEvent: function (t, e, i, s = {}) {
                ...
                let r = o.hcEvents;
                D.Point && t instanceof D.Point && t.series && t.series.chart && (t.series.chart.runTrackerClick = !0);
            ...
            getNestedProperty: function (t, e) {
                ...
                for (; i.length && j(e);) {
                    ...
                    let s = e[t.replace(/[\\'"]/g, "")];
                    if (!j(s) || "function" == typeof s || "number" == typeof s.nodeType || s === z)
                        return;
                    e = s
                }
                return e
            ...
            insertItem: function (t, e) {
                ...
                for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
                    if (!e[i] || Y(s) && s < _(e[i].options.index, e[i]._i) || e[i].options.isInternal) {
                        e.splice(i, 0, t);
                        break
                    }
                return i
            ...
            merge: function (t, ...e) {
                let i, s = [t, ...e], o = {}, r = function (t, e) {
                    return "object" != typeof t && (t = {}),
                        Q(e, function (i, s) {
                            "__proto__" !== s && "constructor" !== s && (!X(i, !0) || F(i) || H(i) ? t[s] = e[s] : t[s] = r(t[s] || {}, i))
                        }),
                        t
                };
                !0 === t && (o = s[1],
            ...
            normalizeTickInterval: function (t, e, i, s, o) {
                ...
                for (!e && (e = o ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
                    ...
                    ;
                return K(a * i, -Math.round(Math.log(.001) / Math.LN10))
            },
            objectEach: Q,
            offset: function (t) {
            ...
            ucfirst: function (t) {
                return W(t) ? t.substring(0, 1).toUpperCase() + t.substring(1) : String(t)
            },
            uniqueKey: ti,
            ...
            , { pageLang: to, win: tr } = D
            , { defined: ta, error: tn, extend: th, isNumber: tl, isObject: td, isString: tc, merge: tp, objectEach: tu, pad: tg, splat: tf, timeUnits: tm, ucfirst: tx } = ts
            , ty = D.isSafari && tr.Intl && !tr.Intl.DateTimeFormat.prototype.formatRange
            , tb = t => void 0 === t.main
            , tv = class {
                constructor(t, e) {
                    this.options = {
                ...
                dateTimeFormat(t, e, i = this.options.locale || to) {
                    let s = JSON.stringify(t) + i;
                    tc(t) && (t = this.str2dtf(t));
                    ...
                    if (!o) {
                        ...
                        try {
                            ...
                            /Invalid time zone/i.test(e.message) ? (tn(34),
                                t.timeZone = "UTC",
                                o = new Intl.DateTimeFormat(i, t)) : tn(e.message, !1)
                        }
                    }
                ...
                makeTime(t, e, i = 1, s = 0, o, r, a) {
                    ...
                    if ("UTC" !== this.timezone) {
                        ...
                        if (n += t,
                            ...
                            t !== e ? n += e - t : t - 36e5 !== this.getTimezoneOffset(n - 36e5) || ty || (n -= 36e5)
                        }
                    }
                    return n
                }
                ...
                getDateFormat(t, e, i, s) {
                    let o = this.dateFormat("%m-%d %H:%M:%S.%L", e)
                        ...
                        , h = n;
                    for (n in tm) {
                        if (t && t === tm.week && +this.dateFormat("%w", e) === i && o.substr(6) === r.substr(6)) {
                            n = "week";
                            break
                        }
                        if (t && tm[n] > t) {
            ...
            , { defined: tk, extend: tM, timeUnits: tw } = ts
            , tS = class extends tv {
                getTimeTicks(t, e, i, s) {
                    let o = this, r = [], a = {}, { count: n = 1, unitRange: h } = t, [l, d, c, p, u, g] = o.toParts(e), f = (e || 0) % 1e3, m;
                    if (s ?? (s = 1),
                        tk(e)) {
                        if (f = h >= tw.second ? 0 : n * Math.floor(f / n),
                            h >= tw.second && (g = h >= tw.minute ? 0 : n * Math.floor(g / n)),
                            h >= tw.minute && (u = h >= tw.hour ? 0 : n * Math.floor(u / n)),
                            h >= tw.hour && (p = h >= tw.day ? 0 : n * Math.floor(p / n)),
                            h >= tw.day && (c = h >= tw.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                            h >= tw.month && (d = h >= tw.year ? 0 : n * Math.floor(d / n)),
                            h >= tw.year && (l -= l % n),
                            h === tw.week) {
                        ...
                        e = o.makeTime(l, d, c, p, u, g, f),
                            o.variableTimezone && tk(i) && (m = i - e > 4 * tw.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i));
                        let t = e
                            , x = 1;
                        for (; t < i;)
                            r.push(t),
                                h === tw.year ? t = o.makeTime(l + x * n, 0) : h === tw.month ? t = o.makeTime(l, d + x * n) : m && (h === tw.day || h === tw.week) ? t = o.makeTime(l, d, c + x * n * (h === tw.day ? 1 : 7)) : m && h === tw.hour && n > 1 ? t = o.makeTime(l, d, c, p + x * n) : t += h * n,
                                x++;
                        r.push(t),
                            h <= tw.hour && r.length < 1e4 && r.forEach(t => {
            ...
            , tE = {
                ...
                setOptions: function (t) {
                    return tT(D, "setOptions", {
                        options: t
                    }),
                        tC(!0, tP, t),
                        t.time && tO.update(tP.time),
                        t.lang && "locale" in t.lang && tO.update({
                            locale: t.lang.locale
                        }),
                        t.lang?.chartTitle && (tP.title = {
                            ...tP.title,
            ...
            , { win: tL } = D
            , { isNumber: tD, isString: tB, merge: tI, pInt: tz, defined: tR } = ts
            , tN = (t, e, i) => `color-mix(in srgb,${t},${e} ${100 * i}%)`
            , tW = t => tB(t) && !!t && "none" !== t;
        class tG {
            static parse(t) {
            ...
            constructor(t) {
                ...
                if ("object" == typeof t && void 0 !== t.stops)
                    ...
                    for (this.input = t = tG.names[t.toLowerCase()] || t,
                        s = tG.parsers.length; s-- && !i;)
            ...
            brighten(t) {
                ...
                if (this.stops)
                    ...
                    if (tD(e[0]))
                        ...
                        tG.useColorMix && tW(this.input) && (this.output = tN(this.input, t > 0 ? "white" : "black", Math.abs(t)));
                return this
            }
            setOpacity(t) {
            ...
            tweenTo(t, e) {
                let i = this.rgba
                    , s = t.rgba;
                if (!tD(i[0]) || !tD(s[0]))
                    return tG.useColorMix && tW(this.input) && tW(t.input) && e < .99 ? tN(this.input, t.input, e) : t.input || "none";
                let o = 1 !== s[3] || 1 !== i[3]
                    , r = (t, s) => t + (i[s] - t) * (1 - e)
        ...
        tG.names = {
            ...
            tG.parsers = [{
                ...
                parse: function (t) {
                    return [tz(t[1] + t[1], 16), tz(t[2] + t[2], 16), tz(t[3] + t[3], 16), tR(t[4]) ? tz(t[4] + t[4], 16) / 255 : 1]
                }
            }, {
                regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i,
                parse: function (t) {
                    return [tz(t[1], 16), tz(t[2], 16), tz(t[3], 16), tR(t[4]) ? tz(t[4], 16) / 255 : 1]
                }
            }],
            tG.useColorMix = tL.CSS?.supports("color", "color-mix(in srgb,red,blue 9%)"),
            tG.None = new tG("");
        let { parse: tX } = tG
            , { win: tH } = D
            , { isNumber: tF, objectEach: tY } = ts;
        class tj {
            constructor(t, e, i) {
                this.pos = NaN,
                    this.options = e,
                    ...
                    if (e.length === i.length && s < 1)
                        for (let t = 0; t < i.length; t++) {
                            ...
                            for (let t = 0; t < a.length; t++) {
                                let e = r[t]
                                    , i = a[t];
                                tF(e) && tF(i) && ("A" !== a[0] || 4 !== t && 5 !== t) ? n[t] = e + s * (i - e) : n[t] = i
                            }
                            o.push(n)
                        }
                    else
            ...
            run(t, e, i) {
                let s = this
                    ...
                    , a = tH.requestAnimationFrame || function (t) {
                        setTimeout(t, 13)
                    }
                    , n = function () {
                        for (let t = 0; t < tj.timers.length; t++)
                            tj.timers[t]() || tj.timers.splice(t--, 1);
                        tj.timers.length && a(n)
                    };
                t !== e || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                    ...
                    r.elem = this.elem,
                    r.prop = this.prop,
                    r() && 1 === tj.timers.push(r) && a(n)) : (delete o.curAnim[this.prop],
            ...
            initPath(t, e, i) {
                ...
                return u.length && tF(l) && (d = r.length + l * n,
                    p ? (g(u, r),
                        f(r)) : (g(r, u),
                            f(u))),
                    [u, r]
            ...
            fillSetter() {
                tj.prototype.strokeSetter.apply(this, arguments)
            }
            strokeSetter() {
        ...
        tj.timers = [];
        let { defined: tU, getStyle: tV, isArray: t$, isNumber: t_, isObject: tZ, merge: tq, objectEach: tK, pick: tJ } = ts;
        function tQ(t) {
            return tZ(t) ? tq({
                duration: 500,
                defer: 0
        ...
        function t0(t, e) {
            let i = tj.timers.length;
            for (; i--;)
                tj.timers[i].elem !== t || e && e !== tj.timers[i].prop || (tj.timers[i].stopped = !0)
        }
        let t1 = {
                ...
                tZ(i) || (n = arguments,
                    ...
                    tK(e, function (n, h) {
                        t0(t, h),
                            a = new tj(t, i, h),
                            r = void 0,
                            "d" === h && t$(e.d) ? (a.paths = a.initPath(t, t.pathArray, e.d),
                                a.toD = e.d,
                                s = 0,
                                r = 1) : t.attr ? s = t.attr(h) : (s = parseFloat(tV(t, h)) || 0,
                                    "opacity" !== h && (o = "px")),
                            r || (r = n),
            ...
            getDeferredAnimation: function (t, e, i) {
                let s = tQ(e)
                    ...
                    , a = 0;
                return o.forEach(t => {
                    let i = tQ(t.options.animation);
                    r = tZ(e) && tU(e.defer) ? s.defer : Math.max(r, i.duration + i.defer),
            ...
            setAnimation: function (t, e) {
                e.renderer.globalAnimation = tJ(t, e.options.chart.animation, !0)
            },
            stop: t0
        }
            , { SVG_NS: t2, win: t3 } = D
            , { attr: t5, createElement: t6, css: t9, error: t4, isFunction: t8, isString: t7, objectEach: et, splat: ee } = ts
            , { trustedTypes: ei } = t3
            , es = ei && t8(ei.createPolicy) && ei.createPolicy("highcharts", {
                createHTML: t => t
            })
            , eo = es ? es.createHTML("") : "";
        class er {
            static filterUserAttributes(t) {
                return et(t, (e, i) => {
                    ...
                    -1 === er.allowedAttributes.indexOf(i) && (s = !1),
                        -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = t7(e) && er.allowedReferences.some(t => 0 === e.indexOf(t))),
                        s || (t4(33, !1, void 0, {
                            "Invalid attribute in config": `${i}`
                        }),
                            delete t[i]),
                        t7(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"))
                }
                ),
                    t
            }
            ...
            static setElementHTML(t, e) {
                t.innerHTML = er.emptyHTML,
                    e && new er(e).addToDOM(t)
            }
            constructor(t) {
            ...
            addToDOM(t) {
                return function t(e, i) {
                    ...
                    return ee(e).forEach(function (e) {
                        let o, r = e.tagName, a = e.textContent ? D.doc.createTextNode(e.textContent) : void 0, n = er.bypassHTMLFiltering;
                        if (r)
                            if ("#text" === r)
                                o = a;
                            else if (-1 !== er.allowedTags.indexOf(r) || n) {
                                let s = "svg" === r ? t2 : i.namespaceURI || t2
                                    , h = D.doc.createElementNS(s, r)
                                    , l = e.attributes || {};
                                et(e, function (t, e) {
                                    "tagName" !== e && "attributes" !== e && "children" !== e && "style" !== e && "textContent" !== e && (l[e] = t)
                                }),
                                    t5(h, n ? l : er.filterUserAttributes(l)),
                                    e.style && t9(h, e.style),
                                    a && h.appendChild(a),
                                    t(e.children || [], h),
                                    o = h
                            } else
            ...
            parseMarkup(t) {
                ...
                let s = (t, e) => {
                    ...
                    if (r) {
                        let t = {};
                        [].forEach.call(r, e => {
                            "data-style" === e.name ? o.style = er.parseStyle(e.value) : t[e.name] = e.value
                        }
                        ),
                            o.attributes = t
                    }
        ...
        let { defaultOptions: ea, defaultTime: en } = tE
            ...
            , ex = {
                ...
                each: function (t) {
                    ...
                    return !!ec(t) && t.map((i, s) => ev(e.body, el(eu(i) ? i : {
                        "@this": i
                    }, {
                        "@index": s,
                        "@first": 0 === s,
            ...
            , eb = t => /^["'].+["']$/.test(t);
        function ev(t = "", e, i) {
            let s = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g, o = /\(([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'= ]+)\)/g, r = [], a = /f$/, n = /\.(\d)/, h = i?.options?.lang || ea.lang, l = i?.time || en, d = i?.numberFormatter || ek.bind(i), c = (t = "") => {
                let i;
                return "true" === t || "false" !== t && ((i = Number(t)).toString() === t ? i : eb(t) ? t.slice(1, -1) : ed(t, e))
            }
                , p, u, g = 0, f;
            for (; null !== (p = s.exec(t));) {
                let i = p
            ...
            return r.forEach(s => {
                ...
                if (m) {
                    ...
                    for (p = ex[m].length; p--;)
                        t.unshift(c(o[p + 1]));
                    r = ex[m].apply(e, t),
                        s.isBlock && "boolean" == typeof r && (r = ev(r ? u : g, e, i))
                } else {
                    let t = eb(f) ? [f] : f.split(":")
                        , e = (r = c(t.shift() || "")) % 1 != 0;
                    ...
                    o.lastIndex = 0,
                        o.test(s.find) && eg(r) && (r = `"${r}"`)
                }
                t = t.replace(s.find, ef(r, ""))
            }
            ),
                f ? ev(t, e, i) : t
        }
        function ek(t, e, i, s) {
            e *= 1;
            let o, r, [a, n] = (t = +t || 0).toString().split("e").map(Number), h = this?.options?.lang || ea.lang, l = (t.toString().split(".")[1] || "").split("e")[0].length, d = e, c = {};
            i ?? (i = h.decimalPoint),
                s ?? (s = h.thousandsSep),
                -1 === e ? e = Math.min(l, 20) : ep(e) ? e && n < 0 && ((r = e + n) >= 0 ? (a = +a.toExponential(r).split("e")[0],
                    e = r) : (a = Math.floor(a),
                        t = e < 20 ? +(a * Math.pow(10, n)).toFixed(e) : 0,
                        n = 0)) : e = 2,
                n && (e ?? (e = 2),
                    t = a),
                ep(e) && e >= 0 && (c.minimumFractionDigits = e,
                    c.maximumFractionDigits = e),
                "" === s && (c.useGrouping = !1);
            let p = s || i
                , u = p ? "en" : this?.locale || h.locale || eh
                , g = JSON.stringify(c) + u;
            return o = (ey[g] ?? (ey[g] = new Intl.NumberFormat(u, c))).format(t),
        ...
        let ew = n
            , { clamp: eS, pick: eA, pushUnique: eT, stableSort: eC } = ts;
        (h || (h = {})).distribute = function t(e, i, s) {
            ...
            for (c = h; c--;)
                x += e[c].size;
            if (x > r) {
                for (eC(e, (t, e) => (e.rank || 0) - (t.rank || 0)),
            ...
            ;
        let eP = h
            , { animate: eO, animObject: eE, stop: eL } = t1
            , { deg2rad: eD, doc: eB, svg: eI, SVG_NS: ez, win: eR, isFirefox: eN } = D
            , { addEvent: eW, attr: eG, createElement: eX, crisp: eH, css: eF, defined: eY, erase: ej, extend: eU, fireEvent: eV, getAlignFactor: e$, isArray: e_, isFunction: eZ, isNumber: eq, isObject: eK, isString: eJ, merge: eQ, objectEach: e0, pick: e1, pInt: e2, pushUnique: e3, replaceNested: e5, syncTimeout: e6, uniqueKey: e9 } = ts;
        class e4 {
            _defaultGetter(t) {
                let e = e1(this[t + "Value"], this[t], this.element ? this.element.getAttribute(t) : null, 0);
            ...
            align(t, e, i, s = !0) {
                ...
                t ? (this.alignOptions = t,
                    ...
                    this.alignTo = i) : (t = this.alignOptions || {},
                        ...
                        i = this.alignTo);
                let n = !i || eJ(i) ? i || "renderer" : void 0;
                n && (a && e3(r, this),
                    i = void 0);
                let h = e1(i, o[n], o)
                    , l = (h.x || 0) + (t.x || 0) + ((h.width || 0) - (t.width || 0)) * e$(t.align)
                    , d = (h.y || 0) + (t.y || 0) + ((h.height || 0) - (t.height || 0)) * e$(t.verticalAlign)
                    , c = {
                        "text-align": t?.align
                    };
            ...
            animate(t, e, i) {
                let s = eE(e1(e, this.renderer.globalAnimation, !0))
                    , o = s.defer;
                return eB.hidden && (s.duration = 0),
                    0 !== s.duration ? (i && (s.complete = i),
                        e6(() => {
                            this.element && eO(this, t, s)
                        }
            ...
            applyTextOutline(t) {
                ...
                if (o && "none" !== o && D.svg) {
                    ...
                    let t = eB.createElementNS(ez, "tspan");
                    eG(t, {
                    ...
                    let a = eB.createElementNS(ez, "tspan");
                    a.textContent = "​",
                        eG(a, {
            ...
            attr(t, e, i, s) {
                let { element: o } = this, r = e4.symbolCustomAttribs, a, n, h = this, l;
                return "string" == typeof t && void 0 !== e && (a = t,
                    (t = {})[a] = e),
                    "string" == typeof t ? h = (this[t + "Getter"] || this._defaultGetter).call(this, t, o) : (e0(t, function (e, i) {
                        l = !1,
                            s || eL(this, i),
            ...
            crisp(t, e) {
                ...
                return eU(t, {
                    ...
                    eY(t.strokeWidth) && (t.strokeWidth = e),
                    t
            }
            complexColor(t, e, i) {
                ...
                eV(this.renderer, "complexColor", {
                    ...
                    if (t.radialGradient ? r = "radialGradient" : t.linearGradient && (r = "linearGradient"),
                        ...
                        if (a = t[r],
                            ...
                            "radialGradient" === r && p && !eY(a.gradientUnits) && (n = a,
                                a = eQ(a, s.getRadialAttr(p, n), {
                                    gradientUnits: "userSpaceOnUse"
                                })),
                            e0(a, function (t, e) {
                                "id" !== e && g.push(e, t)
                            ...
                            t.radAttr = n,
                                ...
                                l.forEach(function (e) {
                                    0 === e[1].indexOf("rgba") ? (d = (o = tG.parse(e[1])).get("rgb"),
                                        c = o.get("a")) : (d = e[1],
                                            c = 1);
            ...
            css(t) {
                ...
                if (e && e0(t, function (t, s) {
                    e && e[s] !== t && (i[s] = t,
                        r = !0)
                }),
                    r) {
                    e && (t = eU(e, i)),
                        null === t.width || "auto" === t.width ? delete this.textWidth : "text" === s.nodeName.toLowerCase() && t.width && (o = this.textWidth = e2(t.width)),
                        eU(this.styles, t),
                        o && !eI && this.renderer.forExport && delete t.width;
                    let r = eN && t.fontSize || null;
                    r && (eq(r) || /^\d+$/.test(r)) && (t.fontSize += "px");
                    let a = eQ(t);
            ...
            dSetter(t, e, i) {
                e_(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)),
                    this.pathArray = t,
            ...
            getBBox(t, e) {
                let i, s, o, r, { alignValue: a, element: n, renderer: h, styles: l, textStr: d } = this, { cache: c, cacheKeys: p } = h, u = n.namespaceURI === this.SVG_NS, g = e1(e, this.rotation, 0), f = h.styledMode ? n && e4.prototype.getStyle.call(n, "font-size") : l.fontSize;
                if (eY(d) && (-1 === (r = d.toString()).indexOf("<") && (r = r.replace(/\d/g, "0")),
                    r += ["", h.rootFontSize, f, g, this.textWidth, a, l.lineClamp, l.textOverflow, l.fontWeight].join(",")),
                    r && !t && (i = c[r]),
                    !i || i.polygon) {
                    if (u || h.forExport) {
                        try {
            ...
            getRotatedBox(t, e) {
                let { x: i, y: s, width: o, height: r } = t
                    ...
                    , D = Math.min(S, A, T, C)
                    , B = Math.min(P, O, E, L)
                    , I = Math.max(S, A, T, C) - D
                    , z = Math.max(P, O, E, L) - B;
                return {
                    x: D,
                    y: B,
                    width: I,
            ...
            getStyle(t) {
                return eR.getComputedStyle(this.element || this, "").getPropertyValue(t)
            }
            hasClass(t) {
            ...
            constructor(t, e) {
                this.onEvents = {},
                    this.opacity = 1,
                    this.SVG_NS = ez,
                    this.element = "span" === e || "body" === e ? eX(e) : eB.createElementNS(this.SVG_NS, e),
                    this.renderer = t,
                    this.styles = {},
                    eV(this, "afterInit")
            }
            ...
            removeClass(t) {
                return this.attr("class", ("" + this.attr("class")).replace(eJ(t) ? RegExp(`(^| )${t}( |$)`) : t, " ").replace(/ +/g, " ").trim())
            }
            removeTextOutline() {
            ...
            shadow(t) {
                let { renderer: e } = this
                    , i = eQ(this.parentGroup?.rotation === 90 ? {
                        offsetX: -1,
                        offsetY: -1
                    } : {}, eK(t) ? t : {})
            ...
            strokeWidth() {
                ...
                return /px$/.test(t) ? e = e2(t) : "" !== t && (eG(i = eB.createElementNS(ez, "rect"), {
                    width: t,
                    "stroke-width": 0
                }),
            ...
            symbolAttr(t) {
                let e = this;
                e4.symbolCustomAttribs.forEach(function (i) {
                    e[i] = e1(t[i], e[i])
                }),
                    e.attr({
            ...
            titleSetter(t) {
                ...
                e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i),
                    i.textContent = e5(e1(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }
            toFront() {
                let t = this.element;
            ...
            updateTransform(t = "transform") {
                ...
                eY(s) && u.push("matrix(" + s.join(",") + ")"),
                    ...
                    (eY(h) || eY(l)) && u.push("scale(" + e1(h, 1) + " " + e1(l, 1) + ")"),
            ...
            zIndexSetter(t, e) {
                ...
                if (eY(t) ? (r.setAttribute("data-z-index", t),
                    t *= 1,
                    this[e] === t && (p = !1)) : eY(this[e]) && r.removeAttribute("data-z-index"),
                    this[e] = t,
                    p) {
                    for ((t = this.zIndex) && s && (s.handleZ = !0),
                        u = (n = o.childNodes).length - 1; u >= 0 && !d; u--)
                        c = !eY(l = (h = n[u]).getAttribute("data-z-index")),
                            h !== r && (t < 0 && c && !a && !u ? (o.insertBefore(r, n[u]),
                                d = !0) : (e2(l) <= t || c && (!eY(t) || t >= 0)) && (o.insertBefore(r, n[u + 1]),
                                    d = !0));
        ...
        e4.symbolCustomAttribs = ["anchorX", "anchorY", "clockwise", "end", "height", "innerR", "r", "start", "width", "x", "y"],
            e4.prototype.strokeSetter = e4.prototype.fillSetter,
            e4.prototype.yGetter = e4.prototype.xGetter,
            e4.prototype.matrixSetter = e4.prototype.rotationOriginXSetter = e4.prototype.rotationOriginYSetter = e4.prototype.rotationSetter = e4.prototype.scaleXSetter = e4.prototype.scaleYSetter = e4.prototype.translateXSetter = e4.prototype.translateYSetter = e4.prototype.verticalAlignSetter = function (t, e) {
                this[e] = t,
                    this.doTransform = !0
            }
            ;
        let e8 = e4
            , { defined: e7, extend: it, getAlignFactor: ie, isNumber: ii, merge: is, pick: io, removeEvent: ir } = ts;
        class ia extends e8 {
            ...
            alignSetter(t) {
                ...
                this.textAlign = t,
                    e !== this.alignFactor && (this.alignFactor = e,
                        this.bBox && ii(this.xSetting) && this.attr({
                            x: this.xSetting
                        }))
            }
            anchorXSetter(t, e) {
            ...
            css(t) {
                ...
                return e8.prototype.css.call(this, t)
            }
            destroy() {
                ir(this.element, "mouseenter"),
                    ir(this.element, "mouseleave"),
                    this.text && this.text.destroy(),
                    this.box && (this.box = this.box.destroy()),
                    e8.prototype.destroy.call(this)
            }
            fillSetter(t, e) {
                t && (this.needsBox = !0),
                    this.fill = t,
            ...
            onAdd() {
                this.text.add(this),
                    this.attr({
                        text: io(this.textStr, ""),
                        x: this.x || 0,
                        y: this.y || 0
                    }),
                    this.box && e7(this.anchorX) && this.attr({
                        anchorX: this.anchorX,
                        anchorY: this.anchorY
                    })
            }
            paddingSetter(t, e) {
                ii(t) ? t !== this[e] && (this[e] = t,
            ...
            updateBoxSize() {
                let t, e = this.text, i = {}, s = this.padding, o = this.bBox = (!ii(this.widthSetting) || !ii(this.heightSetting) || this.textAlign) && e7(e.textStr) ? e.getBBox(void 0, 0) : ia.emptyBBox;
                ...
                if (this.baselineOffset = s + Math.min((this.text.firstLineMetrics || r).b, o.height || 1 / 0),
                    ...
                    i.x = t = this.getCrispAdjust(),
                        ...
                        this.box.attr(it(i, this.deferredAttr)),
                        this.deferredAttr = {}
                }
            }
            updateTextPadding() {
                ...
                if (!t.textPath) {
                    ...
                    let i = this.baseline ? 0 : this.baselineOffset
                        , s = (this.paddingLeft ?? this.padding) + ie(e) * (this.widthSetting ?? this.bBox.width);
                    (s !== t.x || i !== t.y) && (t.attr({
                        align: e,
                        x: s
                    }),
            ...
            widthSetter(t) {
                this.widthSetting = ii(t) ? t : void 0,
                    this.doUpdate = !0
            }
            getPaddedWidth() {
                let t = this.padding
                    , e = io(this.paddingLeft, t)
                    , i = io(this.paddingRight, t);
        ...
        ia.emptyBBox = {
            ...
            ia.textProps = ["color", "direction", "fontFamily", "fontSize", "fontStyle", "fontWeight", "lineClamp", "lineHeight", "textAlign", "textDecoration", "textOutline", "textOverflow", "whiteSpace", "width"];
        let { defined: ih, isNumber: il, pick: id } = ts;
        function ic(t, e, i, s, o) {
            ...
            if (o) {
                ...
                let p = o.innerR
                    ...
                    , m = Math.cos(n)
                    , x = Math.sin(n)
                    , y = id(o.longArc, n - a - Math.PI < d ? 0 : 1)
                    , b = ["A", h, l, 0, y, id(o.clockwise, 1), t + h * m, e + l * x];
                b.params = {
                    start: a,
                    end: n,
                    cx: t,
                    ...
                    ih(p) && ((b = ["A", p, p, 0, y, ih(o.clockwise) ? 1 - o.clockwise : 0, t + p * g, e + p * f]).params = {
                        start: n,
                        end: a,
                        cx: t,
                        cy: e
        ...
        function ip(t, e, i, s, o) {
            return o?.r ? iu(t, e, i, s, o) : [["M", t, e], ["L", t + i, e], ["L", t + i, e + s], ["L", t, e + s], ["Z"]]
        }
        ...
        let ig = {
            ...
            , { doc: im, SVG_NS: ix, win: iy } = D
            , { attr: ib, extend: iv, fireEvent: ik, isString: iM, objectEach: iw, pick: iS } = ts
            ...
            , iT = class {
                ...
                buildSVG() {
                    ...
                    if (n !== t.textCache) {
                        ...
                        if (o || this.ellipsis || this.width || t.textPath || -1 !== s.indexOf(" ") && (!this.noWrap || /<br.*?>/g.test(s))) {
                            ...
                            e.appendChild(im.createTextNode(this.unescapeEntities(s)));
                        iM(this.textOutline) && t.applyTextOutline && t.applyTextOutline(this.textOutline)
                    }
                }
                modifyDOM() {
                    let t, e = this.svgElement, i = ib(e.element, "x");
                        ...
                        if (n) {
                            ...
                            for (; a.length;)
                                if (a.length && !this.noWrap && d > 0 && (r.push(t.textContent || ""),
                                    ...
                                    a.length && (this.truncate(t, t.textContent || "", void 0, 0, s, l, iA),
                            ...
                            n.forEach(e => {
                                ...
                                r.forEach(e => {
                                    o.insertBefore(im.createTextNode(e), t);
                                    let s = im.createElementNS(ix, "tspan");
                                    s.textContent = "​",
                                        ib(s, {
                                            dy: h,
                                            x: i
                            ...
                            this.ellipsis && r && this.truncate(t, r, void 0, 0, s, l, iA)
                    }
                        , r = t => {
                            [].slice.call(t.childNodes).forEach(i => {
                                i.nodeType === iy.Node.TEXT_NODE ? o(i, t) : (-1 !== i.className.baseVal.indexOf("highcharts-br") && (e.actualWidth = 0),
                                    r(i))
                            }
                            )
                        }
                ...
                getLineHeight(t) {
                    let e = t.nodeType === iy.Node.TEXT_NODE ? t.parentElement : t;
                ...
                modifyTree(t) {
                    let e = (i, s) => {
                        ...
                        ;
                    t.forEach(e),
                        ik(this.svgElement, "afterModifyTree", {
                            nodes: t
                        })
                }
                truncate(t, e, i, s, o, r, a) {
                    ...
                    if (l.rotation = 0,
                        ...
                        0 === u ? t.textContent = "" : e && u === e.length - 1 || (t.textContent = n || a(e || i, g)),
                            this.ellipsis && h > o && this.truncate(t, t.textContent || "", void 0, 0, o, r, iA)
                    }
                    i && i.splice(0, g),
                        l.actualWidth = h,
                        l.rotation = d
                ...
                unescapeEntities(t, e) {
                    return iw(this.renderer.escapes, function (i, s) {
                        e && -1 !== e.indexOf(i) || (t = t.toString().replace(RegExp(i, "g"), s))
                    }),
                        t
                }
            }
            , { defaultOptions: iC } = tE
            , { charts: iP, deg2rad: iO, doc: iE, isFirefox: iL, isMS: iD, isWebKit: iB, noop: iI, SVG_NS: iz, symbolSizes: iR, win: iN } = D
            , { addEvent: iW, attr: iG, createElement: iX, crisp: iH, css: iF, defined: iY, destroyObjectProperties: ij, extend: iU, isArray: iV, isNumber: i$, isObject: i_, isString: iZ, merge: iq, pick: iK, pInt: iJ, replaceNested: iQ, uniqueKey: i0 } = ts;
        class i1 {
            constructor(t, e, i, s, o, r, a) {
                ...
                a || l.css(this.getStyle(s || {})),
                    t.appendChild(d),
                    iG(t, "dir", "ltr"),
                    -1 === t.innerHTML.indexOf("xmlns") && iG(d, "xmlns", this.SVG_NS),
                    this.box = d,
                    this.boxWrapper = l,
                    this.alignedObjects = [],
                    this.url = this.getReferenceURL(),
                    this.createElement("desc").add().element.appendChild(iE.createTextNode("Created with Highcharts 12.4.0")),
                    ...
                    this.setSize(e, i, !1),
                    iL && t.getBoundingClientRect && ((n = function () {
                        iF(t, {
                            left: 0,
                            top: 0
                        }),
                        ...
                        this.unSubPixelFix = iW(iN, "resize", n))
            }
            definition(t) {
                return new er([t]).addToDOM(this.defs.element)
            }
            getReferenceURL() {
                if ((iL || iB) && iE.getElementsByTagName("base").length) {
                    if (!iY(e)) {
                        let t = i0()
                            , i = new er([{
                                tagName: "svg",
                        ...
                        let s = iE.elementFromPoint(6, 6);
                        e = s?.id === "hitme",
                            iE.body.removeChild(i)
                    }
                    if (e)
                        return iQ(iN.location.href.split("#")[0], [/<[^>]*>/g, ""], [/([\('\)])/g, "\\$1"], [/ /g, "%20"])
                }
                return ""
            }
            getStyle(t) {
            ...
            button(t, e, i, s, o = {}, r, a, n, h, l) {
                ...
                delete o.states,
                    delete o.style;
                let m = [er.filterUserAttributes(o)]
                    , x = [f];
                return c || ["hover", "select", "disabled"].forEach((t, e) => {
                    m.push(iq(m[0], er.filterUserAttributes(p[e + 5] || g[t] || {}))),
                        x.push(m[e + 1].style),
                        delete m[e + 1].style
                }
                ),
                    iW(d.element, iD ? "mouseover" : "mouseenter", function () {
                        3 !== u && d.setState(1)
                    }),
                    iW(d.element, iD ? "mouseout" : "mouseleave", function () {
                        3 !== u && d.setState(u)
                    }),
                    d.setState = (t = 0) => {
                        if (1 !== t && (d.state = u = t),
            ...
            crispLine(t, e) {
                let [i, s] = t;
                return iY(i[1]) && i[1] === s[1] && (i[1] = s[1] = iH(i[1], e)),
                    iY(i[2]) && i[2] === s[2] && (i[2] = s[2] = iH(i[2], e)),
                    t
            }
            path(t) {
                ...
                return iV(t) ? e.d = t : i_(t) && iU(e, t),
                    this.createElement("path").attr(e)
            }
            circle(t, e, i) {
                let s = i_(t) ? t : void 0 === t ? {} : {
                    x: t,
                    y: e,
                    r: i
                }
            ...
            symbol(t, e, i, s, o, r) {
                ...
                if (g)
                    ...
                    s.imgwidth = iK(r?.width, iR[h]?.width),
                        s.imgheight = iK(r?.height, iR[h]?.height),
                        l = t => t.attr({
                            width: t.width,
                            height: t.height
                        }),
                        ...
                        s.isImg = !0,
                        s.symbolUrl = t,
                        iY(s.imgwidth) && iY(s.imgheight) ? l(s) : (s.attr({
                            width: 0,
                            height: 0
                        }),
                            iX("img", {
                                onload: function () {
                                    let t = iP[d.chartIndex];
                                    0 === this.width && (iF(this, {
                                        position: "absolute",
                                        top: "-999em"
                                    }),
                                        iE.body.appendChild(this)),
                                        iR[h] = {
                                            width: this.width,
                                            height: this.height
                                        },
            ...
            fontMetrics(t) {
                let e = i$(t) ? t : iJ(e8.prototype.getStyle.call(t, "font-size") || 0)
            ...
            rotCorr(t, e, i) {
                let s = t;
                return e && i && (s = Math.max(s * Math.cos(e * iO), 4)),
                {
                    x: -t / 3 * Math.sin(e * iO),
                    y: s
                }
            ...
            pathToSegments(t) {
                ...
                for (let o = 0; o < t.length; o++)
                    iZ(i[0]) && i$(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")),
            ...
            label(t, e, i, s, o, r, a, n, h) {
                return new ia(this, t, e, i, s, o, r, a, n, h)
            }
            alignElements() {
        ...
        iU(i1.prototype, {
            ...
            ew.registerRendererType("svg", i1, !0);
        let { composed: i2, isFirefox: i3 } = D
            , { attr: i5, css: i6, createElement: i9, defined: i4, extend: i8, getAlignFactor: i7, isNumber: st, pInt: se, pushUnique: si } = ts;
        function ss(t, e, i) {
            let s = this.div?.style;
            e8.prototype[`${e}Setter`].call(this, t, e, i),
                s && (i.style[e] = s[e] = t)
        }
        let so = (t, e) => {
            if (!t.div) {
                let i = i5(t.element, "class")
                    , s = t.css
                    , o = i9("div", i ? {
                        className: i
                    } : void 0, {
        ...
        class sr extends e8 {
            static compose(t) {
                si(i2, this.compose) && (t.prototype.html = function (t, e, i) {
                    return new sr(this, "span").attr({
                        text: t,
                        x: Math.round(e),
                        y: Math.round(i)
                    })
            ...
            constructor(t, e) {
                super(t, e),
                    sr.useForeignObject ? this.foreignObject = t.createElement("foreignObject").attr({
                        zIndex: 2
                    }) : this.css({
                        position: "absolute",
                        ...t.styledMode ? {} : {
            ...
            css(t) {
                ...
                return s && (delete t.width,
                    ...
                    t?.lineClamp && (t.display = "-webkit-box",
                        ...
                        t.overflow = "hidden"),
                    st(Number(t?.fontSize)) && (t.fontSize += "px"),
                    i8(this.styles, t),
                    i6(i, t),
            ...
            updateTransform() {
                ...
                if (e || i6(t, {
                    ...
                    "SPAN" === t.tagName) {
                    let u, g = [o, c, t.innerHTML, p, this.textAlign].join(","), x = -(this.parentGroup?.padding * 1) || 0;
                    if (p !== i) {
                        let e = this.textPxLength ? this.textPxLength : (i6(t, {
                            width: "",
                            whiteSpace: d || "nowrap"
                        }),
                            t.offsetWidth)
                        ...
                        (r > i || e > r || a) && (/[\-\s\u00AD]/.test(t.textContent || t.innerText) || "ellipsis" === t.style.textOverflow) && (i6(t, {
                            width: (o || n || e > r || a) && st(p) ? p + "px" : "auto",
                            display: l,
                            whiteSpace: d || "normal"
                        }),
                            this.oldTextWidth = p)
                    ...
                    e && (i6(t, {
                        ...
                        g !== this.cTT && (u = s.fontMetrics(t).b,
                            i4(o) && !e && (o !== (this.oldRotation || 0) || c !== this.oldAlign) && i6(t, {
                                transform: `rotate(${o}deg)`,
                                transformOrigin: `${x}% ${x}px`
                            }),
                            this.getSpanCorrection(!i4(o) && !this.textWidth && this.textPxLength || t.offsetWidth, u, i7(c)));
        ...
        let sa = sr.prototype;
        sa.visibilitySetter = sa.opacitySetter = ss,
            sa.ySetter = sa.rotationSetter = sa.rotationOriginXSetter = sa.rotationOriginYSetter = sa.xSetter,
            !function (t) {
                t.xAxis = {
                    alignTicks: !0,
        ...
        let sn = l
            , { addEvent: sh, isFunction: sl, objectEach: sd, removeEvent: sc } = ts;
        (d || (d = {})).registerEventOptions = function (t, e) {
            t.eventOptions = t.eventOptions || {},
                sd(e.events, function (e, i) {
                    t.eventOptions[i] !== e && (t.eventOptions[i] && (sc(t, i, t.eventOptions[i]),
                        delete t.eventOptions[i]),
                        sl(e) && (t.eventOptions[i] = e,
                            sh(t, i, e, {
                                order: 0
                            })))
                })
        ...
        let sp = d
            , { deg2rad: su } = D
            , { clamp: sg, correctFloat: sf, defined: sm, destroyObjectProperties: sx, extend: sy, fireEvent: sb, getAlignFactor: sv, isNumber: sk, merge: sM, objectEach: sw, pick: sS } = ts
            , sA = class {
                ...
                addLabel() {
                    let t = this, e = t.axis, i = e.options, s = e.chart, o = e.categories, r = e.logarithmic, a = e.names, n = t.pos, h = sS(t.options?.labels, i.labels), l = e.tickPositions, d = n === l[0], c = n === l[l.length - 1], p = (!h.step || 1 === h.step) && 1 === e.tickInterval, u = l.info, g = t.label, f, m, x, y = this.parameters.category || (o ? sS(o[n], a[n], n) : n);
                    r && sk(y) && (y = sf(r.lin2log(y))),
                        e.dateTime && (u ? f = (m = s.time.resolveDTLFormat(i.dateTimeLabelFormats[!i.grid?.enabled && u.higherRanks[n] || u.unitName])).main : sk(y) && (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
                        t.isFirst = d,
                        t.isLast = c;
                    let b = {
                        axis: e,
                    ...
                    M ? t.shortenLabel = function () {
                        ...
                        sm(g) || t.movedLabel ? g && g.textStr !== k && !p && (!g.textWidth || h.style.width || g.styles.width || g.css({
                            width: null
                        }),
                            g.attr({
                                text: k
                ...
                createLabel(t, e, i) {
                    let s = this.axis
                        ...
                        , n = sm(t) && e.enabled ? o.text(t, i?.x, i?.y, e.useHTML).add(s.labelGroup) : void 0;
                    return n && (r || n.css(sM(e.style)),
                ...
                getPosition(t, e, i, s) {
                    let o = this.axis
                        ...
                        , n = {
                            x: t ? sf(o.translate(e + i, void 0, void 0, s) + o.transB) : o.left + o.offset + (o.opposite ? (s && r.oldChartWidth || r.chartWidth) - o.right - o.left : 0),
                            y: t ? a - o.bottom + o.offset - (o.opposite ? o.height : 0) : sf(a - o.translate(e + i, void 0, void 0, s) - o.transB)
                        };
                    return n.y = sg(n.y, -1e9, 1e9),
                        sb(this, "afterGetPosition", {
                            pos: n
                        }),
                        n
                }
                getLabelPosition(t, e, i, s, o, r, a, n) {
                    ...
                    return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? g.y + m : Math.cos(i.rotation * su) * (g.y - i.getBBox(!1, 0).height / 2),
                        sm(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
                        t = t + sS(o.x, [0, 1, 0, -1][d.side] * m) + f + g.x - (r && s ? r * c * (p ? -1 : 1) : 0),
                ...
                handleOverflow(t) {
                    let e = this.axis, i = e.options.labels, s = t.x, o = e.chart.chartWidth, r = e.chart.spacing, a = sS(e.labelLeft, Math.min(e.pos, r[3])), n = sS(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, o - r[1])), h = this.label, l = this.rotation, d = sv(e.labelAlign || h.attr("align")), c = h.getBBox().width, p = e.getSlotWidth(this), u = p, g = 1, f;
                    l || "justify" !== i.overflow ? l < 0 && s - d * c < a ? f = Math.round(s / Math.cos(l * su) - a) : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * su))) : (s - d * c < a ? u = t.x + u * (1 - d) - a : s + (1 - d) * c > n && (u = n - t.x + u * d,
                        g = -1),
                        (u = Math.min(p, u)) < p && "center" === e.labelAlign && (t.x += g * (p - u - d * (p - Math.min(c, u)))),
                        (c > u || e.autoRotation && h?.styles?.width) && (f = u)),
                        f && h && (this.shortenLabel ? this.shortenLabel() : h.css(sy({}, {
                ...
                moveLabel(t, e) {
                    ...
                    s && s.textStr === t ? (i.movedLabel = s,
                        r = !0,
                        delete i.label) : sw(o.ticks, function (e) {
                ...
                render(t, e, i) {
                    let s = this.axis
                        , o = s.horiz
                        , r = this.pos
                        , a = sS(this.tickmarkOffset, s.tickmarkOffset)
                        ...
                        , c = d + s.len
                        , p = o ? h : l
                        , u = sS(i, this.label?.newOpacity, 1);
                    !s.chart.polar && (sf(p) < d || p > c) && (i = 0),
                        i ?? (i = 1),
                        this.isActive = !0,
                ...
                renderGridLine(t, e) {
                    let i = this.axis, s = i.options, o = {}, r = this.pos, a = this.type, n = sS(this.tickmarkOffset, i.tickmarkOffset), h = i.chart.renderer, l = this.gridLine, d, c = s.gridLineWidth, p = s.gridLineColor, u = s.gridLineDashStyle;
                ...
                renderMark(t, e) {
                    let i = this.axis
                        ...
                        , n = t.x
                        , h = t.y
                        , l = sS(s["minor" !== r ? "tickWidth" : "minorTickWidth"], !r && i.isXAxis ? 1 : 0)
                ...
                renderLabel(t, e, i, s) {
                    let o = this.axis
                        ...
                        , h = a.labels
                        , l = h.step
                        , d = sS(this.tickmarkOffset, o.tickmarkOffset)
                        , c = t.x
                        , p = t.y
                        , u = !0;
                    n && sk(c) && (n.xy = t = this.getLabelPosition(c, p, n, r, h, d, s, l),
            ...
            , { animObject: sT } = t1
            , { xAxis: sC, yAxis: sP } = sn
            , { defaultOptions: sO } = tE
            , { registerEventOptions: sE } = sp
            , { deg2rad: sL } = D
            , { arrayMax: sD, arrayMin: sB, clamp: sI, correctFloat: sz, defined: sR, destroyObjectProperties: sN, erase: sW, error: sG, extend: sX, fireEvent: sH, getClosestDistance: sF, insertItem: sY, isArray: sj, isNumber: sU, isString: sV, merge: s$, normalizeTickInterval: s_, objectEach: sZ, pick: sq, relativeLength: sK, removeEvent: sJ, splat: sQ, syncTimeout: s0 } = ts
            , s1 = (t, e) => s_(e, void 0, void 0, sq(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
        sX(sO, {
            xAxis: sC,
            yAxis: s$(sC, sP)
        });
        class s2 {
            ...
            init(t, e, i = this.coll) {
                ...
                this.chart = t,
                    ...
                    this.opposite = sq(e.opposite, this.opposite),
                    this.side = sq(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3),
                    this.setOptions(e);
                let r = this.options
                    , a = r.labels;
                this.type ?? (this.type = r.type || "linear"),
                    this.uniqueNames ?? (this.uniqueNames = r.uniqueNames ?? !0),
                    sH(this, "afterSetType"),
                    this.userOptions = e,
                    this.minPixelPadding = 0,
                    this.reversed = sq(r.reversed, this.reversed),
                    this.visible = r.visible,
                    this.zoomEnabled = r.zoomEnabled,
                    this.hasNames = "category" === this.type || !0 === r.categories,
                    this.categories = sj(r.categories) && r.categories || (this.hasNames ? [] : void 0),
                    this.names || (this.names = [],
                        this.names.keys = {}),
                    this.plotLinesAndBandsGroups = {},
                    this.positiveValuesOnly = !!this.logarithmic,
                    this.isLinked = sR(r.linkedTo),
                    this.ticks = {},
                    this.labelEdge = [],
                    this.minorTicks = {},
                    ...
                    this.max = void 0,
                    this.min = void 0;
                let n = sq(r.crosshair, sQ(t.options.tooltip.crosshairs)[+!s]);
                this.crosshair = !0 === n ? {} : n,
                    ...
                    t.inverted && !this.isZAxis && s && !sR(this.reversed) && (this.reversed = !0),
                    this.labelRotation = sU(a.rotation) ? a.rotation : void 0,
                    sE(this, r),
                    sH(this, "afterInit")
            }
            setOptions(t) {
                ...
                this.options = s$(e, "yAxis" === this.coll ? {
                    title: {
                        text: this.chart.options.lang.yAxisTitle
                    }
                } : {}, sO[this.coll], t),
                    sH(this, "afterSetOptions", {
                        userOptions: t
                    })
            }
            defaultLabelFormatter() {
                let t = this.axis, { numberFormatter: e } = this.chart, i = sU(this.value) ? this.value : NaN, s = t.chart.time, o = t.categories, r = this.dateTimeLabelFormat, a = sO.lang, n = a.numericSymbols, h = a.numericSymbolMagnitude || 1e3, l = t.logarithmic ? Math.abs(i) : t.tickInterval, d = n?.length, c, p;
                if (o)
                    p = `${this.value}`;
                else if (r)
                            ...
                            if (i.reserveSpace()) {
                                ...
                                if (e.hasVisibleSeries = !0,
                                    ...
                                    (o = i.getColumn("x")).length && (o = e.logarithmic ? o.filter(t => t > 0) : o,
                                        ...
                                        n = t.max,
                                        sU(a) || a instanceof Date || (o = o.filter(sU),
                                            a = (t = i.getXExtremes(o)).min,
                                            n = t.max),
                                        o.length && (e.dataMin = Math.min(sq(e.dataMin, a), a),
                                            e.dataMax = Math.max(sq(e.dataMax, n), n)));
                                else {
                                    let t = i.applyExtremes();
                                    sU(t.dataMin) && (a = t.dataMin,
                                        e.dataMin = Math.min(sq(e.dataMin, a), a)),
                                        sU(t.dataMax) && (n = t.dataMax,
                                            e.dataMax = Math.max(sq(e.dataMax, n), n)),
                                        sR(r) && (e.threshold = r),
            ...
            getPlotLinePath(t) {
                ...
                function y(t, e, i) {
                    return "pass" !== p && (t < e || t > i) && (p ? t = sI(t, e, i) : x = !0),
                        t
                }
                let b = {
                    value: a,
                ...
                return sH(this, "getPlotLinePath", b, function (t) {
                    u = f = (c = sI(c = sq(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d,
                        g = m = h - c - d,
                        sU(c) ? e.horiz ? (g = o,
            ...
            getLinearTickPositions(t, e, i) {
                let s, o, r, a = sz(Math.floor(e / t) * t), n = sz(Math.ceil(i / t) * t), h = [];
                if (sz(a + t) === a && (r = 20),
                    this.single)
                    return [e];
            ...
            getMinorTickInterval() {
                ...
                return !0 === t ? sq(e, "auto") : !1 !== t ? e : void 0
            }
            ...
            adjustForMinRange() {
                ...
                this.isXAxis && void 0 === r && !e && (r = sR(t.min) || sR(t.max) || sR(t.floor) || sR(t.ceiling) ? null : Math.min(5 * (sF(this.series.map(t => {
                    let e = t.getColumn("x");
                    return t.xIncrement ? e.slice(0, 2) : e
                }
                )) || 0), this.dataMax - this.dataMin)),
                    sU(s) && sU(o) && sU(r) && s - o < r && (n = this.dataMax - this.dataMin >= r,
                        a = (r - s + o) / 2,
                ...
                if (this.categories)
                    ...
                    this.series.forEach(function (t) {
                        let s = t.closestPointRange
                            , o = t.getColumn("x");
                        1 === o.length ? i.push(o[0]) : t.sorted && sR(s) && t.reserveSpace() && (e = sR(e) ? Math.min(e, s) : s)
                    }),
            ...
            nameToX(t) {
                let e = sj(this.options.categories), i = e ? this.categories : this.names, s = t.options.x, o;
                return t.series.requireSorting = !1,
                    sR(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : sq(i.keys[t.name], -1) : t.series.autoIncrement()),
                    -1 === s ? !e && i && (o = i.length) : sU(s) && (o = s),
                ...
                (o || s || r) && (a = t.getClosest(),
                    i ? (n = i.minPointOffset,
                        h = i.pointRangePadding) : t.series.forEach(function (e) {
                            let i = s ? 1 : o ? sq(e.options.pointRange, a, 0) : t.axisPointRange || 0
                                , l = e.options.pointPlacement;
                            if (r = Math.max(r, i),
                                !t.single || s) {
                                let t = e.is("xrange") ? !o : o;
                                n = Math.max(n, t && sV(l) ? 0 : i / 2),
                    ...
                    sH(this, "afterSetAxisTranslation")
            }
            minFromRange() {
            ...
            setTickInterval(t) {
                let { categories: e, chart: i, dataMax: s, dataMin: o, dateTime: r, isXAxis: a, logarithmic: n, options: h, softThreshold: l } = this, d = i.time, c = sU(this.threshold) ? this.threshold : void 0, p = this.minRange || 0, { ceiling: u, floor: g, linkedTo: f, softMax: m, softMin: x } = h, y = sU(f) && i[this.coll]?.[f], b = h.tickPixelInterval, v = h.maxPadding, k = h.minPadding, M = 0, w, S = sU(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0, A, T, C, P;
                if (r || e || y || this.getTickAmount(),
                    C = sq(this.userMin, d.parse(h.min)),
                    P = sq(this.userMax, d.parse(h.max)),
                    y ? (this.linkedParent = y,
                        w = y.getExtremes(),
                        this.min = sq(w.min, w.dataMin),
                        this.max = sq(w.max, w.dataMax),
                        this.type !== y.type && sG(11, !0, i)) : (l && sR(c) && sU(s) && sU(o) && (o >= c ? (A = c,
                            k = 0) : s <= c && (T = c,
                                v = 0)),
                            this.min = sq(C, A, o),
                            this.max = sq(P, T, s)),
                    sU(this.max) && sU(this.min) && (n && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, sq(o, this.min)) && sG(10, !0, i),
                        this.min = sz(n.log2lin(this.min), 16),
                        this.max = sz(n.log2lin(this.max), 16)),
                        this.range && sU(o) && (this.userMin = this.min = C = Math.max(o, this.minFromRange() || 0),
                            this.userMax = P = this.max,
                            this.range = void 0)),
                    sH(this, "foundExtremes"),
                    this.adjustForMinRange(),
                    sU(this.min) && sU(this.max)) {
                    if (!sU(this.userMin) && sU(x) && x < this.min && (this.min = C = x),
                        !sU(this.userMax) && sU(m) && m > this.max && (this.max = P = m),
                        e || this.axisPointRange || this.stacking?.usePercentage || y || (M = this.max - this.min) && (!sR(C) && k && (this.min -= M * k),
                            !sR(P) && v && (this.max += M * v)),
                        !sU(this.userMin) && sU(g) && (this.min = Math.max(this.min, g)),
                        !sU(this.userMax) && sU(u) && (this.max = Math.min(this.max, u)),
                        l && sU(o) && sU(s)) {
                        let t = c || 0;
                        !sR(C) && this.min < t && o >= t ? this.min = h.minRange ? Math.min(t, this.max - p) : t : !sR(P) && this.max > t && s <= t && (this.max = h.minRange ? Math.max(t, this.min + p) : t)
                    }
                    !i.polar && this.min > this.max && (sR(h.min) ? this.max = this.min : sR(h.max) && (this.min = this.max)),
                        M = this.max - this.min
                }
                if (this.min !== this.max && sU(this.min) && sU(this.max) ? y && !S && b === y.options.tickPixelInterval ? this.tickInterval = S = y.tickInterval : this.tickInterval = sq(S, this.tickAmount ? M / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : M * b / Math.max(this.len, b)) : this.tickInterval = 1,
                    a && !t) {
                ...
                this.setAxisTranslation(),
                    sH(this, "initialAxisTranslation"),
                    this.pointRange && !S && (this.tickInterval = Math.max(this.pointRange, this.tickInterval));
                let O = sq(h.minTickInterval, r && !this.series.some(t => !t.sorted) ? this.closestPointRange : 0);
                !S && O && this.tickInterval < O && (this.tickInterval = O),
                    r || n || S || (this.tickInterval = s1(this, this.tickInterval)),
            ...
            setTickPositions() {
                ...
                if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0,
                    this.single = this.min === this.max && sR(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals),
                    e)
                    n = e.slice();
                    ...
                    if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                        ...
                        for (; e <= 2 * t;)
                            if (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max),
                                ...
                                this.tickInterval = s1(this, e *= 1.1);
                            else
                                break
                    }
                ...
                this.tickPositions = n,
                    ...
                    !this.isLinked && sU(this.min) && sU(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5,
                        this.max += .5),
                        e || h || this.adjustTickAmount()),
                    sH(this, "afterSetTickPositions")
            }
            trimTicks(t, e, i) {
                let s = t[0]
                    , o = t[t.length - 1]
                    , r = !this.isOrdinal && this.minPointOffset || 0;
                if (sH(this, "trimTicks"),
                    ...
                    if (i)
                        ...
                        for (; this.max + r < t[t.length - 1];)
                            t.pop();
                    0 === t.length && sR(s) && !this.options.tickPositions && t.push((o + s) / 2)
                }
            }
            alignToOthers() {
            ...
            getThresholdAlignment(t) {
                if ((!sU(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData)) && this.getSeriesExtremes(),
                    sU(this.threshold)) {
                    let t = sI((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1);
            ...
            getTickAmount() {
                let t = this.options
                    ...
                    , i = t.tickAmount;
                sR(t.tickInterval) || i || !(this.len < e) || this.isRadial || this.logarithmic || !t.startOnTick || !t.endOnTick || (i = 2),
            ...
            adjustTickAmount() {
                let t = this, { finalTickAmt: e, max: i, min: s, options: o, tickPositions: r, tickAmount: a, thresholdAlignment: n } = t, h = r?.length, l = sq(t.threshold, t.softThreshold ? 0 : null), d, c, p = t.tickInterval, u, g = () => r.push(sz(r[r.length - 1] + p)), f = () => r.unshift(sz(r[0] - p));
                if (sU(n) && (u = n < .5 ? Math.ceil(n * (a - 1)) : Math.floor(n * (a - 1)),
                    o.reversed && (u = a - 1 - u)),
                    t.hasData() && sU(s) && sU(i)) {
                    let n = () => {
                        t.transA *= (h - 1) / (a - 1),
            ...
            setAxisSize() {
                let t = this.chart
                    ...
                    , i = e.offsets || [0, 0, 0, 0]
                    , s = this.horiz
                    , o = this.width = Math.round(sK(sq(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth))
                    , r = this.height = Math.round(sK(sq(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight))
                    , a = this.top = Math.round(sK(sq(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop))
                    , n = this.left = Math.round(sK(sq(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft));
            ...
            getExtremes() {
                ...
                return {
                    min: t ? sz(t.lin2log(this.min)) : this.min,
                    max: t ? sz(t.lin2log(this.max)) : this.max,
            ...
            autoLabelAlign(t) {
                let e = (sq(t, 0) - 90 * this.side + 720) % 360
                    , i = {
                        align: "center"
                    };
                return sH(this, "autoLabelAlign", i, function (t) {
                    e > 15 && e < 165 ? t.align = "right" : e > 195 && e < 345 && (t.align = "left")
                }),
                    i.align
            }
            tickSize(t) {
                let e = this.options, i = sq(e["tick" === t ? "tickWidth" : "minorTickWidth"], "tick" === t && this.isXAxis && !this.categories ? 1 : 0), s = e["tick" === t ? "tickLength" : "minorTickLength"], o;
                i && s && ("inside" === e[t + "Position"] && (s = -s),
                    o = [s, i]);
                let r = {
                    tickSize: o
                };
                return sH(this, "afterTickSize", r),
                    r.tickSize
            }
            labelMetrics() {
            ...
            unsquish() {
                let t = this.options.labels, e = t.padding || 0, i = this.horiz, s = this.tickInterval, o = this.len / ((+!!this.categories + this.max - this.min) / s), r = t.rotation, a = sz(.8 * this.labelMetrics().h), n = Math.max(this.max - this.min, 0), h = function (t) {
                    let i = (t + 2 * e) / (o || 1);
                    return (i = i > 1 ? Math.ceil(i) : 1) * s > n && t !== 1 / 0 && o !== 1 / 0 && n && (i = Math.ceil(n / s)),
                        sz(i * s)
                }, l = s, d, c = Number.MAX_VALUE, p;
                if (i) {
                    if (!t.staggerLines && (sU(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)),
                        p) {
                        let t, e;
                        for (let i of p)
                            (i === r || i && i >= -90 && i <= 90) && (e = (t = h(Math.abs(a / Math.sin(sL * i)))) + Math.abs(i / 360)) < c && (c = e,
                                d = i,
                                l = t)
                    }
                } else
                ...
                return this.autoRotation = p,
                    this.labelRotation = sq(d, sU(r) ? r : 0),
                    t.step ? s : l
            }
            getSlotWidth(t) {
                let e = this.chart
            ...
            renderUnsquish() {
                ...
                sV(o.rotation) || (l.rotation = o.rotation || 0),
                    ...
                    i.forEach(function (t) {
                        let e = s[t]
                            ...
                            , a = {};
                        i && (i.attr(l),
                            e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "SPAN" === i.element.tagName) ? i.css(sX(a, {
                                width: `${p}px`,
                                lineClamp: u
            ...
            addTitle(t) {
                ...
                this.axisTitle || ((e = r.textAlign) || (e = (s ? {
                    ...
                    a || this.axisTitle.css(s$(r.style)),
            ...
            getOffset() {
                let t = this, { chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n } = t, h = e.inverted && !t.isZAxis ? [1, 0, 3, 2][o] : o, l = t.hasData(), d = s.title, c = s.labels, p = sU(s.crossing), u = e.axisOffset, g = e.clipOffset, f = [-1, 1, 1, -1][o], m, x = 0, y, b = 0, v = 0, k, M;
                if (t.showAxis = m = l || s.showEmpty,
                    ...
                    l || t.isLinked ? (a.forEach(function (e) {
                        ...
                        sq(c.reserveSpace, !p && null, "center" === t.labelAlign || null, t.reserveSpaceDefault) && a.forEach(function (t) {
                            v = Math.max(r[t].getLabelSize(), v)
                        }),
                        t.staggerLines && (v *= t.staggerLines),
                        t.labelOffset = v * (t.opposite ? -1 : 1)) : sZ(r, function (t, e) {
                            t.destroy(),
                                delete r[e]
                        }),
                    d?.text && !1 !== d.enabled && (t.addTitle(m),
                        m && !p && !1 !== d.reserveSpace && (t.titleOffset = x = t.axisTitle.getBBox()[i ? "height" : "width"],
                            b = sR(y = d.offset) ? 0 : sq(d.margin, i ? 5 : 10))),
                    t.renderLine(),
                    t.offset = f * sq(s.offset, u[o] ? u[o] + (s.margin || 0) : 0),
                    ...
                    k = Math.abs(v) + b,
                    v && (k -= M,
                        k += f * (i ? sq(c.y, t.tickRotCorr.y + f * c.distance) : sq(c.x, f * c.distance))),
                    t.axisTitleMargin = sq(y, k),
            ...
            renderTick(t, e, i) {
                let s = this.isLinked
                    , o = this.ticks;
                (!s || t >= this.min && t <= this.max || this.grid?.isColumn) && (o[t] || (o[t] = new sA(this, t)),
                    i && o[t].isNew && o[t].render(e, !0, -1),
                    o[t].render(e))
            }
            render() {
                let t, e, i = this, s = i.chart, o = i.logarithmic, r = s.renderer, a = i.options, n = i.isLinked, h = i.tickPositions, l = i.axisTitle, d = i.ticks, c = i.minorTicks, p = i.alternateBands, u = a.stackLabels, g = a.alternateGridColor, f = a.crossing, m = i.tickmarkOffset, x = i.axisLine, y = i.showAxis, b = sT(r.globalAnimation);
                ...
                if (i.hasData() || n) {
                    let r = i.chart.hasRendered && i.old && sU(i.old.min);
                    i.minorTickInterval && !i.categories && i.getMinorTickPositions().forEach(function (t) {
                        ...
                        h.length && (h.forEach(function (t, e) {
                            ...
                            m && (0 === i.min || i.single) && (d[-1] || (d[-1] = new sA(i, -1, null, !0)),
                                d[-1].render(-1))),
                        g && h.forEach(function (r, a) {
                            e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m,
                                a % 2 == 0 && r < i.max && e <= i.max + (s.polar ? -m : m) && (p[r] || (p[r] = new D.PlotLineOrBand(i, {})),
                                    t = r + m,
                                    p[r].options = {
            ...
            getKeepProps() {
                return this.keepProps || s2.keepProps
            }
            destroy(t) {
                let e = this
            ...
            drawCrosshair(t, e) {
                ...
                if (sH(this, "drawCrosshair", {
                    ...
                    t || (t = this.cross?.e),
                    i && !1 !== (sR(e) || !s)) {
                    if (s ? sR(e) && (a = sq("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY)) : a = t && (this.horiz ? t.chartX - this.pos : this.len - t.chartY + this.pos),
                        sR(a) && (l = {
                            value: e && (this.isXAxis ? e.x : sq(e.stackY, e.y)),
                            translatedValue: a
                        },
                            o.polar && sX(l, {
                                isCrosshair: !0,
            ...
            hideCrosshair() {
                this.cross && this.cross.hide(),
                    sH(this, "afterHideCrosshair")
            }
            update(t, e) {
                let i = this.chart;
                t = s$(this.userOptions, t),
                    this.destroy(!0),
                    this.init(i, t),
                    i.isDirtyBox = !0,
                    sq(e, !0) && i.redraw()
        ...
        s2.keepProps = ["coll", "extKey", "hcEvents", "len", "names", "series", "userMax", "userMin"];
        let { addEvent: s3, getMagnitude: s5, normalizeTickInterval: s6, timeUnits: s9 } = ts;
        !function (t) {
            function e() {
            ...
            class s {
                ...
                normalizeTimeTickInterval(t, e) {
                    let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], s = i[i.length - 1], o = s9[s[0]], r = s[1], a;
                    for (a = 0; a < i.length && (o = s9[(s = i[a])[0]],
                        r = s[1],
                        !i[a + 1] || !(t <= (o * r[r.length - 1] + s9[i[a + 1][0]]) / 2)); a++)
                        ;
                    o === s9.year && t < 5 * o && (r = [1, 2, 5]);
                    let n = s6(t / o, r, "year" === s[0] ? Math.max(s5(t / o), 1) : 1);
                    return {
                        unitRange: o,
                        count: n,
                        unitName: s[0]
        ...
        let s4 = c
            , { addEvent: s8, normalizeTickInterval: s7, pick: ot } = ts;
        !function (t) {
            function e() {
            ...
            class s {
                ...
                getLogTickPositions(t, e, i, s) {
                    ...
                    if (s || (this.minorAutoInterval = void 0),
                        ...
                        t = s7(t = ot("auto" === d ? null : d, this.minorAutoInterval, (l - h) * c / (p || 1))),
        ...
        let oe = p
            , { erase: oi, extend: os, isNumber: oo } = ts;
        !function (t) {
            let e;
            function i(t) {
            ...
            function r(t, e, i) {
                ...
                }), o = [], r = this.horiz, a = !oo(this.min) || !oo(this.max) || t < this.min && e < this.min || t > this.max && e > this.max, n = this.getPlotLinePath({
                    value: t,
                    force: !0,
                    acrossPanes: i.acrossPanes
                }), h, l = 1, d;
        ...
        let or = u
            , { addEvent: oa, arrayMax: on, arrayMin: oh, defined: ol, destroyObjectProperties: od, erase: oc, fireEvent: op, merge: ou, objectEach: og, pick: of } = ts;
        class om {
            static compose(t, e) {
                return oa(t, "afterInit", function () {
            ...
            render() {
                op(this, "render");
                let { axis: t, options: e } = this, { horiz: i, logarithmic: s } = t, { color: o, events: r, zIndex: a = 0 } = e, { renderer: n, time: h } = t.chart, l = {}, d = h.parse(e.to), c = h.parse(e.from), p = h.parse(e.value), u = e.borderWidth, g = e.label, { label: f, svgElem: m } = this, x = [], y, b = ol(c) && ol(d), v = ol(p), k = !m, M = {
                    class: "highcharts-plot-" + (b ? "band " : "line ") + (e.className || "")
                }, w = b ? "bands" : "lines";
                if (!t.chart.styledMode && (v ? (M.stroke = o || "#999999",
                    M["stroke-width"] = of(e.width, 1),
                ...
                return !this.eventsAdded && r && (og(r, (t, e) => {
                    m?.on(e, t => {
                        r[e].apply(this, [t])
                    }
                    )
                    ...
                    g && (ol(g.text) || ol(g.formatter)) && x?.length && t.width > 0 && t.height > 0 && !x.isFlat ? (g = ou({
            ...
            renderLabel(t, e, i, s) {
                ...
                n.align(t, !1, {
                    ...
                    (!n.alignValue || "left" === n.alignValue || ol(a)) && n.css({
            ...
            getLabelText(t) {
                return ol(t.formatter) ? t.formatter.call(this) : t.text
            }
            destroy() {
                oc(this.axis.plotLinesAndBands, this),
                    delete this.axis,
                    od(this)
            }
        }
        let { animObject: ox } = t1
            , { format: oy } = eM
            , { composed: ob, dateFormats: ov, doc: ok, isSafari: oM } = D
            , { distribute: ow } = eP
            , { addEvent: oS, clamp: oA, css: oT, discardElement: oC, extend: oP, fireEvent: oO, getAlignFactor: oE, isArray: oL, isNumber: oD, isObject: oB, isString: oI, merge: oz, pick: oR, pushUnique: oN, splat: oW, syncTimeout: oG } = ts;
        class oX {
            constructor(t, e, i) {
                this.allowShared = !0,
                    this.crosshairs = [],
            ...
            destroy() {
                this.label && (this.label = this.label.destroy()),
                    ...
                    this.renderer && (this.renderer = this.renderer.destroy(),
                        oC(this.container)),
                    ts.clearTimeout(this.hideTimer)
            }
            getAnchor(t, e) {
            ...
            getClassName(t, e, i) {
                let s = this.options
                    , o = t.series
                    , r = o.options;
                return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + oR(t.colorIndex, o.colorIndex), r?.className].filter(oI).join(" ")
            }
            getLabel({ anchorX: t, anchorY: e } = {
                ...
                if (!this.label) {
                    if (this.outside) {
                        let t = this.chart
                            ...
                            , i = ew.getRendererType();
                        this.container = a = D.doc.createElement("div"),
                ...
                return a && !a.parentElement && D.doc.body.appendChild(a),
                    this.label
            }
            getPlayingField() {
                let { body: t, documentElement: e } = ok
            ...
            getPosition(t, e, i) {
                let { distance: s, chart: o, outside: r, pointer: a } = this, { inverted: n, plotLeft: h, plotTop: l, polar: d } = o, { plotX: c = 0, plotY: p = 0 } = i, u = {}, g = n && i.h || 0, { height: f, width: m } = this.getPlayingField(), x = a.getChartPosition(), y = t => t * x.scaleX, b = t => t * x.scaleY, v = i => {
                    let a = "x" === i;
                ...
                let A = !this.followPointer && oR(i.ttBelow, !d && !n === S)
                    ...
                    , O = () => {
                        !1 !== T.apply(0, k) ? !1 !== C.apply(0, M) || w || (P(!0),
                            O()) : w ? u.x = u.y = 0 : (P(!0),
                                O())
                    }
                    ;
            ...
            getFixedPosition(t, e, i) {
                ...
                return {
                    x: d.x + (d.width - t) * oE(n.align) + n.x,
                    y: d.y + (d.height - e) * oE(n.verticalAlign) + (!a && n.y || 0)
                }
            }
            hide(t) {
                let e = this;
                ts.clearTimeout(this.hideTimer),
                    t = oR(t, this.options.hideDelay),
                    this.isHidden || (this.hideTimer = oG(function () {
                        let i = e.getLabel();
                        e.getLabel().animate({
                            opacity: 0
                        }, {
            ...
            init(t, e) {
                this.chart = t,
                    ...
                    this.outside = oR(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY))
            }
            ...
            move(t, e, i, s) {
                let { followPointer: o, options: r } = this
                    , a = ox(!o && !this.isHidden && !r.fixed && r.animation)
                    , n = o || (this.len || 0) > 1
                    , h = {
                        x: t,
                        y: e
            ...
            refresh(t, e) {
                ...
                if (!s.enabled || !n.series)
                    return;
                ts.clearTimeout(this.hideTimer),
                    this.allowShared = !(!oL(t) && t.series && t.series.noSharedTooltip),
                ...
                r && this.allowShared && (o.applyInactiveState(a),
                    ...
                    n.points = a),
                    this.len = a.length;
                let f = oI(h) ? oy(h, n, i) : l.call(n, this);
                n.points = void 0;
                let m = n.series;
                if (this.distance = oR(m.tooltipOptions.distance, 16),
                    !1 === f)
                    this.hide();
                else {
            ...
            renderSplit(t, e) {
                let i = this
                    ...
                    , v = i.outside && "number" != typeof d ? ok.documentElement.getBoundingClientRect() : {
                        left: y,
                        right: y + o,
                        top: b,
                        bottom: b + r
                    ...
                    , E = function (t, e, s, o = [0, 0], r = !0) {
                        ...
                        if (s.isHeader)
                            n = w ? 0 : O,
                                a = oA(o[0] - t / 2, v.left, v.right - t - (i.outside ? S : 0));
                        else if (g && s) {
                            ...
                            n = o[1] - C,
                                a = oA(a = r ? o[0] - t - p : o[0] + p, r ? a : v.left, v.right);
                        return {
                            x: a,
                            y: n
                        }
                ...
                L.forEach(function (t) {
                    ...
                    !o && (i.outside && S + e < D.left && (D.left = S + e),
                        !o && i.outside && D.left + s > D.right && (D.right = S + e))
                }),
                    L.forEach(function (t) {
            ...
            headerFooterFormatter(t, e) {
                ...
                return oO(this, "headerFormatter", a, function (e) {
                    if (r && !n && oD(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                        r && n) {
                        if (oB(n)) {
                            let t = n;
                            ov[0] = e => i.chart.time.dateFormat(t, e),
                                n = "%0"
                        }
            ...
            updatePosition(t) {
                let { chart: e, container: i, distance: s, options: o, pointer: r, renderer: a } = this, { height: n = 0, width: h = 0 } = this.getLabel(), { fixed: l, positioner: d } = o, { left: c, top: p, scaleX: u, scaleY: g } = r.getChartPosition(), f = (d || l && this.getFixedPosition || this.getPosition).call(this, h, n, t), m = D.doc, x = (t.plotX || 0) + e.plotLeft, y = (t.plotY || 0) + e.plotTop, b;
                if (a && i) {
                    if (d || l) {
                    ...
                    b = (o.borderWidth || 0) + 2 * s + 2,
                        a.setSize(oA(h + b, 0, m.documentElement.clientWidth) - 1, n + b, !1),
                        (1 !== u || 1 !== g) && (oT(i, {
                            transform: `scale(${u}, ${g})`
                        }),
                            x *= u,
        ...
        !function (t) {
            t.compose = function (e) {
                oN(ob, "Core.Tooltip") && oS(e, "afterInit", function () {
                    let e = this.chart;
        ...
        let oH = oX
            , { animObject: oF } = t1
            , { defaultOptions: oY } = tE
            , { format: oj } = eM
            , { addEvent: oU, crisp: oV, erase: o$, extend: o_, fireEvent: oZ, getNestedProperty: oq, isArray: oK, isFunction: oJ, isNumber: oQ, isObject: o0, merge: o1, pick: o2, syncTimeout: o3, removeEvent: o5, uniqueKey: o6 } = ts;
        class o9 {
            ...
            applyOptions(t, e) {
                ...
                return o_(this, t = o9.prototype.optionsToObject.call(this, t)),
                    this.options = this.options ? o_(this.options, t) : t,
                    t.group && delete this.group,
                    t.dataLabels && delete this.dataLabels,
                    s && (this.y = o9.prototype.getNestedProperty.call(this, s)),
                    this.selected && (this.state = "select"),
                    "name" in this && void 0 === e && i.xAxis && i.xAxis.hasNames && (this.x = i.xAxis.nameToX(this)),
                    void 0 === this.x && i ? this.x = e ?? i.autoIncrement() : oQ(t.x) && i.options.relativeXValue ? this.x = i.autoIncrement(t.x) : "string" == typeof this.x && (e ?? (e = i.chart.time.parse(this.x)),
                        oQ(e) && (this.x = e)),
            ...
            destroy() {
                if (!this.destroyed) {
                    let t = this
                        ...
                        , o = i.hoverPoints
                        , r = oF(t.series.chart.renderer.globalAnimation)
                        , a = () => {
                            for (let e in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (o5(t),
                                t.destroyElements()),
                                t)
                                delete t[e]
                        }
            ...
            isValid() {
                return (oQ(this.x) || this.x instanceof Date) && oQ(this.y)
            }
            optionsToObject(t) {
                ...
                if (oQ(t) || null === t)
                    ...
                    for (!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]),
                        n++); h < o;)
                        i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? o9.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]),
                            n++,
                            h++;
                else
                    "object" == typeof t && (r = t,
                ...
                delete this.nonZonedColor,
                    t.options.colorByPoint ? (i || (s = (o = t.options.colors || t.chart.options.colors)[t.colorCounter],
                        ...
                        t.colorCounter === r && (t.colorCounter = 0)) : (i || (s = t.color),
                            a = t.colorIndex),
                    this.colorIndex = o2(this.options.colorIndex, a),
                    this.color = o2(this.options.color, s)
            }
            setNestedProperty(t, e, i) {
                return i.split(".").reduce(function (t, i, s, o) {
                    let r = o.length - 1 === s;
                    return t[i] = r ? e : o0(t[i], !0) ? t[i] : {},
                        t[i]
                }, t),
                    t
            }
            ...
            update(t, e, i, s) {
                ...
                function d() {
                    ...
                    n && d && (r.graphic = n.destroy(),
                        ...
                        o0(t, !0) && (n?.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = n.destroy()),
                    ...
                    a.dataTable.setRow(c, o),
                        l.data[o] = o0(l.data[o], !0) || o0(t, !0) ? r.options : o2(t, l.data[o]),
            ...
            manageEvent(t) {
                let e = o1(this.series.options.point, this.options)
                    , i = e.events?.[t];
                oJ(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1) ? (this.importedUserEvent?.(),
                    this.importedUserEvent = oU(this, t, i),
                    this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && this.hcEvents?.[t] && this.hcEvents?.[t].userEvent && (o5(this, t),
                        delete this.hcEvents[t],
                        Object.keys(this.hcEvents) || delete this.importedUserEvent)
            }
            setState(t, e) {
                let i = this.series, s = this.state, o = i.options.states[t || "normal"] || {}, r = oY.plotOptions[i.type].marker && i.options.marker, a = r && !1 === r.enabled, n = r?.states?.[t || "normal"] || {}, h = !1 === n.enabled, l = this.marker || {}, d = i.chart, c = r && i.markerAttribs, p = i.halo, u, g, f, m = i.stateMarkerGraphic, x;
                ...
                if (this.state = t,
                    ...
                    if (s && this.graphic.removeClass("highcharts-point-" + s),
                        ...
                        g = i.pointAttribs(this, t),
                            f = o2(d.options.chart.animation, o.animation);
                        let e = g.opacity;
                        i.options.inactiveOtherPoints && oQ(e) && (this.dataLabels || []).forEach(function (t) {
                    ...
                    u && this.graphic.animate(u, o2(d.options.chart.animation, n.animation, r.animation)),
                        m && m.hide()
                } else
                    t && n && (x = l.symbol || i.symbol,
                        ...
                        u && (m ? m[e ? "animate" : "attr"]({
                            x: u.x,
                            y: u.y
                        }) : x && (i.stateMarkerGraphic = m = d.renderer.symbol(x, u.x, u.y, u.width, u.height, o1(r, n)).add(i.markerGroup),
                            m.currentSymbol = x)),
                ...
                y?.size && b && "hidden" !== v && !this.isCluster ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
                    ...
                    p.attr({
                        class: "highcharts-halo highcharts-color-" + o2(this.colorIndex, i.colorIndex) + (this.className ? " " + this.className : ""),
                        visibility: v,
                        zIndex: -1
                    }),
                    p.point = this,
                    d.styledMode || p.attr(o_({
                        fill: this.color || i.color,
                        "fill-opacity": y.opacity
                    }, er.filterUserAttributes(y.attributes || {})))) : p?.point?.haloPath && !p.point.destroyed && p.animate({
                        d: p.point.haloPath(0)
                    }, null, p.hide),
                    oZ(this, "afterSetState", {
                        state: t
                    })
            }
            haloPath(t) {
                let e = this.pos();
                return e ? this.series.chart.renderer.symbols.circle(oV(e[0], 1) - t, e[1] - t, 2 * t, 2 * t) : []
            }
        }
        let o4 = o9
            , { parse: o8 } = tG
            , { charts: o7, composed: rt, isTouchDevice: re } = D
            , { addEvent: ri, attr: rs, css: ro, extend: rr, find: ra, fireEvent: rn, isNumber: rh, isObject: rl, objectEach: rd, offset: rc, pick: rp, pushUnique: ru, splat: rg } = ts;
        class rf {
            ...
            destroy() {
                ...
                this.eventsToUnbind.forEach(t => t()),
                    this.eventsToUnbind = [],
                    !D.chartCount && (rf.unbindDocumentMouseUp.forEach(t => t.unbind()),
                        rf.unbindDocumentMouseUp.length = 0,
                        rf.unbindDocumentTouchEnd && (rf.unbindDocumentTouchEnd = rf.unbindDocumentTouchEnd())),
            ...
            getSelectionMarkerAttrs(t, e) {
                ...
                return rn(this, "getSelectionMarkerAttrs", i, i => {
            ...
            drag(t) {
                let { chart: e } = this, { mouseDownX: i = 0, mouseDownY: s = 0 } = e, { panning: o, panKey: r, selectionMarkerFill: a } = e.options.chart, n = e.plotLeft, h = e.plotTop, l = e.plotWidth, d = e.plotHeight, c = rl(o) ? o.enabled : o, p = r && t[`${r}Key`], u = t.chartX, g = t.chartY, f, m = this.selectionMarker;
                if ((!m || !m.touch) && (u < n ? u = n : u > n + l && (u = n + l),
                    ...
                    this.hasZoom && f && !p && !m && (this.selectionMarker = m = e.renderer[r](),
                        ...
                        e.styledMode || m.attr({
                            fill: a || o8("#334eff").setOpacity(.25).get()
                        })),
                        m && m.attr(l),
                        f && !m && c && e.pan(t, o)
                }
            ...
            getSelectionBox(t) {
                ...
                return rn(this, "getSelectionBox", e),
                    e.result
            }
            drop(t) {
                ...
                if (e && i.redraw(),
                    ...
                    rh(i.index) && (this.selectionMarker = s.destroy())
                }
                i && rh(i.index) && (ro(i.container, {
                    cursor: i._cursor
                }),
            ...
            findNearestKDPoint(t, e, i) {
                ...
                return t.forEach(function (t) {
                    let o = !(t.noSharedTooltip && e) && 0 > t.options.findNearestPointBy.indexOf("y")
                        , r = t.searchPoint(i, o);
                    rl(r, !0) && r.series && (!rl(s, !0) || function (t, i) {
            ...
            getChartCoordinatesFromPoint(t, e) {
                ...
                if (i && s) {
                    let r = t.clientX ?? t.plotX ?? 0
                        , a = t.plotY || 0;
                    return t.isNode && o && rh(o.x) && rh(o.y) && (r = o.x,
                        a = o.y),
                        e ? {
            ...
            getHoverData(t, e, i, s, o, r) {
                let a = [], n = function (t) {
                    return t.visible && !(!o && t.directTouch) && rp(t.options.enableMouseTracking, !0)
                }, h = e, l, d = {
                    chartX: r ? r.chartX : void 0,
                    chartY: r ? r.chartY : void 0,
                    shared: o
                };
                rn(this, "beforeGetHoverData", d),
                ...
                return h = c?.series,
                    c && (o && !h.noSharedTooltip ? (l = i.filter(function (t) {
                        ...
                        let e = t.options?.nullInteraction
                            , i = ra(t.points, function (t) {
                                return t.x === c.x && (!t.isNull || !!e)
                            });
                        rl(i) && (t.boosted && t.boost && (i = t.boost.getPoint(i)),
                            a.push(i))
                    }) : a.push(c)),
                    rn(this, "afterGetHoverData", d = {
                        hoverPoint: c
                    }),
                {
            ...
            normalize(t, e) {
                let i = t.touches
                    , s = i ? i.length ? i.item(0) : rp(i.changedTouches, t.changedTouches)[0] : t;
            ...
            onContainerClick(t) {
                let e = this.chart
                    ...
                    , o = e.plotLeft
                    , r = e.plotTop;
                !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (rn(i.series, "click", rr(s, {
                    point: i
                })),
                    e.hoverPoint && i.firePointEvent("click", s)) : (rr(s, this.getCoordinates(s)),
            ...
            onContainerMouseDown(t) {
                ...
                t = this.normalize(t),
                    D.isFirefox && 0 !== t.button && this.onContainerMouseMove(t),
                    (void 0 === t.button || e) && (this.zoomOption(t),
                        e && t.preventDefault?.(),
                        this.dragStart(t))
            }
            onContainerMouseLeave(t) {
                let { pointer: e } = o7[rp(rf.hoverChartIndex, -1)] || {};
                t = this.normalize(t),
            ...
            onDocumentMouseUp(t) {
                t?.touches && this.hasPinchMoved && t?.preventDefault?.(),
                    o7[rp(rf.hoverChartIndex, -1)]?.pointer?.drop(t)
            }
            pinch(t) {
                let e = this
            ...
            reset(t, e) {
                let i = this.chart
                    ...
                    , a = i.tooltip
                    , n = a?.shared ? r : o;
                t && n && rg(n).forEach(function (e) {
                    e.series.isCartesian && void 0 === e.plotX && (t = !1)
                }),
                    t ? a && n && rg(n).length && (a.refresh(n),
            ...
            runPointActions(t, e, i) {
                ...
                this.unDocMouseMove || (this.unDocMouseMove = ri(s.container.ownerDocument, "mousemove", t => o7[rf.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)),
                    this.eventsToUnbind.push(this.unDocMouseMove)),
                    s.axes.forEach(function (e) {
                        let i, o = e.crosshair?.snap ?? !0;
                        o && ((i = s.hoverPoint) && i.series[e.coll] === e || (i = ra(c, t => t.series?.[e.coll] === e))),
            ...
            setDOMEvents() {
                ...
                t.onmousedown = this.onContainerMouseDown.bind(this),
                    ...
                    this.eventsToUnbind.push(ri(t, "mouseenter", this.onContainerMouseEnter.bind(this)), ri(t, "mouseleave", this.onContainerMouseLeave.bind(this))),
                    rf.unbindDocumentMouseUp.some(t => t.doc === e) || rf.unbindDocumentMouseUp.push({
                        doc: e,
                        unbind: ri(e, "mouseup", this.onDocumentMouseUp.bind(this))
                    });
                let i = this.chart.renderTo.parentElement;
                for (; i && "BODY" !== i.tagName;)
                    this.eventsToUnbind.push(ri(i, "scroll", () => {
                        delete this.chartPosition
                    }
                    )),
                        i = i.parentElement;
                this.eventsToUnbind.push(ri(t, "touchstart", this.onContainerTouchStart.bind(this), {
                    passive: !1
                }), ri(t, "touchmove", this.onContainerTouchMove.bind(this), {
                    passive: !1
                })),
                    rf.unbindDocumentTouchEnd || (rf.unbindDocumentTouchEnd = ri(e, "touchend", this.onDocumentTouchEnd.bind(this), {
                        passive: !1
                    })),
                    this.setPointerCapture(),
                    ri(this.chart, "redraw", this.setPointerCapture.bind(this))
            }
            setPointerCapture() {
                if (!re)
                    return;
                let t = this.pointerCaptureEventsToUnbind
                    , e = this.chart
                    , i = e.container
                    , s = rp(e.options.tooltip?.followTouchMove, !0) && e.series.some(t => t.options.findNearestPointBy.indexOf("y") > -1);
                !this.hasPointerCapture && s ? (t.push(ri(i, "pointerdown", t => {
                    ...
                    this.hasPointerCapture = !0) : this.hasPointerCapture && !s && (t.forEach(t => t()),
                        t.length = 0,
                        e.styledMode || ro(i, {
                            "touch-action": rp(e.options.chart.style?.["touch-action"], "manipulation")
                        }),
            ...
            setHoverChartIndex(t) {
                let e = this.chart
                    , i = D.charts[rp(rf.hoverChartIndex, -1)];
                if (i && i !== e) {
                    let s = {
                ...
                i?.mouseIsDown || (rf.hoverChartIndex = e.index)
            }
            touch(t, e) {
                ...
                this.setHoverChartIndex(),
                    1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
                        ...
                        rp(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t)
            }
            touchSelect(t) {
            ...
            zoomOption(t) {
                ...
                /touch/.test(t.type) && (s = rp(e.zooming.pinchType, s)),
        ...
        rf.unbindDocumentMouseUp = [],
            function (t) {
                t.compose = function (e) {
                    ru(rt, "Core.Pointer") && ri(e, "beforeRender", function () {
        ...
        let { setLength: rx, splice: ry } = g
            , { fireEvent: rb, objectEach: rv, uniqueKey: rk } = ts
            , rM = class {
                constructor(t = {}) {
                    this.autoId = !t.id,
                        this.columns = {},
                ...
                applyRowCount(t) {
                    this.rowCount = t,
                        rv(this.columns, (e, i) => {
                            e.length !== t && (this.columns[i] = rx(e, t))
                        }
                        )
                }
                deleteRows(t, e = 1) {
                ...
                setRow(t, e = this.rowCount, i, s) {
                    ...
                    rv(t, (t, a) => {
                        ...
                        n && (i ? n = ry(n, e, 0, !0, [t]).array : n[e] = t,
                            o[a] = n)
                    }
                    ),
        ...
        !function (t) {
            function e(t, e, i) {
                ...
                if (m && !1 !== m.enabled && n) {
                    let t = Math.min(rA(m.radius, d), d);
                    0 === l.indexOf("url") && (m = rS(m, {
                        width: h,
                        height: h
                    }),
                        t = 0),
                        s.symbol = f = c.symbol(l, n / 2 - t, u - t, 2 * t, 2 * t, rw({
                            context: "legend"
            ...
            t.areaMarker = function (t, i) {
                ...
                t.rectangle = function (t, e) {
                    let i = e.legendItem || {}
                        ...
                        , r = s.squareSymbol
                        , a = r ? o : t.symbolWidth;
                    i.symbol = this.chart.renderer.rect(r ? (t.symbolWidth - o) / 2 : 0, t.baseline - o + 1, a, o, rA(t.options.symbolRadius, o / 2)).addClass("highcharts-point").attr({
                        zIndex: 3
                    }).add(i.group)
                }
        }(f || (f = {}));
        let rT = f
            , { defaultOptions: rC } = tE
            , { extend: rP, extendClass: rO, merge: rE } = ts;
        !function (t) {
            function e(e, i) {
                let s = rC.plotOptions || {}
                    , o = i.defaultOptions
                    , r = i.prototype;
                return r.type = e,
                    r.pointClass || (r.pointClass = o4),
                    !t.seriesTypes[e] && (o && (s[e] = o),
                        t.seriesTypes[e] = i,
                        !0)
            }
            t.seriesTypes = D.seriesTypes,
                t.registerSeriesType = e,
                t.seriesType = function (i, s, o, r, a) {
                    let n = rC.plotOptions || {};
                    if (s = s || "",
                        n[i] = rE(n[s], o),
                        delete t.seriesTypes[i],
                        e(i, rO(t.seriesTypes[s] || ae, r)),
        ...
        let rL = m
            , { animObject: rD, setAnimation: rB } = t1
            , { defaultOptions: rI } = tE
            , { registerEventOptions: rz } = sp
            , { svg: rR, win: rN } = D
            , { seriesTypes: rW } = rL
            , { format: rG } = eM
            , { arrayMax: rX, arrayMin: rH, clamp: rF, correctFloat: rY, crisp: rj, defined: rU, destroyObjectProperties: rV, diffObjects: r$, erase: r_, error: rZ, extend: rq, find: rK, fireEvent: rJ, getClosestDistance: rQ, getNestedProperty: r0, insertItem: r1, isArray: r2, isNumber: r3, isString: r5, merge: r6, objectEach: r9, pick: r4, removeEvent: r8, syncTimeout: r7 } = ts;
        class at {
            constructor() {
                this.zoneAxis = "y"
            }
            init(t, e) {
                ...
                rJ(this, "init", {
                    ...
                    this.dataTable ?? (this.dataTable = new rM);
                let s = t.series;
                this.eventsToUnbind = [],
                    this.chart = t,
                ...
                (a?.click || o.point?.events?.click || o.allowPointSelect) && (t.runTrackerClick = !0),
                    ...
                    t.orderItems("series", r1(this, s)),
                    o.dataSorting?.enabled ? this.setDataSortingOptions() : this.points || this.data || this.setData(o.data, !1),
                    rJ(this, "afterInit")
            }
            is(t) {
                return rW[t] && this instanceof rW[t]
            }
            bindAxes() {
                let t, e = this, i = e.options, s = e.chart;
                rJ(this, "bindAxes", null, function () {
                    (e.axisTypes || []).forEach(function (o) {
                        (s[o] || []).forEach(function (s) {
                            t = s.options,
                                (r4(i[o], 0) === s.index || void 0 !== i[o] && i[o] === t.id) && (r1(e, s.series),
                                    e[o] = s,
                                    s.isDirty = !0)
                        }),
                            e[o] || e.optionalAxis === o || rZ(18, !0, s)
                    })
                }),
                    rJ(this, "afterBindAxes")
            }
            hasData() {
            ...
            autoIncrement(t) {
                ...
                if (this.pointInterval = e = r4(this.pointInterval, i.pointInterval, 1),
                    o && r3(t) && (e *= t),
                    s) {
                    let t = r.toParts(a);
                ...
                return o && r3(t) ? a + e : (this.xIncrement = a + e,
                    a)
            }
            setDataSortingOptions() {
                ...
                rq(this, {
                    ...
                    rU(t.pointRange) || (t.pointRange = 1)
            }
            setOptions(t) {
                let e, i = this.chart, s = i.options.plotOptions, o = i.userOptions || {}, r = r6(t), a = i.styledMode, n = {
                    plotOptions: s,
                    userOptions: r
                };
                rJ(this, "setOptions", n);
                let h = n.plotOptions[this.type]
                    , l = o.plotOptions || {}
                    , d = l.series || {}
                    , c = rI.plotOptions[this.type] || {}
                    , p = l[this.type] || {};
                h.dataLabels = this.mergeArrays(c.dataLabels, h.dataLabels),
                    this.userOptions = n.userOptions;
                let u = r6(h, s.series, p, r);
                this.tooltipOptions = r6(rI.tooltip, rI.plotOptions.series?.tooltip, c?.tooltip, i.userOptions.tooltip, l.series?.tooltip, p.tooltip, r.tooltip),
                    this.stickyTracking = r4(r.stickyTracking, p.stickyTracking, d.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || u.stickyTracking),
                ...
                return (u.negativeColor || u.negativeFillColor) && !u.zones && (e = {
                    ...
                    g.push(e)),
                    g.length && rU(g[g.length - 1].value) && g.push(a ? {} : {
                        color: this.color,
                        fillColor: this.fillColor
                    }),
                    rJ(this, "afterSetOptions", {
                        options: u
                    }),
                    u
            }
            getName() {
                return this.options.name ?? rG(this.chart.options.lang.seriesName, this, this.chart)
            }
            getCyclic(t, e, i) {
                let s, o, r = this.chart, a = `${t}Index`, n = `${t}Counter`, h = i?.length || r.options.chart.colorCount;
                !e && (rU(o = r4("color" === t ? this.options.colorIndex : void 0, this[a])) ? s = o : (r.series.length || (r[n] = 0),
                    s = r[n] % h,
                    r[n] += 1),
                    i && (e = i[s])),
                    void 0 !== s && (this[a] = s),
            ...
            getColor() {
                this.chart.styledMode ? this.getCyclic("color") : this.options.colorByPoint ? this.color = "#cccccc" : this.getCyclic("color", this.options.color || rI.plotOptions[this.type].color, this.chart.options.colors)
            }
            getPointsCollection() {
            ...
            findPointIndex(t, e) {
                ...
                return i && void 0 !== (o = i?.index) && (s = !0),
                    void 0 === o && r3(a) && (o = this.getColumn("x").indexOf(a, e)),
                    -1 !== o && void 0 !== o && this.cropped && (o = o >= l ? o - l : o),
                    !s && r3(o) && n[o]?.touched && (o = void 0),
                    o
            }
            updateData(t, e) {
                ...
                if (this.xIncrement = null,
                    t.forEach((t, e) => {
                        let l, d = rU(t) && this.pointClass.prototype.optionsToObject.call({
                            series: this
                        }, t) || {}, { id: p, x: u } = d;
                        p || r3(u) ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l ? a.push(t) : r[l] && t !== i.data?.[l] ? (r[l].update(t, !1, void 0, !1),
                            r[l].touched = !0,
                ...
                return null === this.xIncrement && u.length && (this.xIncrement = rX(u),
                    this.autoIncrement()),
                    !0
            }
            dataColumnKeys() {
            ...
            setData(t, e = !0, i, s) {
                ...
                if (h?.enabled && (t = this.sortData(t)),
                    ...
                    for (r5(this.getColumn("y")[0]) && rZ(14, !0, n),
                        this.data = [],
            ...
            sortData(t) {
                let e = this
                    ...
                    , s = function (t, e) {
                        return rU(e) && t.pointClass.prototype.optionsToObject.call({
                            series: t
                        }, e) || {}
                    };
            ...
            getProcessedData(t) {
                ...
                return r && (g = (u = r.getExtremes()).min,
                    ...
                    s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < g || m[0] > f ? x = new rM : e.getColumn(e.pointValKey || "y").length && (m[0] < g || m[l - 1] > f) && (x = (d = this.cropData(i, g, f)).modified,
                        p = d.start,
                        c = !0))),
                    m = x.getColumn("x") || [],
                {
                    ...
                    cropped: c,
                    cropStart: p,
                    closestPointRange: rQ([h ? m.map(h.log2lin) : m], () => e.requireSorting && !y && rZ(15, !1, e.chart))
                }
            }
            processData(t) {
                let e = this.xAxis
            ...
            generatePoints() {
                let t = this.options, e = this.processedData || t.data, i = this.dataTable.modified, s = this.getColumn("x", !0), o = this.pointClass, r = i.rowCount, a = this.cropStart || 0, n = this.hasGroupedData, h = t.keys, l = [], d = t.dataGrouping?.groupAll ? a : 0, c = this.xAxis?.categories, p = this.pointArrayMap || ["y"], u = this.dataColumnKeys(), g, f, m, x, y = this.data, b;
                if (!y && !n) {
                    let t = [];
                    t.length = e?.length || 0,
                        y = this.data = t
                ...
                for (h && n && (this.options.keys = !1),
                    x = 0; x < r; x++)
                    f = a + x,
                        n ? ((m = new o(this, i.getRow(x, u) || [])).dataGroup = this.groupMap[d + x],
                            m.dataGroup?.options && (m.options = m.dataGroup.options,
                                rq(m, m.dataGroup.options),
            ...
            getExtremes(t, e) {
                ...
                return rJ(this, "afterGetExtremes", {
                    dataExtremes: b
                }),
                    b
            }
            ...
            translate() {
                ...
                for (p = 0; p < a; p++) {
                    ...
                    a.plotX = r3(u = i.translate(y, !1, !1, !1, !0, n)) ? rY(x(u)) : void 0,
                        e && this.visible && w && w[y] && (f = this.getStackIndicator(f, y, this.index),
                            !a.isNull && f.key && (v = (b = w[y]).points[f.key]),
                            b && r2(v) && (M = v[0],
                                k = v[1],
                                M === d && f.key === w[y].base && (M = r4(r3(l) ? l : o.min)),
                                o.positiveValuesOnly && rU(M) && M <= 0 && (M = void 0),
                                a.total = a.stackTotal = r4(b.total),
                                a.percentage = rU(a.y) && b.total ? a.y / b.total * 100 : void 0,
                                a.stackY = k,
                                this.irregularWidths || b.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))),
                        a.yBottom = rU(M) ? x(o.translate(M, !1, !0, !1, !0)) : void 0,
                        this.dataModify && (k = this.dataModify.modifyValue(k, p)),
                        r3(k) && void 0 !== a.plotX ? t = r3(t = o.translate(k, !1, !0, !1, !0)) ? x(t) : void 0 : !r3(k) && c && (t = c),
                        a.plotY = t,
                        a.isInside = this.isPointInside(a),
                        a.clientX = h ? rY(i.translate(y, !1, !1, !1, !0, n)) : u,
            ...
            afterAnimate() {
                this.setClip(),
                    r9(this.chart.sharedClips, (t, e, i) => {
                        t && !this.chart.container.querySelector(`[clip-path="url(#${t.id})"]`) && (t.destroy(),
                            delete i[e])
                    }
                    ),
                    this.finishedAnimating = !0,
                    rJ(this, "afterAnimate")
            }
            drawPoints(t = this.points) {
                let e, i, s, o, r, a, n, h = this.chart, l = h.styledMode, { colorAxis: d, options: c } = this, p = c.marker, u = c.nullInteraction, g = this[this.specialGroup || "markerGroup"], f = this.xAxis, m = r4(p.enabled, !f || !!f.isRadial || null, this.closestPointRangePx >= p.enabledThreshold * p.radius);
                if (!1 !== p.enabled || this._hasPointMarkers)
                    for (e = 0; e < t.length; e++) {
                        o = (s = (i = t[e]).graphic) ? "animate" : "attr",
                            ...
                            a = !!i.marker;
                        let c = i.isNull;
                        if ((m && !rU(r.enabled) || r.enabled) && (!c || u) && !1 !== i.visible) {
                            let t = r4(r.symbol, this.symbol, "rect");
            ...
            markerAttribs(t, e) {
                let i = this.options, s = i.marker, o = t.marker || {}, r = o.symbol || s.symbol, a = {}, n, h, l = r4(o.radius, s?.radius);
                e && (n = s.states[e],
                    h = o.states && o.states[e],
                    l = r4(h?.radius, n?.radius, l && l + (n?.radiusPlus || 0))),
                    t.hasImage = r && 0 === r.indexOf("url"),
                    t.hasImage && (l = 0);
                let d = t.pos();
                return r3(l) && d && (i.crisp && (d[0] = rj(d[0], t.hasImage ? 0 : "rect" === r ? s?.lineWidth || 0 : 1)),
                    a.x = d[0] - l,
                    a.y = d[1] - l),
            ...
            pointAttribs(t, e) {
                let i = this.options, s = i.marker, o = t?.options, r = o?.marker || {}, a = o?.color, n = t?.color, h = t?.zone?.color, l, d, c = this.color, p, u, g = r4(r.lineWidth, s.lineWidth), f = t?.isNull && i.nullInteraction ? 0 : 1;
                return c = a || h || n || c,
                    p = r.fillColor || s.fillColor || c,
                    u = r.lineColor || s.lineColor || c,
                    e = e || "normal",
                    l = s.states[e] || {},
                    g = r4((d = r.states && r.states[e] || {}).lineWidth, l.lineWidth, g + r4(d.lineWidthPlus, l.lineWidthPlus, 0)),
                    ...
                    u = d.lineColor || l.lineColor || u,
                {
                    ...
                    "stroke-width": g,
                    fill: p,
                    opacity: f = r4(d.opacity, l.opacity, f)
                }
            }
            destroy(t) {
                let e, i, s = this, o = s.chart, r = /AppleWebKit\/533/.test(rN.navigator.userAgent), a = s.data || [];
                for (rJ(s, "destroy", {
                ...
                for (let t of s.zones)
                    rV(t, void 0, !0);
                ts.clearTimeout(s.animationTimeout),
                    r9(s, function (t, e) {
                        t instanceof e8 && !t.survive && t[r && "group" === e ? "hide" : "destroy"]()
                    }),
            ...
            applyZones() {
                ...
                if (s.length && (i || t) && d && r3(d.min)) {
                    ...
                    if (s.forEach(t => {
                        t.lineClip = [],
                            t.translated = rF(d.toPixels(r4(t.value, e), !0) || 0, 0, p)
                    }
                    ),
            ...
            plotGroup(t, e, i, s, o) {
                ...
                return rU(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n.opacity = this.opacity),
                    r || (this[t] = r = this.chart.renderer.g().add(o)),
                    r.addClass("highcharts-" + e + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (rU(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0),
                ...
                if (this.kdTree || this.buildingKdTree || this.buildKDTree(i),
                    ...
                    return function t(e, i, s, o) {
                        ...
                        !function (t, e) {
                            let i = t[a]
                                , s = e[a]
                                , o = rU(i) && rU(s) ? i - s : null
                                , r = t[n]
                                , h = e[n]
                                , l = rU(r) && rU(h) ? r - h : 0
                                , c = d && e.marker?.radius || 0;
                            e.dist = Math.sqrt((o && o * o || 0) + l * l) - c,
                                e.distX = rU(o) ? Math.abs(o) - c : Number.MAX_VALUE
                        }(e, l);
                        let m = (e[u] || 0) - (l[u] || 0) + (d && l.marker?.radius || 0)
                            , x = m < 0 ? "left" : "right"
                            , y = m < 0 ? "right" : "left";
                        return i[x] && ([g, f] = c(l, t(e, i[x], s + 1, o), h)),
                            i[y] && p(Math.sqrt(m * m), g[h], f) && (g = c(g, t(e, i[y], s + 1, o), h)[0]),
                            g
                    }(t, this.kdTree, l, l)
            }
            pointPlacementToXValue() {
                ...
                return "between" === i && (i = e.reversed ? -.5 : .5),
                    r3(i) ? i * (t.pointRange || e.pointRange) : 0
            }
            isPointInside(t) {
            ...
            drawTracker() {
                let t = this
                    ...
                    , l = "rgba(192,192,192," + (rR ? 1e-4 : .002) + ")"
                    , d = t.tracker;
                d ? d.attr({
                    d: s
            ...
            addPoint(t, e, i, s, o) {
                ...
                d.setRow(f, a, !0, {
                    ...
                    i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, u].filter(rU).forEach(t => {
                        t.shift()
                    }
                    ),
                        d.deleteRows(0))),
                    !1 !== o && rJ(this, "addPoint", {
                        point: f
                    }),
                    this.isDirty = !0,
                    this.isDirtyData = !0,
            ...
            removePoint(t, e, i) {
                let s = this
                    ...
                    , h = r[t]
                    , l = function () {
                        [a?.length === r.length ? a : void 0, r, s.options.data].filter(rU).forEach(e => {
                            e.splice(t, 1)
                        }
                        ),
                            n.deleteRows(t),
            ...
            remove(t, e, i, s) {
                ...
                !1 !== i ? rJ(o, "remove", null, a) : a()
            }
            update(t, e) {
                rJ(this, "update", {
                    options: t = r$(t, this.userOptions)
                });
                let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions, n = rW[r].prototype, h = i.finishedAnimating && {
                    animation: !1
                }, l = {}, d, c, p = at.keepProps.slice(), u = t.type || o.type || s.options.chart.type, g = !(this.hasDerivedData || u && u !== this.type || void 0 !== t.keys || void 0 !== t.pointStart || void 0 !== t.pointInterval || void 0 !== t.relativeXValue || t.joinBy || t.mapData || ["dataGrouping", "pointStart", "pointInterval", "pointIntervalUnit", "keys"].some(t => i.hasOptionChanged(t)));
                u = u || r,
                    g ? (p.push.apply(p, at.keepPropsForPoints),
                        !1 !== t.visible && p.push("area", "graph"),
                        i.parallelArrays.forEach(function (t) {
                            p.push(t + "Data")
                        }),
                        t.data && (t.dataSorting && rq(i.options.dataSorting, t.dataSorting),
                ...
                if (rW[u]) {
                    if (f = u !== i.type,
                        ...
                        if (s.propFromSeries(),
                            ...
                            Object.setPrototypeOf(i, rW[u].prototype);
                        else {
            ...
            hasOptionChanged(t) {
                let e = this.chart
                    ...
                    , r = r4(s?.[this.type]?.[t], s?.series?.[t]);
                return o && !rU(r) ? i !== o : i !== r4(r, i)
            }
            onMouseOver() {
                let t = this.chart
                    , e = t.hoverSeries
                ...
                i?.setHoverChartIndex(),
                    ...
                    this.options.events.mouseOver && rJ(this, "mouseOver"),
                    this.setState("hover"),
                    t.hoverSeries = this
            }
            onMouseOut() {
                ...
                e.hoverSeries = null,
                    s && s.onMouseOut(),
                    this && t.events.mouseOut && rJ(this, "mouseOut"),
            ...
            setState(t, e) {
                let i = this
                    ...
                    , a = s.states
                    , n = r4(a[t || "normal"] && a[t || "normal"].animation, i.chart.options.chart.animation)
                    , h = s.lineWidth
                    , l = s.opacity;
                if (t = t || "",
            ...
            drawLegendSymbol(t, e) {
                rT[this.options.legendSymbol || "rectangle"]?.call(this, t, e)
            }
        }
        at.defaultOptions = {
            lineWidth: 2,
            ...
            at.types = rL.seriesTypes,
            at.registerType = rL.registerSeriesType,
            at.keepProps = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"],
            at.keepPropsForPoints = ["data", "isDirtyData", "isDirtyCanvas", "points", "dataTable", "processedData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"],
            rq(at.prototype, {
            ...
            rL.series = at;
        let ae = at
            , { animObject: ai, setAnimation: as } = t1
            , { registerEventOptions: ao } = sp
            , { composed: ar, marginNames: aa } = D
            , { distribute: an } = eP
            , { format: ah } = eM
            , { addEvent: al, createElement: ad, css: ac, defined: ap, discardElement: au, find: ag, fireEvent: af, isNumber: am, merge: ax, pick: ay, pushUnique: ab, relativeLength: av, stableSort: ak, syncTimeout: aM } = ts;
        class aw {
            constructor(t, e) {
                this.allItems = [],
                    this.initialItemY = 0,
                    ...
                    e.enabled && (this.render(),
                        ao(this, e),
                        al(this.chart, "endResize", function () {
                            this.legend.positionCheckboxes()
                        })),
                    al(this.chart, "render", () => {
            ...
            update(t, e) {
                let i = this.chart;
                this.setOptions(ax(!0, this.options, t)),
                    "events" in this.options && ao(this, this.options),
                    this.destroy(),
            ...
            colorizeItem(t, e) {
                ...
                if ((t instanceof ae || t instanceof o4) && (t.color = t.options?.legendSymbolColor || i),
            ...
            positionItem(t) {
                ...
                if (e?.element) {
                    ...
                    e[ap(e.translateY) ? "animate" : "attr"](o, void 0, () => {
                        af(this, "afterPositionItem", {
                            item: t
                        })
                    }
                    )
            ...
            setText(t) {
                ...
                t.legendItem.label.attr({
                    text: e.labelFormat ? ah(e.labelFormat, t, this.chart) : e.labelFormatter.call(t)
                })
            }
            renderItem(t) {
                ...
                !y && (e.group = s.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : "")).attr({
                    ...
                    i.styledMode || y.css(ax(t.visible ? h : l)),
                    y.attr({
                        align: c ? "left" : "right",
                        zIndex: 2
                    }).add(e.group),
                    !this.baseline && (this.fontMetrics = s.fontMetrics(y),
                        ...
                        this.symbolHeight = ay(o.symbolHeight, this.fontMetrics.f),
                        o.squareSymbol && (this.symbolWidth = ay(o.symbolWidth, Math.max(this.symbolHeight, 16)),
            ...
            getAllItems() {
                ...
                return this.chart.series.forEach(function (e) {
                    let i = e?.options;
                    e && ay(i.showInLegend, !ap(i.linkedTo) && void 0, !0) && (t = t.concat(e.legendItem?.labels || ("point" === i.legendType ? e.data : e)))
                }),
                    af(this, "afterGetAllItems", {
                        allItems: t
                    }),
                    t
            }
            ...
            adjustMargins(t, e) {
                ...
                o && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach((r, a) => {
                    r.test(o) && !ap(t[a]) && (i[aa[a]] = Math.max(i[aa[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a] * s[a % 2 ? "x" : "y"] + (s.margin ?? 12) + e[a] + (i.titleOffset[a] || 0)))
                }
                )
            }
            proximatePositions() {
                ...
                for (let o of (this.allItems.forEach(function (t) {
                    ...
                    t.yAxis && (t.xAxis.options.reversed && (a = !a),
                        t.points && (o = ag(a ? t.points : t.points.slice(0).reverse(), function (t) {
                            return am(t.plotY)
                        })),
            ...
            render() {
                ...
                this.itemX = s,
                    ...
                    this.offsetWidth = 0,
                    this.lastItemY = 0,
                    this.widthOption = av(i.width, t.spacingBox.width - s),
                    ...
                    this.renderTitle(),
                    ak(o, (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)),
            ...
            handleOverflow(t) {
                let e = this, i = this.chart, s = i.renderer, o = this.options, r = o.y, a = "top" === o.verticalAlign, n = this.padding, h = o.maxHeight, l = o.navigation, d = ay(l.animation, !0), c = l.arrowSize || 12, p = this.pages, u = this.allItems, g = function (t) {
                ...
                return "horizontal" !== o.layout || "middle" === o.verticalAlign || o.floating || (v /= 2),
                    ...
                    t && v > 0 && t > v && !1 !== l.enabled ? (this.clipHeight = m = Math.max(v - 20 - this.titleHeight - n, 0),
                        this.currentPage = ay(this.currentPage, 1),
                        this.fullHeight = t,
                        u.forEach((t, e) => {
                ...
                l > o && (l = o),
                    l > 0 && (void 0 !== e && as(e, i),
                        ...
                        aM(() => {
                            ...
                            , ai(ay(e, i.renderer.globalAnimation, !0)).duration))
            }
            setItemEvents(t, e, i) {
                let s = this
                    , o = t.legendItem || {}
                ...
                for (let i of d)
                    i && i.on("mouseover", function () {
                        ...
                        s.chart.styledMode || e.css(ax(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                            c(""),
                            r.removeClass(h),
                            t.setState()
                    }).on("click", function (e) {
            ...
            createCheckboxForItem(t) {
                t.checkbox = ad("input", {
                    ...
                    al(t.checkbox, "click", function (e) {
                        let i = e.target;
                        af(t.series || t, "checkboxClick", {
                            checked: i.checked,
                            item: t
                        }, function () {
                            t.select()
        ...
        !function (t) {
            t.compose = function (e) {
                ab(ar, "Core.Legend") && al(e, "beforeMargins", function () {
                    this.legend = new t(this, this.options.legend)
                })
            }
        }(aw || (aw = {}));
        let aS = aw
            , { animate: aA, animObject: aT, setAnimation: aC } = t1
            , { defaultOptions: aP } = tE
            , { numberFormat: aO } = eM
            , { registerEventOptions: aE } = sp
            , { charts: aL, doc: aD, marginNames: aB, svg: aI, win: az } = D
            , { seriesTypes: aR } = rL
            , { addEvent: aN, attr: aW, createElement: aG, css: aX, defined: aH, diffObjects: aF, discardElement: aY, erase: aj, error: aU, extend: aV, find: a$, fireEvent: a_, getAlignFactor: aZ, getStyle: aq, isArray: aK, isNumber: aJ, isObject: aQ, isString: a0, merge: a1, objectEach: a2, pick: a3, pInt: a5, relativeLength: a6, removeEvent: a9, splat: a4, syncTimeout: a8, uniqueKey: a7 } = ts;
        class nt {
            static chart(t, e, i) {
                return new nt(t, e, i)
            }
            constructor(t, e, i) {
                this.sharedClips = {};
                let s = [...arguments];
                (a0(t) || t.nodeName) && (this.renderTo = s.shift()),
                    this.init(s[0], s[1])
            }
            setZoomOptions() {
                ...
                this.zooming = {
                    ...e,
                    type: a3(t.zoomType, e.type),
                    key: a3(t.zoomKey, e.key),
                    pinchType: a3(t.pinchType, e.pinchType),
                    singleTouch: a3(t.zoomBySingleTouch, e.singleTouch, !1),
                    resetButton: a1(e.resetButton, t.resetZoomButton)
                }
            }
            init(t, e) {
                a_(this, "init", {
                    ...
                    this.userOptions = aV({}, t),
                        (this.renderTo = a0(o) ? aD.getElementById(o) : o) || aU(13, !0, this),
                        this.margin = [],
                        this.spacing = [],
            ...
            orderItems(t, e = 0) {
                let i = this[t]
                    , s = this.options[t] = a4(this.options[t]).slice()
                    , o = this.userOptions[t] = this.userOptions[t] ? a4(this.userOptions[t]).slice() : [];
                if (this.hasRendered && (s.splice(e),
                    ...
                    for (let t = e, r = i.length; t < r; ++t) {
                        let e = i[t];
                        e && (e.index = t,
                            e instanceof ae && (e.name = e.getName()),
            ...
            getClipBox(t, e) {
                let i = this.inverted
                    , { xAxis: s, yAxis: o } = t || {}
                    , { x: r, y: a, width: n, height: h } = a1(this.clipBox);
            ...
            isInsidePlot(t, e, i = {}) {
                ...
                return a_(this, "afterIsInsidePlot", g),
                    g.isInsidePlot
            }
            redraw(t) {
                ...
                i.forEach(function (t) {
                    t.isDirty && ("point" === t.options.legendType ? ("function" == typeof t.updateTotals && t.updateTotals(),
                        ...
                        t.isDirtyData && a_(t, "updatedData")
                }),
                    ...
                    e.forEach(function (t) {
                        ...
                        t.extKey !== e && (t.extKey = e,
                            h.push(function () {
                                a_(t, "afterSetExtremes", aV(t.eventArgs, t.getExtremes())),
                                    delete t.eventArgs
                            })),
                            (p || d) && t.redraw()
                    }),
            ...
            get(t) {
                ...
                let s = a$(this.axes, i) || a$(this.series, i);
            ...
            createAxes() {
                ...
                for (let e of (a_(this, "createAxes"),
                    ["xAxis", "yAxis"]))
                    for (let i of t[e] = a4(t[e] || {}))
                        new s2(this, i, e);
                a_(this, "afterCreateAxes")
            }
            getSelectedPoints() {
                return this.series.reduce((t, e) => (e.getPointsCollection().forEach(e => {
                    a3(e.selectedStaging, e.selected) && t.push(e)
                }
                ),
                    t), [])
            }
            ...
            applyDescription(t, e) {
                let i = this
                    , s = this.options[t] = a1(this.options[t], e)
                    , o = this[t];
                o && e && (this[t] = o = o.destroy()),
                    s && !o && ((o = this.renderer.text(s.text, 0, 0, s.useHTML).attr({
                        ...
                        ,
                        this.styledMode || o.css(aV("title" === t ? {
                    ...
                    if (i && r) {
                        ...
                        if (m.height = y,
                            i.align(m, !1, a).attr({
                                ...
                                scaleX: f,
                                scaleY: f,
                                "transform-origin": `${a.x + n * f * aZ(m.align)} ${l}`
                            }),
                            !r.floating) {
                            let t = y * (y < 1.2 * l ? 1 : f);
            ...
            getContainerBox() {
                let t = [].map.call(this.renderTo.children, t => {
                    ...
                    , e = {
                        width: aq(this.renderTo, "width", !0) || 0,
                        height: aq(this.renderTo, "height", !0) || 0
                    };
            ...
            getChartSize() {
                ...
                this.chartWidth = Math.max(0, e || s.width || 600),
                    this.chartHeight = Math.max(0, a6(i, this.chartWidth) || (o ? 400 : s.height)),
                    this.containerBox = s
            }
            temporaryDisplay(t) {
                ...
                if (t)
                    for (; e?.style;)
                        e.hcOrigStyle && (aX(e, e.hcOrigStyle),
                            delete e.hcOrigStyle),
                            e.hcOrigDetached && (aD.body.removeChild(e),
                                e.hcOrigDetached = !1),
                            e = e.parentNode;
                else
                    for (; e?.style && (aD.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0,
                        aD.body.appendChild(e)),
                        ("none" === aq(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
            ...
            getContainer() {
                let t, e = this.options, i = e.chart, s = "data-highcharts-chart", o = a7(), r = this.renderTo, a = a5(aW(r, s));
                aJ(a) && aL[a] && aL[a].hasRendered && aL[a].destroy(),
                    aW(r, s, this.index),
                ...
                this.container = l,
                    ...
                    h !== this.chartWidth && (h = this.chartWidth,
                        this.styledMode || aX(l, {
                            width: a3(i.style?.width, h + "px")
                        })),
                    this.containerBox = this.getContainerBox(),
                    this._cursor = l.style.cursor;
                let d = i.renderer || !aI ? ew.getRendererType(i.renderer) : i1;
                ...
                this.renderer.chartIndex = this.index,
                    a_(this, "afterGetContainer")
            }
            getMargins(t) {
                let { spacing: e, margin: i, titleOffset: s } = this;
                this.resetMargins(),
                    s[0] && !aH(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])),
                    s[2] && !aH(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
            ...
            reflow(t) {
                ...
                delete e.pointer?.chartPosition,
                    !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (ts.clearTimeout(e.reflowTimeout),
                        e.reflowTimeout = a8(function () {
            ...
            setSize(t, e, i) {
                ...
                (s.isDirtyBox || a !== s.oldChartWidth || n !== s.oldChartHeight) && (s.styledMode || (r ? aA : aX)(s.container, {
                    width: `${a + h}px`,
                    height: `${n + l}px`
                }, r),
                    s.setChartSize(!0),
            ...
            propFromSeries() {
                ...
                ["inverted", "angular", "polar"].forEach(function (a) {
                    for (e = aR[o.type],
                        ...
                        t = r?.length; !i && t--;)
                        (e = aR[r[t].type]) && e.prototype[a] && (i = !0);
                    s[a] = i
                })
            }
            linkSeries(t) {
                    ...
                    i.forEach(function (t) {
                        ...
                        if (a0(i)) {
                            ...
                            (s = ":previous" === i ? e.series[t.index - 1] : e.get(i)) && s.linkedParent !== t && (s.linkedSeries.push(t),
                                ...
                                t.visible = a3(t.options.visible, s.options.visible, t.visible))
                        }
                    }),
                ...
                for (let e of (this.setTitle(),
                    ...
                    if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                        ...
                        let s = new sA(e, 0, "", !0)
                            , o = s.createLabel("x", i);
                        if (s.destroy(),
                            o && a3(i.reserveSpace, !aJ(t.crossing)) && (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
                            r) {
                            o?.destroy();
                            break
                        }
            ...
            addCredits(t) {
                ...
                i.enabled && !this.credits && (this.credits = this.renderer.text(i.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function () {
                    i.href && (az.location.href = i.href)
                }).attr({
            ...
            destroy() {
                ...
                for (a_(e, "destroy"),
                    e.renderer.forExport ? aj(aL, e) : aL[e.index] = void 0,
                    D.chartCount--,
            ...
            warnIfA11yModuleNotLoaded() {
                ...
                t && !this.accessibility && (this.renderer.boxWrapper.attr({
                    ...
                    t.accessibility && !1 === t.accessibility.enabled || aU('Highcharts warning: Consider including the "accessibility.js" module to make your chart more usable for people with disabilities. Set the "accessibility.enabled" option to false to remove this warning. See https://www.highcharts.com/docs/accessibility/accessibility-module.', !1, this))
            }
            addSeries(t, e, i) {
                let s, o = this;
                return t && (e = a3(e, !0),
            ...
            createAxis(t, e) {
                let i = new s2(this, e.axis, t);
                return a3(e.redraw, !0) && this.redraw(e.animation),
                    i
            }
            showLoading(t) {
                let e = this
                    ...
                    , r = e.loadingDiv
                    , a = e.loadingSpan;
                r || (e.loadingDiv = r = aG("div", {
                    className: "highcharts-loading highcharts-loading-hidden"
                }, null, e.container)),
                    a || (e.loadingSpan = a = aG("span", {
                        className: "highcharts-loading-inner"
                    }, null, r),
                        aN(e, "redraw", o)),
                    r.className = "highcharts-loading",
                    er.setElementHTML(a, a3(t, i.lang.loading, "")),
                    !e.styledMode && (aX(r, aV(s.style, {
                        zIndex: 10
                    })),
                        aX(a, s.labelStyle),
                        e.loadingShown || (aX(r, {
            ...
            update(t, e, i, s) {
                ...
                c && (a1(!0, n.options.chart, c),
                    ...
                    a2(t, function (e, i) {
                        n[i] && "function" == typeof n[i].update ? n[i].update(e, !1) : "function" == typeof n[h[i]] ? n[h[i]](e) : "colors" !== i && -1 === n.collectionsWithUpdate.indexOf(i) && a1(!0, n.options[i], t[i]),
                            "chart" !== i && -1 !== n.propsRequireUpdateSeries.indexOf(i) && (r = !0)
                    }),
                    this.collectionsWithUpdate.forEach(function (e) {
                        t[e] && (a4(t[e]).forEach(function (t, s) {
                            let o, r = aH(t.id);
                            r && (o = n.get(t.id)),
                                !o && n[e] && (o = n[e][a3(t.index, s)]) && (r && aH(o.options.id) || o.options.isInternal) && (o = void 0),
                ...
                let p = c?.width
                    , u = c && (a0(c.height) ? a6(c.height, p || n.chartWidth) : c.height);
                a || aJ(p) && p !== n.chartWidth || aJ(u) && u !== n.chartHeight ? n.setSize(p, u, s) : a3(e, !0) && n.redraw(s),
                    a_(n, "afterUpdate", {
                        options: t,
                        redraw: e,
                        animation: s
            ...
            transform(t) {
                ...
                for (let t of e) {
                    let { horiz: e, len: u, minPointOffset: g = 0, options: f, reversed: m } = t
                        , x = e ? "width" : "height"
                        , y = e ? "x" : "y"
                        , b = a3(a[x], t.len)
                        , v = a3(s[x], t.len)
                        ...
                        , M = (s[y] || 0) + v / 2 - t.pos
                        , w = M - ((a[y] ?? t.pos) + b / 2 - t.pos) / k
                        , S = m && !h || !m && h ? -1 : 1;
                    if (!o && (M < 0 || M > t.len))
                        continue;
                    let A = t.chart.polar || t.isOrdinal ? 0 : g * S || 0
                        , T = t.toValue(w, !0)
                        , C = t.toValue(w + u / k, !0)
                        , P = T + A
                        , O = C - A
                    ...
                    if (r && r[t.coll].push({
                        ...
                        for (let e of t.series) {
                            ...
                            E ?? (E = {
                                ...
                                aJ(t.dataMin) && aJ(t.dataMax) && (E.dataMin = Math.min(t.dataMin, E.dataMin),
                                    E.dataMax = Math.max(t.dataMax, E.dataMax))
                        }
                        t.allExtremes = E
                    }
                    let { dataMin: L, dataMax: D, min: B, max: I } = aV(t.getExtremes(), E || {})
                        , z = l.parse(f.min)
                        , R = l.parse(f.max)
                        , N = L ?? z
                        , W = D ?? R
                        , G = O - P
                        , X = t.categories ? 0 : Math.min(G, W - N)
                        , H = N - X * (aH(z) ? 0 : f.minPadding)
                        , F = W + X * (aH(R) ? 0 : f.maxPadding)
                        , Y = t.allowZoomOutside || 1 === k || "zoom" !== n && k > 1
                        , j = Math.min(z ?? H, H, Y ? B : H)
                        , U = Math.max(R ?? F, F, Y ? I : F);
                    (!t.isOrdinal || 1 !== k || o) && (P < j && (P = j,
                        k >= 1 && (O = P + G)),
                        O > U && (O = U,
                            k >= 1 && (P = O - G)),
                        (o || t.series.length && (P !== B || O !== I) && P >= j && O <= U) && (r ? r[t.coll].push({
                            axis: t,
                            min: P,
                            max: O
                        }) : (t.isPanning = "zoom" !== n,
                            t.isPanning && (p = !0),
                            t.setExtremes(o ? void 0 : P, o ? void 0 : O, !1, !1, {
                                move: w,
                                trigger: n,
                                scale: k
                            }),
                            !o && (P > j || O < U) && "mousewheel" !== n && (c = !0)),
                            d = !0),
                        this.hasCartesianSeries || o || "mousewheel" === n || (c = !0),
                        i && (this[e ? "mouseDownX" : "mouseDownY"] = i[e ? "chartX" : "chartY"]))
                }
                return d && (r ? a_(this, "selection", r, () => {
                    delete t.selection,
                        t.trigger = "zoom",
                        this.transform(t)
                }
        ...
        aV(nt.prototype, {
            callbacks: [],
            collectionsWithInit: {
                xAxis: [nt.prototype.addAxis, [!0]],
                yAxis: [nt.prototype.addAxis, [!1]],
                series: [nt.prototype.addSeries]
            },
        ...
        let ne = nt
            , { stop: ni } = t1
            , { composed: ns } = D
            , { addEvent: no, createElement: nr, css: na, defined: nn, erase: nh, merge: nl, pushUnique: nd } = ts;
        function nc() {
            let t = this.scrollablePlotArea;
            (this.scrollablePixelsX || this.scrollablePixelsY) && !t && (this.scrollablePlotArea = t = new nu(this)),
                t?.applyFixed()
        }
        function np() {
        ...
        class nu {
            static compose(t, e, i) {
                nd(ns, this.compose) && (no(t, "afterInit", np),
                    no(e, "afterSetChartSize", t => this.afterSetSize(t.target, t)),
                    no(e, "render", nc),
                    no(i, "show", np))
            }
            ...
            constructor(t) {
                let e, i = t.options.chart, s = ew.getRendererType(), o = i.scrollablePlotArea || {}, r = this.moveFixedElements.bind(this), a = {
                ...
                t.scrollablePixelsX && (a.overflowX = "auto"),
                    ...
                    this.chart = t;
                let n = this.parentDiv = nr("div", {
                    className: "highcharts-scrolling-parent"
                }, {
                    position: "relative"
                }, t.renderTo)
                    , h = this.scrollingContainer = nr("div", {
                        className: "highcharts-scrolling"
                    }, a, n)
                    , l = this.innerContainer = nr("div", {
                        className: "highcharts-inner-container"
                    }, void 0, h)
                    , d = this.fixedDiv = nr("div", {
                ...
                this.mask = c.path().attr({
                    ...
                    no(t, "afterShowResetZoom", r),
                    no(t, "afterApplyDrilldown", r),
                    no(t, "afterLayOutTitles", r),
                    no(h, "scroll", () => {
            ...
            moveFixedElements() {
                let t, { container: e, inverted: i, scrollablePixelsX: s, scrollablePixelsY: o } = this.chart, r = this.fixedRenderer, a = nu.fixedSelectors;
        ...
        let { format: ng } = eM
            , { series: nf } = rL
            , { destroyObjectProperties: nm, fireEvent: nx, getAlignFactor: ny, isNumber: nb, pick: nv } = ts
            , nk = class {
                constructor(t, e, i, s, o) {
                ...
                render(t) {
                    let e = this.axis.chart
                        , i = this.options
                        , s = i.format
                        , o = s ? ng(s, this, e) : i.formatter.call(this);
                    if (this.label)
                        this.label.attr({
                            text: o,
                            visibility: "hidden"
                ...
                setOffset(t, e, i, s, o, r) {
                    let { alignOptions: a, axis: n, label: h, options: l, textAlign: d } = this
                        ...
                        , { verticalAlign: u } = a;
                    if (h && p) {
                        let t = h.getBBox(void 0, 0), e = h.padding, i = "justify" === nv(l.overflow, "justify"), s;
                        a.x = l.x || 0,
                            a.y = l.y || 0;
                        ...
                        p.x -= o,
                            ...
                            i && nf.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p),
                            h.attr({
                                x: h.alignAttr.x,
                                y: h.alignAttr.y,
                                rotation: l.rotation,
                                rotationOriginX: t.width * ny(l.textAlign || "center"),
                                rotationOriginY: t.height / 2
                            }),
                            nv(!i && l.crop, !0) && (s = nb(h.x) && nb(h.y) && c.isInsidePlot(h.x - e + (h.width || 0), h.y) && c.isInsidePlot(h.x + e, h.y)),
                            h[s ? "show" : "hide"]()
                    }
                    nx(this, "afterSetOffset", {
                        xOffset: t,
                        width: e
                    })
                }
                adjustStackPosition({ labelBox: t, verticalAlign: e, textAlign: i }) {
                    return {
                        x: t.width / 2 + t.width / 2 * (2 * ny(i) - 1),
                        y: t.height / 2 * 2 * (1 - ny(e))
                    }
                }
                getStackBox(t) {
                    let e = this.axis
                        ...
                        , h = e.stacking.usePercentage ? 100 : nv(s, this.total, 0)
                        , l = e.toPixels(h)
                        , d = t.xAxis || i.xAxis[0]
                        , c = nv(o, d.translate(this.x)) + r
                        , p = Math.abs(l - e.toPixels(n || nb(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0))
                        , u = i.inverted
                        , g = this.isNegative;
                    return u ? {
            ...
            , { getDeferredAnimation: nM } = t1
            , { series: { prototype: nw } } = rL
            , { addEvent: nS, correctFloat: nA, defined: nT, destroyObjectProperties: nC, fireEvent: nP, isNumber: nO, objectEach: nE, pick: nL } = ts;
        function nD() {
            let t = this.inverted;
            this.axes.forEach(t => {
                ...
                this.series.forEach(e => {
                    ...
                    e.options.stacking && e.reserveSpace() && (e.stackKey = [e.type, nL(e.options.stack, ""), t ? i.top : i.left, t ? i.height : i.width].join(","))
                }
                )
        }
        function nB() {
        ...
        function nz(t, e, i, s) {
            return !nT(t) || t.x !== e || s && t.stackKey !== s ? t = {
                x: e,
                index: 0,
                key: s,
                stackKey: s
        ...
        function nW(t) {
            (this.is("column") || this.is("columnrange")) && (this.options.centerInCategory && this.chart.series.length > 1 ? nw.setStackedPoints.call(this, t, "group") : t.stacking.resetStacks())
        }
        function nG(t, e) {
            ...
            for (k.stacksTouched += 1,
                ...
                n = (i = this.getStackIndicator(i, e, this.index)).key || "",
                    ...
                    M[a][e] || (w[a]?.[e] ? (M[a][e] = w[a][e],
                        M[a][e].total = null) : M[a][e] = new nk(t, t.options.stackLabels, !!s, e, x)),
                    o = M[a][e],
                    null !== u ? (o.points[n] = o.points[this.index] = [nL(o.cumulative, m)],
                ...
                let S = o.total || 0;
                "percent" === l ? (r = s ? y : b,
                    S = v && M[r]?.[e] ? (r = M[r][e]).total = Math.max(r.total || 0, S) + Math.abs(g) : nA(S + Math.abs(g))) : "group" === l ? nO(u) && S++ : S = nA(S + g),
                    "group" === l ? o.cumulative = (S || 1) - 1 : o.cumulative = nA(nL(o.cumulative, m) + g),
                    o.total = S,
        ...
        class nX {
            ...
            resetStacks() {
                nE(this.stacks, t => {
                    nE(t, (e, i) => {
                        nO(e.touched) && e.touched < this.stacksTouched ? (e.destroy(),
            ...
            renderStackTotals() {
                let t = this.axis
                    ...
                    , i = e.renderer
                    , s = this.stacks
                    , o = nM(e, t.options.stackLabels?.animation || !1)
        ...
        (x || (x = {})).compose = function (t, e, i) {
            let s = e.prototype
                , o = i.prototype;
            s.getStacks || (nS(t, "init", nI),
                nS(t, "destroy", nB),
                s.getStacks = nD,
                o.getStackIndicator = nz,
                o.modifyStacks = nR,
                o.percentStacker = nN,
                o.setGroupedPoints = nW,
                o.setStackedPoints = nG)
        }
            ;
        let nH = x
            , { defined: nF, merge: nY, isObject: nj } = ts;
        class nU extends ae {
            drawGraph() {
                let t = this.options
                ...
                [this, ...this.zones].forEach((s, o) => {
                    ...
                    a ? (a.endX = this.preventGraphAnimation ? null : e.xMap,
                        ...
                        a && !i && (r = {
                            ...
                            a[n](r).shadow(t.shadow && nY({
                                filterUnits: "userSpaceOnUse"
                            }, nj(t.shadow) ? t.shadow : {}))),
                        a && (a.startX = e.xMap,
                            a.isArea = e.isArea)
                }
                )
                ...
                return l && t.reverse(),
                    ...
                    (t = this.getValidPoints(t, !1, o.nullInteraction || !(o.connectNulls && !e && !i))).forEach(function (l, d) {
                        ...
                        (l.leftCliff || g?.rightCliff) && !i && (n = !0),
                            f && !nF(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [["M", l.plotX, l.plotY]] : s.getPointSpline ? c = [s.getPointSpline(t, l, d)] : h ? (c = 1 === h ? [["L", g.plotX, u]] : 2 === h ? [["L", (g.plotX + p) / 2, g.plotY], ["L", (g.plotX + p) / 2, u]] : [["L", p, g.plotY]]).push(["L", p, u]) : c = [["L", p, u]],
                                a.push(l.x),
                                h && (a.push(l.x),
                                    2 === h && a.push(l.x)),
                                r.push.apply(r, c),
        ...
        nU.defaultOptions = nY(ae.defaultOptions, {
            legendSymbol: "lineMarker"
        }),
            rL.registerSeriesType("line", nU);
        let { seriesTypes: { line: nV } } = rL
            , { extend: n$, merge: n_, objectEach: nZ, pick: nq } = ts;
        class nK extends nV {
            drawGraph() {
                this.areaPath = [],
            ...
            getGraphPath(t) {
                let e, i, s, o = nV.prototype.getGraphPath, r = this.options, a = r.stacking, n = this.yAxis, h = [], l = [], d = this.index, c = n.stacking.stacks[this.stackKey], p = r.threshold, u = Math.round(n.getThreshold(r.threshold)), g = nq(r.connectNulls, "percent" === a), f = function (i, s, o) {
                ...
                for (let o = 0, r = t.length; o < r; ++o)
                    a || (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[o].rightNull = void 0),
                        i = t[o].isNull,
                        e = nq(t[o].rectPlotX, t[o].plotX),
                        s = a ? nq(t[o].yBottom, u) : u,
                        (!i || g) && (g || f(o, o - 1, "left"),
                            i && !a && g || (l.push(t[o]),
                                h.push({
                                    x: o,
        ...
        nK.defaultOptions = n_(nV.defaultOptions, {
            threshold: 0,
            ...
            rL.registerSeriesType("area", nK);
        let { line: nJ } = rL.seriesTypes
            , { merge: nQ, pick: n0 } = ts;
        class n1 extends nJ {
            getPointSpline(t, e, i) {
                ...
                let p = ["C", n0(l.rightContX, l.plotX, 0), n0(l.rightContY, l.plotY, 0), n0(s, n, 0), n0(o, h, 0), n, h];
                return l.rightContX = l.rightContY = void 0,
                    p
            }
        }
        n1.defaultOptions = nQ(nJ.defaultOptions),
            rL.registerSeriesType("spline", n1);
        let n2 = n1
            , { area: n3, area: { prototype: n5 } } = rL.seriesTypes
            , { extend: n6, merge: n9 } = ts;
        class n4 extends n2 {
        }
        n4.defaultOptions = n9(n2.defaultOptions, n3.defaultOptions),
            n6(n4.prototype, {
                getGraphPath: n5.getGraphPath,
                getStackPoints: n5.getStackPoints,
                drawGraph: n5.drawGraph
            }),
            rL.registerSeriesType("areaspline", n4);
        let { animObject: n8 } = t1
            , { parse: n7 } = tG
            , { noop: ht } = D
            , { clamp: he, crisp: hi, defined: hs, extend: ho, fireEvent: hr, isArray: ha, isNumber: hn, merge: hh, pick: hl, objectEach: hd } = ts;
        class hc extends ae {
            animate(t) {
                ...
                t && h ? (d.scaleY = .001,
                    i = he(o.toPixels(n.threshold || 0), r, r + o.len),
            ...
            getColumnMetrics() {
                ...
                let l = Math.min(Math.abs(i.transA) * (!i.brokenAxis?.hasBreaks && i.ordinal?.slope || e.pointRange || i.closestPointRange || i.tickInterval || 1), i.len)
                    , d = l * e.groupPadding
                    , c = (l - 2 * d) / (h || 1)
                    , p = Math.min(e.maxPointWidth || i.len, hl(e.pointWidth, c * (1 - 2 * e.pointPadding)))
                    , u = (t.columnIndex || 0) + +!!r;
            ...
            crispCol(t, e, i, s) {
                ...
                return s = hi(e + s, o, r) - (e = hi(e, o, r)),
                    this.options.crisp && (i = hi(t + i, o) - (t = hi(t, o))),
                {
                    x: t,
                    y: e,
                    width: i,
            ...
            adjustForMissingColumns(t, e, i, s) {
                if (!i.isNull && s.columnCount > 1) {
                    let o = this.xAxis.series.filter(t => t.visible).map(t => t.index)
                        , r = 0
                        , a = 0;
                    hd(this.xAxis.stacking?.stacks, t => {
            ...
            translate() {
                let t = this
                    ...
                    , o = t.borderWidth = hl(i.borderWidth, +!s)
                    , r = t.xAxis
                    , a = t.yAxis
                    , n = i.threshold
                    , h = hl(i.minPointLength, 5)
                ...
                i.pointPadding && i.crisp && (f = Math.ceil(f)),
                    ae.prototype.translate.apply(t),
                    t.points.forEach(function (s) {
                        let o = hl(s.yBottom, g), m = 999 + Math.abs(o), x = s.plotX || 0, y = he(s.plotY, -m, a.len + m), b, v = Math.min(y, o), k = Math.max(y, o) - v, M = d, w = x + c, S = f;
                        h && Math.abs(k) < h && (k = h,
                            b = !a.reversed && !s.negative || a.reversed && s.negative,
                            hn(n) && hn(u) && s.y === n && u <= n && (a.min || 0) < n && (p !== u || (a.max || 0) <= n) && (b = !b,
                                s.negative = !s.negative),
                            v = Math.abs(v - g) > h ? o - h : g - (b ? h : 0)),
                            hs(s.options.pointWidth) && (w -= Math.round(((M = S = Math.ceil(s.options.pointWidth)) - d) / 2)),
                            i.centerInCategory && (w = t.adjustForMissingColumns(w, M, s, l)),
                            s.barX = w,
                            s.pointWidth = M,
                            s.tooltipPos = e.inverted ? [he(a.len + a.pos - e.plotLeft - y, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), r.len + r.pos - e.plotTop - w - S / 2, k] : [r.left - e.plotLeft + w + S / 2, he(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), k],
            ...
            pointAttribs(t, e) {
                ...
                t && this.zones.length && (n = t.getZone(),
                    ...
                    n && (d = n.borderColor || d,
                        c = n.dashStyle || c,
                        p = n.borderWidth || p)),
                    e && t && (h = (a = hh(i.states[e], t.options.states && t.options.states[e] || {})).brightness,
                        l = a.color || void 0 !== h && n7(l).brighten(a.brightness).get() || l,
                        d = a[o] || d,
                        p = a[r] || p,
                        c = a.dashStyle || c,
                        u = hl(a.opacity, u));
            ...
            drawTracker(t = this.points) {
                ...
                t.forEach(function (t) {
                    e = ha(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [],
        ...
        hc.defaultOptions = hh(ae.defaultOptions, {
            ...
            rL.registerSeriesType("column", hc);
        let hp = hc
            , { getDeferredAnimation: hu } = t1
            , { format: hg } = eM
            , { defined: hf, extend: hm, fireEvent: hx, getAlignFactor: hy, isArray: hb, isString: hv, merge: hk, objectEach: hM, pick: hw, pInt: hS, splat: hA } = ts;
        !function (t) {
            function e() {
            ...
            function i(t, e, i, s, o) {
                let { chart: r, enabledDataSorting: a } = this
                    ...
                    , l = t.plotY
                    , d = i.rotation || 0
                    , c = hf(h) && hf(l) && r.isInsidePlot(h, Math.round(l), {
                        inverted: n,
                        paneCoordinates: !0,
                        series: this
                    })
                    , p = 0 === d && "justify" === hw(i.overflow, a ? "none" : "justify")
                    , u = this.visible && !1 !== t.visible && hf(h) && (t.series.forceDL || a && !p || c || hw(i.inside, !!this.options.stacking) && s && r.isInsidePlot(h, n ? s.x + 1 : s.y + s.height - 1, {
                        inverted: n,
                        paneCoordinates: !0,
                        series: this
                    }))
                ...
                if (u && g) {
                    ...
                    if (s = hm({
                        ...
                        e.alignAttr.x += hy(i.align) * (l.width - h.width),
                        e.alignAttr.y += hy(i.verticalAlign) * (l.height - h.height),
            ...
            function r(t) {
                ...
                let i = this
                    ...
                    , d = r.getContrast(hv(l) && l || hv(a) && a || "#000000")
                    , c = h(i)
                ...
                hx(this, "drawDataLabels"),
                    i.hasDataLabels?.() && (e = this.initDataLabels(g),
                        t.forEach(t => {
                            let a = t.dataLabels || []
                                , h = t.color || i.color;
                            hA(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                                let c = n.enabled && (t.visible || t.dataLabelOnHidden) && (!t.isNull || t.dataLabelOnNull) && function (t, e) {
                                    ...
                                    return !0
                                }(t, n), { backgroundColor: p, borderColor: u, distance: g, style: f = {} } = n, m, x, y, b = {}, v = a[l], k = !v, M;
                                c && (x = hf(m = hw(n[t.formatPrefix + "Format"], n.format)) ? hg(m, t, s) : (n[t.formatPrefix + "Formatter"] || n.formatter).call(t, n),
                                    y = n.rotation,
                                    !s.styledMode && (f.color = hw(n.color, f.color, hv(i.color) ? i.color : void 0, "#000000"),
                                        "contrast" === f.color ? ("none" !== p && (M = p),
                                            t.contrastColor = r.getContrast("auto" !== M && hv(M) && M || (hv(h) ? h : "")),
                                            f.color = M || !hf(g) && n.inside || 0 > hS(g || 0) || o.stacking ? t.contrastColor : d) : delete t.contrastColor,
                                    ...
                                    s.styledMode || (b.fill = "auto" === p ? t.color : p,
                                        b.stroke = "auto" === u ? t.color : u,
                                        b["stroke-width"] = n.borderWidth),
                                    hM(b, (t, e) => {
                                        void 0 === t && delete b[e]
                                    }
                                    )),
                                    !v || c && hf(x) && !!(v.div || v.text?.foreignObject) == !!n.useHTML && (v.rotation && n.rotation || v.rotation === n.rotation) || (v = void 0,
                                        k = !0),
                                    c && hf(x) && "" !== x && (v ? b.text = x : (v = r.label(x, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " highcharts-tracker" : "")),
                                        v && (v.options = n,
                                            v.attr(b),
            ...
            function h(t) {
                ...
                return hA(n(n(e?.series?.dataLabels, e?.[t.type]?.dataLabels), t.options.dataLabels))
            }
        ...
        !function (t) {
            function e(t, e, i, s, o) {
                ...
                i.align ?? (i.align = !n || p ? "center" : c ? "right" : "left"),
                    ...
                    hP.prototype.alignDataLabel.call(this, t, e, i, s, o),
            ...
            t.compose = function (t) {
                hT.compose(hP),
                    hE(hC, "ColumnDataLabel") && (t.prototype.alignDataLabel = e)
            }
        }(b || (b = {}));
        let hL = b
            , { extend: hD, merge: hB } = ts;
        class hI extends hp {
        }
        hI.defaultOptions = hB(hp.defaultOptions, {}),
            hD(hI.prototype, {
                inverted: !0
            }),
            rL.registerSeriesType("bar", hI);
        let { column: hz, line: hR } = rL.seriesTypes
            , { addEvent: hN, extend: hW, merge: hG } = ts;
        class hX extends hR {
            applyJitter() {
                let t = this
        ...
        hX.defaultOptions = hG(hR.defaultOptions, {
            lineWidth: 0,
            ...
            hW(hX.prototype, {
                drawTracker: hz.prototype.drawTracker,
                sorted: !1,
                requireSorting: !1,
                noSharedTooltip: !0,
                trackerGroups: ["group", "markerGroup", "dataLabelsGroup"]
            }),
            hN(hX, "afterTranslate", function () {
                this.applyJitter()
            }),
            rL.registerSeriesType("scatter", hX);
        let { deg2rad: hH } = D
            , { fireEvent: hF, isNumber: hY, pick: hj, relativeLength: hU } = ts;
        !function (t) {
            t.getCenter = function () {
                ...
                let u = [hj(r?.[0], "50%"), hj(r?.[1], "50%"), hj(l && l < 0 ? void 0 : t.size, "100%"), hj(d && d < 0 ? void 0 : t.innerSize || 0, "0%")];
                for (!e.angular || this instanceof ae || (u[3] = 0),
                    c = 0; c < 4; ++c)
                    p = u[c],
                        h = c < 2 || 2 === c && /%$/.test(p),
                        u[c] = hU(p, [s, o, a, u[2]][c]) + (h ? i : 0);
                return u[3] > u[2] && (u[3] = u[2]),
                    hY(n) && 2 * n < u[2] && n > 0 && (u[3] = u[2] - 2 * n),
                    hF(this, "afterGetCenter", {
                        positions: u
                    }),
                    u
            }
        ...
        let hV = v
            , { setAnimation: h$ } = t1
            , { addEvent: h_, defined: hZ, extend: hq, isNumber: hK, pick: hJ, relativeLength: hQ } = ts;
        class h0 extends o4 {
            getConnectorPath(t) {
            ...
            slice(t, e, i) {
                ...
                h$(i, s.chart),
                    e = hJ(e, !0),
                    this.sliced = this.options.sliced = t = hZ(t) ? t : !this.sliced,
        ...
        let { getStartAndEndRadians: h1 } = hV
            , { noop: h2 } = D
            , { clamp: h3, extend: h5, fireEvent: h6, merge: h9, pick: h4 } = ts;
        class h8 extends ae {
            animate(t) {
                let e = this
                    , i = e.points
                ...
                t || i.forEach(function (t) {
                    let i = t.graphic
                        , o = t.shapeArgs;
                    i && o && (i.attr({
                        r: h4(t.startR, e.center && e.center[3] / 2),
                        start: s,
                        end: s
                    }),
                        i.animate({
            ...
            drawEmpty() {
                ...
                0 === this.total && this.center ? (t = this.center[0],
                    ...
                    this.graph.attr({
                        d: ig.arc(t, e, this.center[2] / 2, 0, {
                            start: i,
                            end: s,
            ...
            translate(t) {
                h6(this, "translate"),
                    this.generatePoints();
                let e = this.options, i = e.slicedOffset, s = h1(e.startAngle, e.endAngle), o = this.startAngleRad = s.start, r = (this.endAngleRad = s.end) - o, a = this.points, n = e.ignoreHiddenPoint, h = a.length, l, d, c, p, u, g, f, m = 0;
        ...
        h8.defaultOptions = h9(ae.defaultOptions, {
            borderRadius: 3,
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            h5(h8.prototype, {
                ...
                directTouch: !0,
                drawGraph: void 0,
                drawTracker: hp.prototype.drawTracker,
                getCenter: hV.getCenter,
                getSymbol: h2,
                invertible: !1,
                isCartesian: !1,
                noSharedTooltip: !0,
                pointAttribs: hp.prototype.pointAttribs,
                pointClass: h0,
                requireSorting: !1,
                searchPoint: h2,
                trackerGroups: ["group", "dataLabelsGroup"]
            }),
            rL.registerSeriesType("pie", h8);
        let { composed: h7, noop: lt } = D
            , { distribute: le } = eP
            , { series: li } = rL
            , { arrayMax: ls, clamp: lo, defined: lr, isNumber: la, pick: ln, pushUnique: lh, relativeLength: ll } = ts;
        !function (t) {
            let e = {
            ...
            function s() {
                ...
                t.visible && t.hasDataLabels?.() && (e.forEach(t => {
                    ...
                    li.prototype.drawDataLabels.apply(t),
                    e.forEach(t => {
                        (t.dataLabels || []).forEach((e, i) => {
                            let s = n[2] / 2
                                ...
                                , r = ll(o?.distance || 0, s);
                            0 === i && d[t.half].push(t),
                                !lr(o?.style?.width) && e.getBBox().width > a && (e.css({
                            ...
                            e.forEach(i => {
                                (i.dataLabels || []).forEach(l => {
                                    let d = l.options || {}
                                        ...
                                        , S = "inherit";
                                    if (x) {
                                        if (u && lr(m) && x.distance > 0 && (void 0 === m.pos ? S = "hidden" : (f = m.size,
                    ...
                    (0 === ls(c) || this.verifyDataLabelOverflow(c)) && (this.placeDataLabels(),
                        this.points.forEach(e => {
                            (e.dataLabels || []).forEach(s => {
                                ...
                                if (la(r)) {
                                    ...
                                    u = s.connector,
                                        a && a.distance > 0 ? (n = !u,
                                            u || (s.connector = u = i.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + e.colorIndex + (e.className ? " " + e.className : "")).add(t.dataLabelsGroup)),
                                            i.styledMode || u.attr({
                                                "stroke-width": r,
            ...
            function r(t) {
                ...
                return !a && (null !== s[0] ? r = Math.max(e[2] - Math.max(t[1], t[3]), o) : (r = Math.max(e[2] - t[1] - t[3], o),
                    e[0] += (t[3] - t[1]) / 2),
                    null !== s[1] ? r = lo(r, o, e[2] - Math.max(t[0], t[2])) : (r = lo(r, o, e[2] - t[0] - t[2]),
                        e[1] += (t[0] - t[2]) / 2),
                    r < e[2] ? (e[2] = r,
                        e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, ll(i.innerSize || 0, r)), r),
                        this.translate(e),
        ...
        let { pointInPolygon: lc } = M
            , { addEvent: lp, getAlignFactor: lu, fireEvent: lg, objectEach: lf, pick: lm } = ts;
        function lx(t) {
            ...
            for (let e of t)
                ly(e, this) && (l = !0);
            l && lg(this, "afterHideAllOverlappingLabels")
        }
        function ly(t, e) {
            let i, s = !1;
            return t && (i = t.newOpacity,
                t.oldOpacity !== i && (t.hasClass("highcharts-data-label") ? (t[i ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                    ...
                    lg(e, "afterHideOverlappingLabel")) : t.attr({
                        opacity: i
                    })),
                t.isOld = !0),
                s
        ...
        function lb() {
            ...
            for (let i of t.yAxis || [])
                i.stacking && i.options.stackLabels && !i.options.stackLabels.allowOverlap && lf(i.stacking.stacks, t => {
                    lf(t, t => {
                    ...
                    let s = i => {
                        for (let s of i)
                            s.visible && (s.dataLabels || []).forEach(i => {
                                let o = i.options || {};
                                i.labelrank = lm(o.labelrank, s.labelrank, s.shapeArgs?.height),
        ...
        let lv = {
            compose: function (t) {
                let e = t.prototype;
                e.hideOverlappingLabels || (e.hideOverlappingLabels = lx,
                    lp(t, "render", lb))
            }
        }
            , { defaultOptions: lk } = tE
            , { noop: lM } = D
            , { addEvent: lw, extend: lS, isObject: lA, merge: lT, relativeLength: lC } = ts
            , lP = {
                radius: 0,
                scope: "stack",
                where: void 0
        ...
        function lL(t, e, i, s, o = {}) {
            ...
            let p = c - d
                , u = Math.sin(p / 2)
                , g = Math.max(Math.min(lC(o.borderRadius || 0, l - h), (l - h) / 2, l * u / (1 + u)), 0)
        ...
        function lD() {
            if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                let { options: t, yAxis: e } = this
                    ...
                    , s = lk.plotOptions?.[this.type]?.borderRadius
                    , o = lB(t.borderRadius, lA(s) ? s : {})
        ...
        function lI() {
            let t = lB(this.options.borderRadius);
        ...
        let { diffObjects: lR, extend: lN, find: lW, merge: lG, pick: lX, uniqueKey: lH } = ts;
        !function (t) {
            function e(t, e) {
                let i = t.condition;
                (i.callback || function () {
                    return this.chartWidth <= lX(i.maxWidth, Number.MAX_VALUE) && this.chartHeight <= lX(i.maxHeight, Number.MAX_VALUE) && this.chartWidth >= lX(i.minWidth, 0) && this.chartHeight >= lX(i.minHeight, 0)
                }
            ...
            function i(t, e) {
                ...
                !e && i && i.rules && i.rules.forEach(t => {
                    void 0 === t._id && (t._id = lH()),
                        this.matchResponsiveRule(t, o)
                }
                    , this);
                let a = lG(...o.map(t => lW(i?.rules || [], e => e._id === t)).map(t => t?.chartOptions));
                ...
                o !== n && (s && (this.currentResponsive = void 0,
                    ...
                    o ? ((r = lR(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0,
            ...
            t.compose = function (t) {
                let s = t.prototype;
                return s.matchResponsiveRule || lN(s, {
        ...
        D.AST = er,
            ...
            D.Legend = aS,
            D.LegendSymbol = rT,
            D.OverlappingDataLabels = D.OverlappingDataLabels || lv,
            D.PlotLineOrBand = om,
            D.Point = o4,
            D.Pointer = rm,
            D.RendererRegistry = ew,
            D.Series = ae,
            D.SeriesRegistry = rL,
            D.StackItem = nk,
            D.SVGElement = e8,
            ...
            D.Time = tS,
            D.Tooltip = oH,
            D.animate = t1.animate,
            D.animObject = t1.animObject,
            D.chart = ne.chart,
            D.color = tG.parse,
            D.dateFormat = eM.dateFormat,
            D.defaultOptions = tE.defaultOptions,
            D.distribute = eP.distribute,
            D.format = eM.format,
            D.getDeferredAnimation = t1.getDeferredAnimation,
            D.getOptions = tE.getOptions,
            D.numberFormat = eM.numberFormat,
            D.seriesType = rL.seriesType,
            D.setAnimation = t1.setAnimation,
            D.setOptions = tE.setOptions,
            D.stop = t1.stop,
            D.time = tE.defaultTime,
            D.timers = tj.timers,
            ({
                compose: function (t, e, i) {
                    ...
                    if (!e.symbolCustomAttribs.includes("borderRadius")) {
                        ...
                        lw(t, "afterColumnTranslate", lD, {
                            order: 9
                        }),
                            lw(s, "afterTranslate", lI),
                ...
                optionsToObject: lB
            }).compose(D.Series, D.SVGElement, D.SVGRenderer),
            hL.compose(D.Series.types.column),
            hT.compose(D.Series),
            s4.compose(D.Axis),
            sr.compose(D.SVGRenderer),
            aS.compose(D.Chart),
            oe.compose(D.Axis),
            lv.compose(D.Chart),
            ld.compose(D.Series.types.pie),
            om.compose(D.Chart, D.Axis),
            rm.compose(D.Chart),
            lF.compose(D.Chart),
            nu.compose(D.Axis, D.Chart, D.Series),
            nH.compose(D.Axis, D.Chart, D.Series),
            oH.compose(D.Pointer),
            ts.extend(D, ts);
        let { tooltipFormatter: lY } = o4.prototype
            , { addEvent: lj, arrayMax: lU, arrayMin: lV, correctFloat: l$, defined: l_, isArray: lZ, isNumber: lq, isString: lK, pick: lJ } = ts;
        !function (t) {
            function e(t, e, i) {
                !this.isXAxis && (this.series.forEach(function (i) {
                    "compare" === t && "boolean" != typeof e ? i.setCompare(e, !1) : "cumulative" !== t || lK(e) || i.setCumulative(e, !1)
                }),
                    lJ(i, !0) && this.chart.redraw())
            }
            function i(t) {
                let e = this
                    , { numberFormatter: i } = e.series.chart
                    , s = function (s) {
                        t = t.replace("{point." + s + "}", (e[s] > 0 && "change" === s ? "+" : "") + i(e[s], lJ(e.series.tooltipOptions.changeDecimals, 2)))
                    };
                return l_(e.change) && s("change"),
                    l_(e.cumulativeSum) && s("cumulativeSum"),
                    lY.apply(this, [t])
            }
            function s() {
                let t, e = this.options.compare;
                ("percent" === e || "value" === e || this.options.cumulative) && (t = new d(this),
                    "percent" === e || "value" === e ? t.initCompare(e) : t.initCumulative()),
                    this.dataModify = t
            }
            function o(t) {
                ...
                if (this.dataModify && e) {
                    let t;
                    this.options.compare ? t = [this.dataModify.modifyValue(e.dataMin), this.dataModify.modifyValue(e.dataMax)] : this.options.cumulative && lZ(i) && i.length >= 2 && (t = d.getCumulativeExtremes(i)),
                        t && (e.dataMin = lV(t),
                            e.dataMax = lU(t))
                }
            }
            ...
            function a() {
                ...
                if (this.xAxis && t.length && this.dataModify) {
                    ...
                    for (let o = 0; o < i - s; o++) {
                        let i = t[o];
                        if (lq(i) && 0 !== i && e[o + s] >= (this.xAxis.min || 0)) {
            ...
            t.compose = function (t, d, c) {
                ...
                return g.setCompare || (g.setCompare = r,
                    g.setCumulative = h,
                    lj(t, "afterInit", s),
                    lj(t, "afterGetExtremes", o),
                    lj(t, "afterProcessData", a)),
                ...
                initCumulative() {
                    this.modifyValue = function (t, e) {
                        if (null === t && (t = 0),
                            ...
                            i && i.cumulativeSum && (t = l$(i.cumulativeSum + t));
        ...
        let lQ = S
            , { isTouchDevice: l0 } = D
            , { addEvent: l1, merge: l2, pick: l3 } = ts
            , l5 = [];
        function l6() {
        ...
        function l9() {
            ...
            if (o) {
                ...
                this.inverted ? (o.left = o.opposite ? this.chartWidth - r - o.height : this.spacing[3] + r,
                    o.top = this.plotTop + a) : (o.left = l3(e.left, this.plotLeft + a),
                        o.top = o.navigatorOptions.top || this.chartHeight - o.height - r - (this.scrollbar?.options.margin || 0) - this.spacing[2] - (this.rangeSelector && this.extraBottomMargin ? this.rangeSelector.getHeight() : 0) - (t && "bottom" === t.verticalAlign && "proximate" !== t.layout && t.enabled && !t.floating ? s.legendHeight + l3(t.margin, 10) : 0) - (this.titleOffset ? this.titleOffset[2] : 0)),
        ...
        function l4(t) {
            !this.navigator && !this.scroller && (this.options.navigator.enabled || this.options.scrollbar.enabled) && (this.scroller = this.navigator = new i(this),
                l3(t.redraw, !0) && this.redraw(t.animation))
        }
        function l8() {
            let t = this.options;
        ...
        function l7() {
            let t = this.options
                , e = t.navigator
                , i = t.rangeSelector;
            if ((e && e.enabled || i && i.enabled) && (!l0 && "x" === this.zooming.type || l0 && "x" === this.zooming.pinchType))
                return !1
        }
        function dt(t) {
            let e = t.navigator;
        ...
        function de(t) {
            ...
            !this.navigator && !this.scroller && (e.enabled || i.enabled) && (l2(!0, this.options.navigator, e),
                l2(!0, this.options.scrollbar, i),
                delete t.options.navigator,
                delete t.options.scrollbar)
        }
        let di = {
            compose: function (t, e) {
                if (ts.pushUnique(l5, t)) {
                    let s = t.prototype;
                    i = e,
                        s.callbacks.push(dt),
                        l1(t, "afterAddSeries", l6),
                        l1(t, "afterSetChartSize", l9),
                        l1(t, "afterUpdate", l4),
                        l1(t, "beforeRender", l8),
                        l1(t, "beforeShowResetZoom", l7),
                        l1(t, "update", de)
                }
            }
        }
            , { isTouchDevice: ds } = D
            , { addEvent: dr, correctFloat: da, defined: dn, isNumber: dh, pick: dl } = ts;
        function dd() {
            this.navigatorAxis || (this.navigatorAxis = new dp(this))
        }
        function dc(t) {
            ...
            if (this.isXAxis && (o?.enabled || n?.enabled)) {
                if ("y" === h && "zoom" === t.trigger)
                    e = !1;
                else if (("zoom" === t.trigger && "xy" === h || ds && "xy" === a) && this.options.range) {
                    let e = r.previousZoom;
                    dn(t.min) ? r.previousZoom = [this.min, this.max] : e && (t.min = e[0],
                        t.max = e[1],
        ...
        class dp {
            ...
            toFixedRange(t, e, i, s) {
                let o = this.axis
                    , r = (o.pointRange || 0) / 2
                    , a = dl(i, o.translate(t, !0, !o.horiz))
                    , n = dl(s, o.translate(e, !0, !o.horiz));
                return dn(i) || (a = da(a + r)),
                    dn(s) || (n = da(n - r)),
                    dh(a) && dh(n) || (a = n = void 0),
                {
                    min: a,
                    max: n
                }
        ...
        let { parse: du } = tG
            ...
            , df = {
                ...
                maskFill: du("#667aff").setOpacity(.3).get(),
                outlineColor: "#999999",
                outlineWidth: 1,
                series: {
                    type: void 0 === dg.areaspline ? "line" : "areaspline",
                    fillOpacity: .05,
                    lineWidth: 1,
                    compare: null,
                    sonification: {
            ...
            , { relativeLength: dm } = ts
            , dx = {
                "navigator-handle": function (t, e, i, s, o = {}) {
                    let r = o.width ? o.width / 2 : i
                        , a = dm(o.borderRadius || 0, Math.min(2 * r, s));
                    return [["M", -1.5, (s = o.height || s) / 2 - 3.5], ["L", -1.5, s / 2 + 4.5], ["M", .5, s / 2 - 3.5], ["L", .5, s / 2 + 4.5], ...ig.rect(-r - 1, .5, 2 * r + 1, s, {
                        r: a
                    })]
                }
            }
            ...
            , db = {
                setFixedRange: function (t) {
                    let e = this.xAxis[0];
                    dy(e.dataMax) && dy(e.dataMin) && t ? this.fixedRange = Math.min(t, e.dataMax - e.dataMin) : this.fixedRange = t
                }
            }
            , { defaultOptions: dv } = tE
            , { composed: dk } = D
            , { getRendererType: dM } = ew
            , { setFixedRange: dw } = db
            , { addEvent: dS, extend: dA, pushUnique: dT } = ts;
        function dC() {
        ...
        let dP = {
            compose: function (t, e, i) {
                dp.compose(e),
                    dT(dk, "Navigator") && (t.prototype.setFixedRange = dw,
                        dA(dM().prototype.symbols, dx),
                        dA(dv, {
                            navigator: df
                        }),
                        dS(i, "afterUpdate", dC))
            ...
            , { composed: dO } = D
            , { addEvent: dE, correctFloat: dL, defined: dD, pick: dB, pushUnique: dI } = ts;
        !function (t) {
            let e;
            function i(t) {
                let e = dB(t.options?.min, t.min)
                    , i = dB(t.options?.max, t.max);
                return {
                    axisMin: e,
                    axisMax: i,
                    scrollMin: dD(t.dataMin) ? Math.min(e, t.min ?? 1 / 0, t.dataMin, t.threshold ?? 1 / 0) : e,
                    scrollMax: t.treeGrid?.adjustedMax ?? (dD(t.dataMax) ? Math.max(i, t.max ?? -1 / 0, t.dataMax, t.threshold ?? -1 / 0) : i)
                }
            }
            function s() {
            ...
            function o() {
                ...
                t.options?.scrollbar?.enabled && (t.options.scrollbar.vertical = !t.horiz,
                    ...
                    dE(t.scrollbar, "changed", function (e) {
            ...
            function r() {
                ...
                if (a && h) {
                    ...
                    if (h[t] += a.size + (a.options.margin || 0),
                        isNaN(o) || isNaN(r) || !dD(this.min) || !dD(this.max) || dD(this.dataMin) && this.dataMin === this.dataMax)
                        a.setRange(0, 1);
            ...
            t.compose = function (t, i) {
                dI(dO, "Axis.Scrollbar") && (e = i,
                    dE(t, "afterGetOffset", s),
                    dE(t, "afterInit", o),
                    dE(t, "afterRender", r))
            }
        }(A || (A = {}));
        let dz = A
            ...
            , { defaultOptions: dN } = tE
            , { composed: dW } = D
            , { addEvent: dG, correctFloat: dX, crisp: dH, defined: dF, destroyObjectProperties: dY, extend: dj, fireEvent: dU, merge: dV, pick: d$, pushUnique: d_, removeEvent: dZ } = ts;
        class dq {
            static compose(t) {
                dz.compose(t, dq),
                    d_(dW, "Scrollbar") && dj(dN, {
                        scrollbar: dR
                    })
            }
            static swapXY(t, e) {
            ...
            buttonToMaxClick(t) {
                let e = (this.to - this.from) * d$(this.options.step, .2);
            ...
            buttonToMinClick(t) {
                let e = dX(this.to - this.from) * d$(this.options.step, .2);
                this.updatePosition(dX(this.from - e), dX(this.to - e)),
                    dU(this, "changed", {
                        from: this.from,
                        to: this.to,
                        trigger: "scrollbar",
            ...
            drawScrollbarButton(t) {
                ...
                if (i.push(r),
                    ...
                    let n = e.path(dq.swapXY([["M", o / 2 + (t ? -1 : 1), o / 2 - 3], ["L", o / 2 + (t ? -1 : 1), o / 2 + 3], ["L", o / 2 + (t ? 2 : -2), o / 2]], s.vertical)).addClass("highcharts-scrollbar-arrow").add(i[t]);
            ...
            init(t, e, i) {
                this.scrollbarButtons = [],
                    this.renderer = t,
                    this.userOptions = e,
                    this.options = dV(dR, dN.scrollbar, e),
                    this.options.margin = d$(this.options.margin, 10),
                    this.chart = i,
            ...
            mouseMoveHandler(t) {
                ...
                this.grabbedCenter && (!t.touches || 0 !== t.touches[0][s]) && (e = this.cursorToScrollbarPosition(i)[s] - this[s],
                    ...
                    this.hasDragged && dU(this, "changed", {
                        from: this.from,
                        to: this.to,
                        trigger: "scrollbar",
                        DOMType: t.type,
            ...
            render() {
                ...
                this.track.attr({
                    ...
                    this.scrollbarRifles = t.path(dq.swapXY([["M", -3, i / 4], ["L", -3, 2 * i / 3], ["M", 0, i / 4], ["L", 0, 2 * i / 3], ["M", 3, i / 4], ["L", 3, 2 * i / 3]], e.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup),
                    ...
                    this.scrollbarGroup.translate(-dH(0, this.scrollbarStrokeWidth), -dH(0, this.scrollbarStrokeWidth)),
            ...
            shouldUpdateExtremes(t) {
                return d$(this.options.liveRedraw, D.svg && !D.isTouchDevice && !this.chart.boosted) || "mouseup" === t || "touchend" === t || !dF(t)
            }
            trackClick(t) {
                let e = this.chart.pointer?.normalize(t) || t
                    , i = this.to - this.from
            ...
            update(t) {
                this.destroy(),
                    this.init(this.chart.renderer, dV(!0, this.options, t), this.chart)
            }
            updatePosition(t, e) {
                e > 1 && (t = dX(1 - dX(e - t)),
                    e = 1),
        ...
        dq.defaultOptions = dR;
        let { defaultOptions: dK } = tE
            , { isTouchDevice: dJ } = D
            , { prototype: { symbols: dQ } } = i1
            , { addEvent: d0, clamp: d1, correctFloat: d2, defined: d3, destroyObjectProperties: d5, erase: d6, extend: d9, find: d4, fireEvent: d8, isArray: d7, isNumber: ct, merge: ce, pick: ci, removeEvent: cs, splat: co } = ts;
        function cr(t, ...e) {
            let i = [].filter.call(e, ct);
            if (i.length)
        ...
        class ca {
                    ...
                    [0, 1].forEach(e => {
                        ...
                        if (t.handles[e] && t.handles[e].symbolUrl === l) {
                            if (!t.handles[e].isImg && t.handles[e].symbolName !== l) {
                                let i = dQ[l].call(dQ, -h / 2 - 1, 0, h, o);
                                t.handles[e].attr({
                                    d: i
                                }),
            ...
            update(t, e = !1) {
                ...
                if (this.navigatorEnabled && (this.isDirty = !0,
                    !1 === t.adaptToUpdatedData && this.baseSeries.forEach(t => {
                        cs(t, "updatedData", this.updatedDataHandler)
                    }
                        , this),
                    t.adaptToUpdatedData && this.baseSeries.forEach(t => {
                        t.eventsToUnbind.push(d0(t, "updatedData", this.updatedDataHandler))
                    }
                        , this),
            ...
            render(t, e, i, s) {
                ...
                if (this.isDirty && this.renderElements(),
                    ...
                    if (!l)
                        ...
                        i = 0,
                            s = ci(r.width, n.width);
                this.left = ci(r.left, o.plotLeft + u + (d ? o.plotWidth : 0));
                let v = this.size = y = ci(r.len, (d ? o.plotHeight : o.plotWidth) - 2 * u);
                g = d ? x : y + 2 * u,
                    i = ci(i, r.toPixels(t, !0)),
                    s = ci(s, r.toPixels(e, !0)),
                    ct(i) && Math.abs(i) !== 1 / 0 || (i = 0,
                        s = g);
                let k = r.toValue(i, !0)
                    , M = r.toValue(s, !0)
                    , w = Math.abs(d2(M - k));
                w < c ? this.grabbedLeft ? i = r.toPixels(M - c - a, !0) : this.grabbedRight && (s = r.toPixels(k + c + a, !0)) : d3(p) && d2(w - a) > p && (this.grabbedLeft ? i = r.toPixels(M - p - a, !0) : this.grabbedRight && (s = r.toPixels(k + p + a, !0))),
                    this.zoomedMax = d1(Math.max(i, s), 0, v),
                    this.zoomedMin = d1(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i, s), 0, v),
            ...
            addMouseEvents() {
                ...
                t.mouseMoveHandler = o = function (e) {
                    ...
                    ,
                    (s = t.getPartsEvents("mousedown")).push(d0(e.renderTo, "mousemove", o), d0(i.ownerDocument, "mouseup", r), d0(e.renderTo, "touchmove", o), d0(i.ownerDocument, "touchend", r)),
                    s.concat(t.getPartsEvents("touchstart")),
                    t.eventsToUnbind = s,
                    t.series && t.series[0] && s.push(d0(t.series[0].xAxis, "foundExtremes", function () {
            ...
            getPartsEvents(t) {
                ...
                return ["shades", "handles"].forEach(function (s) {
                    e[s].forEach(function (o, r) {
                        i.push(d0(o.element, t, function (t) {
                            e[s + "Mousedown"](t, r)
                        }))
                    })
                }),
                    ...
                    1 === e ? (this.grabbedCenter = h,
                        ...
                        this.dragOffset = h - o) : (p = h - n - a / 2,
                            ...
                            p !== o && (this.fixedWidth = a,
                                d3((c = s.navigatorAxis.toFixedRange(p, p + a, d, l)).min) && d8(this, "setRange", {
            ...
            onMouseMove(t) {
                ...
                (!t.touches || 0 !== t.touches[0].pageX) && (h = (t = i.pointer?.normalize(t) || t).chartX,
                    ...
                    e.hasDragged && e.scrollbar && ci(e.scrollbar.options.liveRedraw, !dJ && !this.chart.boosted) && (t.DOMType = t.type,
                        setTimeout(function () {
                            e.onMouseUp(t)
                        }, 0)))
            }
            onMouseUp(t) {
                ...
                (this.hasDragged && (!l || !l.hasDragged) || "scrollbar" === t.trigger) && (s = this.getUnionExtremes(),
                    ...
                    d3((a = h.navigatorAxis.toFixedRange(this.zoomedMin, this.zoomedMax, o, r)).min) && d8(this, "setRange", {
                    ...
                    this.navigatorEnabled && ct(this.zoomedMin) && ct(this.zoomedMax) && (i = Math.round(this.zoomedMin),
            ...
            removeBaseSeriesEvents() {
                ...
                this.navigatorEnabled && t[0] && (!1 !== this.navigatorOptions.adaptToUpdatedData && t.forEach(function (t) {
                    ...
                    t[0].xAxis && cs(t[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes))
            }
            getXAxisOffsets() {
            ...
            init(t) {
                ...
                if (t.isDirtyBox = !0,
                    ...
                    l.xAxis = new s2(t, ce({
                        ...
                        l.yAxis = new s2(t, ce(i.yAxis, {
                            alignTicks: !1,
                            offset: 0,
                            index: p,
                            isInternal: !0,
                            reversed: ci(i.yAxis && i.yAxis.reversed, t.yAxis[0] && t.yAxis[0].reversed, !1),
                            zoomEnabled: !1
                        }, t.inverted ? {
                            width: a
                        } : {
                        ...
                        d || i.series.data ? l.updateNavigatorSeries(!1) : 0 === t.series.length && (l.unbindRedraw = d0(t, "beforeRedraw", function () {
                    ...
                    l.xAxis = {
                        ...
                        translate: function (e, i) {
                            let s = t.xAxis[0]
                                , o = s.getExtremes()
                                , r = s.len - 2 * h
                                , a = cr("min", s.options.min, o.dataMin)
                                , n = cr("max", s.options.max, o.dataMax) - a;
                        ...
                        l.xAxis.navigatorAxis.toFixedRange = dp.prototype.toFixedRange.bind(l.xAxis.navigatorAxis);
                if (t.options.scrollbar?.enabled) {
                    let e = ce(t.options.scrollbar, {
                        vertical: t.inverted
                    });
                    ct(e.margin) || (e.margin = t.inverted ? -3 : 3),
                        t.scrollbar = l.scrollbar = new dq(t.renderer, e, t),
                        d0(l.scrollbar, "changed", function (t) {
                            let e = l.size
                                , i = e * this.to
                                , s = e * this.from;
            ...
            setOpposite() {
                let t = this.navigatorOptions
                    ...
                    , i = this.chart;
                this.opposite = ci(t.opposite, !!(!e && i.inverted))
            }
            getUnionExtremes(t) {
                let e, i = this.chart.xAxis[0], s = this.chart.time, o = this.xAxis, r = o.options, a = i.options;
                return t && null === i.dataMin || (e = {
                    dataMin: ci(s.parse(r?.min), cr("min", s.parse(a.min), i.dataMin, o.dataMin, o.min)),
                    dataMax: ci(s.parse(r?.max), cr("max", s.parse(a.max), i.dataMax, o.dataMax, o.max))
                }),
                    e
            }
            setBaseSeries(t, e) {
                let i = this.chart
                    , s = this.baseSeries = [];
                t = t || i.options && i.options.navigator.baseSeries || (i.series.length ? d4(i.series, t => !t.options.isInternal).index : 0),
            ...
            updateNavigatorSeries(t, e) {
                let i = this, s = i.chart, o = i.baseSeries, r = {
                    ...
                    let e = t.baseSeries;
                    return !(0 > o.indexOf(e)) || (e && (cs(e, "updatedData", i.updatedDataHandler),
                ...
                o && o.length && o.forEach(t => {
                    let c = t.navigatorSeries
                        , p = d9({
                            color: t.color,
                            visible: t.visible
                        }, d7(l) ? dK.navigator.series : l);
                    if (c && !1 === i.navigatorOptions.adaptToUpdatedData)
                        return;
                    r.name = "Navigator " + o.length,
                        d = (n = t.options || {}).navigatorOptions || {},
                        p.dataLabels = co(p.dataLabels),
                        (h = ce(n, r, p, d)).pointRange = ci(p.pointRange, d.pointRange, dK.plotOptions[h.type || "line"].pointRange);
                    let u = d.data || p.data;
                    ...
                    (l.data && !(o && o.length) || d7(l)) && (i.hasNavigatorData = !1,
                        (l = co(l)).forEach((t, e) => {
                            r.name = "Navigator " + (a.length + 1),
                                (h = ce(dK.navigator.series, {
            ...
            addBaseSeriesEvents() {
                let t = this
                    , e = t.baseSeries || [];
                e[0] && e[0].xAxis && e[0].eventsToUnbind.push(d0(e[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)),
                    e.forEach(i => {
                        i.eventsToUnbind.push(d0(i, "show", function () {
                            this.navigatorSeries && this.navigatorSeries.setVisible(!0, !1)
                        })),
                            i.eventsToUnbind.push(d0(i, "hide", function () {
                                this.navigatorSeries && this.navigatorSeries.setVisible(!1, !1)
                            })),
                            !1 !== this.navigatorOptions.adaptToUpdatedData && i.xAxis && i.eventsToUnbind.push(d0(i, "updatedData", this.updatedDataHandler)),
                            i.eventsToUnbind.push(d0(i, "remove", function () {
                                e && d6(e, i),
                                    this.navigatorSeries && t.series && (d6(t.series, this.navigatorSeries),
                                        d3(this.navigatorSeries.options) && this.navigatorSeries.remove(!1),
            ...
            modifyBaseAxisExtremes() {
                let t, e, i = this.chart.navigator, s = this.getExtremes(), o = s.min, r = s.max, a = s.dataMin, n = s.dataMax, h = r - o, l = i.stickToMin, d = i.stickToMax, c = ci(this.ordinal?.convertOverscroll(this.options.overscroll), 0), p = i.series && i.series[0], u = !!this.setExtremes;
                !(this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger) && (l && (t = (e = a) + h),
                    ...
                    u && (l || d) && ct(e) && (this.min = this.userMin = e,
            ...
            updatedDataHandler() {
                ...
                t.stickToMax = ci(this.chart.options.navigator && this.chart.options.navigator.stickToMax, i),
            ...
            shouldStickToMin(t, e) {
                let i = e.getBaseSeriesMin(t.getColumn("x")[0])
                    ...
                    , a = s.options.range
                    , n = !0;
                return !!(ct(o) && ct(r)) && (a && o - i > 0 ? o - i < a : r <= i)
            }
            addChartEvents() {
                this.eventsToUnbind || (this.eventsToUnbind = []),
                    this.eventsToUnbind.push(d0(this.chart, "redraw", function () {
                        let t = this.navigator
                            , e = t && (t.baseSeries && t.baseSeries[0] && t.baseSeries[0].xAxis || this.xAxis[0]);
                        e && t.render(e.min, e.max)
                    }), d0(this.chart, "getMargins", function () {
                        let t = this.navigator
                    ...
                    }), d0(ca, "setRange", function (t) {
                        this.chart.xAxis[0].setExtremes(t.min, t.max, t.redraw, t.animation, t.eventArguments)
                    }))
            }
            destroy() {
                this.removeEvents(),
                    this.xAxis && (d6(this.chart.xAxis, this.xAxis),
                        d6(this.chart.axes, this.xAxis)),
                    this.yAxis && (d6(this.chart.yAxis, this.yAxis),
                        d6(this.chart.axes, this.yAxis)),
                    (this.series || []).forEach(t => {
                        t.destroy && t.destroy()
                    }
                    ),
        ...
        let { addEvent: cn, correctFloat: ch, css: cl, defined: cd, error: cc, isNumber: cp, pick: cu, timeUnits: cg, isString: cf } = ts;
        !function (t) {
            ...
            function a() {
                ...
                if (this.isXAxis && cd(e.overscroll) && 0 !== e.overscroll && cp(this.max) && cp(this.min) && (this.options.ordinal && !this.ordinal.originalOrdinalRange && this.ordinal.getExtendedPositions(!1),
                    this.max === this.dataMax && (t?.trigger !== "pan" || this.isInternal) && t?.trigger !== "navigator")) {
                    let i = this.ordinal.convertOverscroll(e.overscroll);
                    this.max += i,
                        !this.isInternal && cd(this.userMin) && t?.trigger !== "mousewheel" && (this.min += i)
                }
            }
            function n() {
            ...
            function l(t) {
                ...
                if (o?.type !== "y" && e.options.ordinal && e.series.length && (!t.touches || t.touches.length <= 1)) {
                    ...
                    r = !0;
                r || o && /y/.test(o.type) ? i && cp(e.dataMax) && (e.max = e.dataMax + i) : t.preventDefault()
            }
            function d() {
                let t = this.xAxis;
            ...
            t.compose = function (t, o, p) {
                ...
                return u.ordinal2lin || (u.getTimeTicks = e,
                    ...
                    cn(t, "afterInit", r),
                    cn(t, "foundExtremes", a),
                    cn(t, "afterSetScale", n),
                    cn(t, "initialAxisTranslation", h),
                    cn(p, "pan", l),
                    cn(p, "touchpan", l),
                    cn(o, "updatedData", d)),
                    t
                ...
                t.Additions = class {
                    ...
                    beforeSetTickPositions() {
                        ...
                        if (a || r) {
                            ...
                            if (t.series.forEach(function (t, e) {
                                ...
                                if (l = [],
                                    ...
                                    t.reserveSpace() && (!1 !== t.takeOrdinalPosition || r) && (h = (f = f.concat(s)).length,
                                        ...
                                        m = Math.min(m, cu(t.closestPointRange, m)),
                                        h)) {
                                    for (e = 0; e < h - 1;)
                            ...
                            x || t.forceOrdinal ? (t.options.overscroll && (e.overscrollPointsRange = m,
                                ...
                                e.slope = u = (o - s) / (p - c),
                                e.offset = s - c * u) : (e.overscrollPointsRange = cu(t.closestPointRange, e.overscrollPointsRange),
                    ...
                    getIndexOfPoint(t, e) {
                        let i = this.axis
                            , s = i.min
                            , r = i.minPixelPadding;
                        return o(e, s) + ch((t - r) / (i.translationSlope * (this.slope || i.closestPointRange || this.overscrollPointsRange)))
                    }
                    ...
                    postProcessTickInterval(t) {
                        let e, i = this.axis, s = this.slope, o = i.closestPointRange;
                        return s && o ? i.options.breaks ? o || t : t / (s / o) : t
                    }
                    convertOverscroll(t = 0) {
                        let e = this
                            , i = e.axis
                            , s = function (t) {
                                return cu(e.originalOrdinalRange, cd(i.dataMax) && cd(i.dataMin) ? i.dataMax - i.dataMin : 0) * t
                            };
                        if (cf(t)) {
                            let e, o = parseInt(t, 10);
                            if (cd(i.min) && cd(i.max) && cd(i.dataMin) && cd(i.dataMax) && ((e = i.max - i.min == i.dataMax - i.dataMin) || (this.originalOrdinalRange = i.max - i.min)),
                                /%$/.test(t))
                                return s(o / 100);
                            if (/px/.test(t)) {
                                let t = Math.min(o, .9 * i.len) / i.len;
                                return s(t / (e ? 1 - t : 1))
                            }
                            return 0
                        }
        ...
        let cm = T
            ...
            , { defaultOptions: cy } = tE
            , { composed: cb } = D
            , { addEvent: cv, defined: ck, extend: cM, isNumber: cw, merge: cS, pick: cA, pushUnique: cT } = ts
            , cC = [];
        function cP() {
            ...
            let n = cA(this.dataMin, Number.MIN_VALUE);
            return cw(t) || (t = n),
                t <= n && (t = n,
                    void 0 === e && (e = a(t, i.count)),
                    this.newMax = Math.min(t + e, cA(this.dataMax, Number.MAX_VALUE))),
                cw(o) ? !cw(i) && i && i._offsetMin && (t += i._offsetMin) : t = void 0,
                t
        }
        function cO() {
        ...
        function cL() {
            ...
            if (t) {
                cw(t.deferredYTDClick) && (t.clickButton(t.deferredYTDClick),
        ...
        function cD() {
            ...
            cw(i.min) && e.render(i.min, i.max),
                s.display && "top" === o && o === s.options.verticalAlign && (t = cS(this.spacingBox),
                    "vertical" === s.options.layout ? t.y = this.plotTop : t.y += e.getHeight(),
                    s.group.placed = !1,
                    s.align(t))
        }
        function cB() {
            for (let t = 0, e = cC.length; t < e; ++t) {
                let e = cC[t];
                if (e[0] === this) {
                    e[1].forEach(t => t()),
                        cC.splice(t, 1);
        ...
        function cz(t) {
            ...
            if (e && e.enabled && !ck(r) && this.options.rangeSelector && (this.options.rangeSelector.enabled = !0,
        ...
        let cR = {
            compose: function (t, e, i) {
                if (s = i,
                    cT(cb, "RangeSelector")) {
                    let i = e.prototype;
                    t.prototype.minFromRange = cP,
                        cv(e, "afterGetContainer", cE),
                        cv(e, "beforeRender", cL),
                        cv(e, "destroy", cB),
                        cv(e, "getMargins", cI),
                        cv(e, "redraw", cD),
                        cv(e, "update", cz),
                        cv(e, "beforeRedraw", cO),
                        i.callbacks.push(cD),
                        cM(cy, {
                            rangeSelector: cx.rangeSelector
                        }),
                        cM(cy.lang, cx.lang)
                }
            }
        }
            , { defaultOptions: cN } = tE
            , { format: cW } = eM
            , { addEvent: cG, createElement: cX, css: cH, defined: cF, destroyObjectProperties: cY, diffObjects: cj, discardElement: cU, extend: cV, fireEvent: c$, isNumber: c_, isString: cZ, merge: cq, objectEach: cK, pick: cJ, splat: cQ } = ts;
        function c0(t) {
            let e = e => RegExp(`%[[a-zA-Z]*${e}`).test(t);
            if (cZ(t) ? -1 !== t.indexOf("%L") : t.fractionalSecondDigits)
                return "text";
            let i = cZ(t) ? ["a", "A", "d", "e", "w", "b", "B", "m", "o", "y", "Y"].some(e) : t.dateStyle || t.day || t.month || t.year
                , s = cZ(t) ? ["H", "k", "I", "l", "M", "S"].some(e) : t.timeStyle || t.hour || t.minute || t.second;
        ...
        class c1 {
            ...
            clickButton(t, e) {
                let i = this.chart, s = this.buttonOptions[t], o = i.xAxis[0], r = i.scroller && i.scroller.getUnionExtremes() || o || {}, a = s.type, n = s.dataGrouping, h = r.dataMin, l = r.dataMax, d, c = c_(o?.max) ? Math.round(Math.min(o.max, l ?? o.max)) : void 0, p, u = s._range, g, f, m, x = !0;
                if (null !== h && null !== l) {
                    if (this.setSelected(t),
                        n && (this.forcedDataGrouping = !0,
                            s2.prototype.setDataGrouping.call(o || {
                                chart: this.chart
                            }, n, !1),
                        ...
                        o ? (f = {
                            ...
                            c_(f.newMax) && (c = f.newMax),
                            x = !1) : u = s;
                    else if (u)
                        c_(c) && (c = Math.min((d = Math.max(c - u, h)) + u, l),
                            x = !1);
                    else if ("ytd" === a)
                        if (o)
                            !o.hasData() || c_(l) && c_(h) || (h = Number.MAX_VALUE,
                                l = -Number.MAX_VALUE,
                                i.series.forEach(t => {
                                    let e = t.getColumn("x");
                                ...
                                e = !1),
                                c_(l) && c_(h) && (d = g = (m = this.getYTDExtremes(l, h)).min,
                                    c = m.max);
                        else {
                        ...
                        "all" === a && o && (i.navigator && i.navigator.baseSeries[0] && (i.navigator.baseSeries[0].xAxis.options.range = void 0),
                            d = h,
                            c = l);
                    if (x && s._offsetMin && cF(d) && (d += s._offsetMin),
                        s._offsetMax && cF(c) && (c += s._offsetMax),
                        this.dropdown && (this.dropdown.selectedIndex = t + 1),
                        o)
                        c_(d) && c_(c) && (o.setExtremes(d, c, cJ(e, !0), void 0, {
                        ...
                        let t = cG(i, "afterCreateAxes", function () {
                            let t = i.xAxis[0];
            ...
            init(t) {
                ...
                e.chart = t,
                    ...
                    e.buttonOptions = o.map(t => (t.type && s.rangeSelector && (t.text ?? (t.text = s.rangeSelector[`${t.type}Text`]),
                        ...
                        t)),
                    this.eventsToUnbind = [],
                    this.eventsToUnbind.push(cG(t.container, "mousedown", a)),
                    this.eventsToUnbind.push(cG(t, "resize", a)),
                    o.forEach(e.computeButtonRange),
                    void 0 !== r && o[r] && this.clickButton(r, !1),
                    this.eventsToUnbind.push(cG(t, "load", function () {
                        t.xAxis && t.xAxis[0] && cG(t.xAxis[0], "setExtremes", function (i) {
                            c_(this.max) && c_(this.min) && this.max - this.min !== t.fixedRange && "rangeSelectorButton" !== i.trigger && "updatedData" !== i.trigger && e.forcedDataGrouping && !e.frozenStates && this.setDataGrouping(!1, !1)
                        })
                    })),
                    this.createElements()
            }
                ...
                t.buttonOptions.forEach((e, i) => {
                    ...
                    if (k && M && (b = !0),
                        ...
                        let t = o.ordinal.positions
                            , e = cm.Additions.findIndexOf(t, o.min, !0)
                            , i = Math.min(cm.Additions.findIndexOf(t, o.max, !0) + 1, t.length - 1);
                        t[i] - t[e] > s && (A = !0)
                    } else
                    ...
                    null !== v ? (m[v] = 2,
                        ...
                        this.dropdown && (this.dropdown.selectedIndex = v + 1)) : (t.setSelected(),
                            ...
                            s && (s.setState(0),
                                s.attr({
                                    text: (cN.lang.rangeSelectorZoom || "") + " ▾"
                                })));
            ...
            computeButtonRange(t) {
                ...
                s[e] ? t._range = s[e] * i : ("month" === e || "year" === e) && (t._range = 24 * ({
                    ...
                    t._offsetMin = cJ(t.offsetMin, 0),
                    t._offsetMax = cJ(t.offsetMax, 0),
            ...
            setInputValue(t, e) {
                ...
                if (o) {
                    o.setAttribute("type", c0(i.inputDateFormat || "%e %b %Y"));
                    let t = o.getAttribute("data-hc-time")
                        , a = cF(t) ? Number(t) : void 0;
                    if (cF(e)) {
                        let t = a;
                        cF(t) && o.setAttribute("data-hc-time-previous", t),
            ...
            drawInput(t) {
                ...
                function d(t) {
                    let { maxInput: i, minInput: s } = o
                        ...
                        , c = o.getInputValue(t);
                    c_(c) && c !== d && (l && i && c_(n) ? c > Number(i.getAttribute("data-hc-time")) ? c = void 0 : c < n && (c = n) : s && c_(h) && (c < Number(s.getAttribute("data-hc-time")) ? c = void 0 : c > h && (c = h)),
                ...
                g.setAttribute("type", c0(n.inputDateFormat || "%e %b %Y")),
                    e.styledMode || (p.css(cq(r, n.labelStyle)),
                        u.css(cq({
                            color: "#333333"
                        }, r, n.inputStyle)),
                        cH(g, cV({
            ...
            renderButtons() {
                ...
                let n = this.dropdown = cX("select", void 0, {
                    position: "absolute",
                    padding: 0,
                    border: 0,
                    cursor: "pointer",
                ...
                this.dropdownLabel = o.button("", 0, 0, () => { }
                    , cq(r, {
                        "stroke-width": cJ(r["stroke-width"], 0),
                        width: "auto",
                        paddingLeft: cJ(i.buttonTheme.paddingLeft, h?.padding, 8),
                        paddingRight: cJ(i.buttonTheme.paddingRight, h?.padding, 8)
                    }), a && a.hover, a && a.select, a && a.disabled).hide().add(this.group),
                    cG(n, "touchstart", () => {
                        n.style.fontSize = "16px"
                    }
                    );
                let l = D.isMS ? "mouseover" : "mouseenter"
                    , d = D.isMS ? "mouseout" : "mouseleave";
                cG(n, l, () => {
                    c$(this.dropdownLabel.element, l)
                }
                ),
                    cG(n, d, () => {
                        c$(this.dropdownLabel.element, d)
                    }
                    ),
                    cG(n, "change", () => {
                        c$(this.buttons[n.selectedIndex - 1].element, "click")
                    }
                    ),
            ...
            alignElements() {
                ...
                if (s && l && d) {
                    ...
                    if ("bottom" === c) {
                        ...
                        m = g - (f = f + (t && "bottom" === t.verticalAlign && t.enabled && !t.floating ? i.legend.legendHeight + cJ(t.margin, 10) : 0) - 20) - (r.floating ? 0 : r.y) - (i.titleOffset ? i.titleOffset[2] : 0) - 10
                    }
            ...
            redrawElements() {
                ...
                if (this.maxDateBox?.attr({
                    ...
                    for (let s = e - 1; s >= 0; s--)
                        if (0 !== Object.keys(cj(t[s], this.buttonOptions[s])).length) {
                            let e = t[s];
                    ...
                    this.buttonOptions = this.options.buttons ?? [],
                        cF(this.options.selected) && this.buttons.length && this.clickButton(this.options.selected, !1)
                }
            }
            alignButtonGroup(t, e) {
                ...
                "right" === n.align ? (l += t - h,
                    ...
                    o && o.align({
                        y: n.y,
                        width: cJ(e, this.initialButtonGroupWidth),
                        align: n.align,
                        x: l
                    }, !0, i.spacingBox)
            }
            ...
            handleCollision(t) {
                ...
                s && i ? n.align === r.align ? (h(),
                    o > e.plotWidth + t - 20 ? this.collapseButtons() : this.expandButtons()) : o - t + s.getBBox().width > e.plotWidth ? "responsive" === a ? this.collapseButtons() : h() : this.expandButtons() : i && "responsive" === a && (o > e.plotWidth ? this.collapseButtons() : this.expandButtons()),
            ...
            destroy() {
                ...
                t.eventsToUnbind && (t.eventsToUnbind.forEach(t => t()),
                    ...
                    cK(t, function (e, i) {
                        e && "chart" !== i && (e instanceof e8 ? e.destroy() : e instanceof window.HTMLElement && cU(e),
                            delete t[i]),
                            e !== c1.prototype[i] && (t[i] = null)
                    }, this),
                    this.buttons = []
            }
        }
        ...
        let { format: c2 } = eM
            , { getOptions: c3 } = tE
            , { setFixedRange: c5 } = db
            , { addEvent: c6, clamp: c9, crisp: c4, defined: c8, extend: c7, find: pt, isNumber: pe, isString: pi, merge: ps, pick: po, splat: pr } = ts;
        function pa(t, e, i) {
            return "xAxis" === t ? {
                minPadding: 0,
                maxPadding: 0,
        ...
        function pn(t, e) {
            if ("xAxis" === t) {
                let t = po(e.navigator?.enabled, df.enabled, !0)
                    , i = {
                        type: "datetime",
                        categories: void 0
                    };
        ...
        class ph extends ne {
            init(t, e) {
                let i = c3()
                    , s = t.xAxis
                    , o = t.yAxis
                    , r = po(t.navigator?.enabled, df.enabled, !0);
                ...
                let a = ps({
                    ...
                    scrollbar: {
                        enabled: po(dR.enabled, !0)
                    },
                    rangeSelector: {
                        enabled: po(cx.rangeSelector.enabled, !0)
                    },
                    title: {
                        text: null
                    },
                    tooltip: {
                        split: po(i.tooltip?.split, !0),
                        crosshairs: !0
                    },
                    legend: {
                        enabled: !1
                ...
                t.xAxis = s,
                    t.yAxis = o,
                    a.xAxis = pr(t.xAxis || {}).map(e => ps(pa("xAxis", e, i.xAxis), e, pn("xAxis", t))),
                    a.yAxis = pr(t.yAxis || {}).map(t => ps(pa("yAxis", t, i.yAxis), t)),
                    super.init(a, e)
            }
            createAxis(t, e) {
                return e.axis = ps(pa(t, e.axis, c3()[t]), e.axis, pn(t, this.userOptions)),
                    super.createAxis(t, e)
            }
        }
        c6(ne, "update", function (t) {
            let e = t.options;
            "scrollbar" in e && this.navigator && (ps(!0, this.options.scrollbar, e.scrollbar),
            ...
            function (t) {
                function e(t) {
                    if (!(this.crosshair?.label?.enabled && this.cross && pe(this.min) && pe(this.max)))
                        return;
                    ...
                    !u && (u = this.crossLabel = e.renderer.label("", 0, void 0, s.shape || "callout").addClass("highcharts-crosshair-label highcharts-color-" + (p?.series ? p.series.colorIndex : this.series[0] && this.series[0].colorIndex)).attr({
                        align: s.align || M,
                        padding: po(s.padding, 8),
                        r: po(s.borderRadius, 3),
                        zIndex: 2
                    }).add(this.labelGroup),
                        e.styledMode || u.attr({
                    ...
                    let w = d ? this.isXAxis ? p.x : p.y : this.toValue(o ? c.chartX : c.chartY)
                        , S = p?.series ? p.series.isPointInside(p) : pe(w) && w > v && w < k
                        , A = "";
                    m ? A = c2(m, {
                        value: w
                    }, e) : s.formatter && pe(w) && (A = s.formatter.call(this, w)),
                        u.attr({
                            text: A,
                            x: g,
                            y: f,
                    ...
                    let T = u.getBBox();
                    !pe(u.x) || o || r || (g = u.x - T.width / 2),
                        pe(u.y) && (o ? (l && !r || !l && r) && (f = u.y - T.height) : f = u.y - T.height / 2),
                        y = o ? {
                            left: a,
                            right: a + this.width
                        } : {
                ...
                function r(t) {
                    let e = this
                        ...
                        , c = (e.isXAxis ? s.yAxis : s.xAxis) || [];
                    function p(t, e, i) {
                        a.push(["M", o ? t : e, o ? e : t], ["L", o ? t : i, o ? i : t])
                    }
                    let u = [], g, f;
                    if (s.options.isStock && ("xAxis" === e.coll || "yAxis" === e.coll)) {
                        for (let o of (t.preventDefault(),
                            u = (t => {
                                let o = "xAxis" === t ? "yAxis" : "xAxis"
                                    , r = e.options[o];
                                return n && !e.options.isInternal ? c.filter(t => !t.options.isInternal) : pe(r) ? [s[o][r]] : pi(r) ? [s.get(r)] : i.map(t => t[o])
                            }
                            )(e.coll),
                            c))
                            if (!o.options.isInternal) {
                                let t = o.isXAxis ? "yAxis" : "xAxis";
                                e === (c8(o.options[t]) && s[t][o.options[t]]) && u.push(o)
                            }
                        for (let t of (g = u.length ? [] : [e.isXAxis ? s.yAxis[0] : s.xAxis[0]],
                            u))
                            -1 !== g.indexOf(t) || pt(g, e => e.pos === t.pos && e.len === t.len) || g.push(t);
                        if (pe(f = po(l, e.translate(d || 0, void 0, void 0, t.old)))) {
                            let t, i = o ? f + e.pos : e.pos + e.len - f;
                            if ("pass" !== h && (i < e.pos || i > e.pos + e.len) && (h ? i = c9(i, e.pos, e.pos + e.len) : t = !0),
                                !t) {
                                let t = o ? "top" : "left"
                                    , s = o ? "height" : "width";
                                if (!n && (e.options[t] || e.options[s]))
                                    p(i, e[t], e[t] + e[s]);
                                else
                                    for (let t of g)
                                        p(i, t.pos, t.pos + t.len)
                            }
                        }
                ...
                function a(t) {
                    if (this.chart.options.isStock) {
                        ...
                        this.is("column") || this.is("columnrange") ? e = {
                            ...
                            e && (t.plotOptions[this.type] = ps(t.plotOptions[this.type], e))
                    }
                }
                function n() {
                    let t = this.chart
                        , e = this.options.dataGrouping;
                    return !1 !== this.allowDG && e && po(e.enabled, t.options.isStock)
                }
                function h(t, e) {
                    for (let i = 0; i < t.length; i += 2) {
                        let s = t[i]
                            , o = t[i + 1];
                        c8(s[1]) && s[1] === o[1] && (s[1] = o[1] = c4(s[1], e)),
                            c8(s[2]) && s[2] === o[2] && (s[2] = o[2] = c4(s[2], e))
                    }
                    return t
                }
                t.compose = function (t, l, d, c) {
                    let p = d.prototype;
                    p.forceCropping || (c6(l, "afterDrawCrosshair", e),
                        c6(l, "afterHideCrosshair", i),
                        c6(l, "autoLabelAlign", s),
                        c6(l, "destroy", o),
                        c6(l, "getPlotLinePath", r),
                        t.prototype.setFixedRange = c5,
                        p.forceCropping = n,
                        c6(d, "setOptions", a),
        ...
        let pl = ph
            , { column: { prototype: { pointClass: pd } } } = rL.seriesTypes
            , { column: pc } = rL.seriesTypes
            , { crisp: pp, extend: pu, merge: pg } = ts
            , { defaultOptions: pf } = tE;
        class pm extends pc {
            extendStem(t, e, i) {
                let s = t[0]
                    , o = t[1];
        ...
        pm.defaultOptions = pg(pc.defaultOptions, {
            lineWidth: 1,
            tooltip: {
            ...
            rL.registerSeriesType("hlc", pm);
        let { seriesTypes: { hlc: px } } = rL;
        class py extends px.prototype.pointClass {
            getClassName() {
        ...
        let { composed: pb } = D
            , { hlc: pv } = rL.seriesTypes
            , { addEvent: pk, crisp: pM, extend: pw, merge: pS, pushUnique: pA } = ts;
        function pT(t) {
            let e = t.options
                , i = e.dataGrouping;
        ...
        function pC(t) {
            let e = t.options;
            e.useOhlcData && "highcharts-navigator-series" !== e.id && pw(this, {
                pointValKey: pP.prototype.pointValKey,
                pointArrayMap: pP.prototype.pointArrayMap,
                toYData: pP.prototype.toYData
            })
        }
        class pP extends pv {
            static compose(t, ...e) {
                pA(pb, "OHLCSeries") && (pk(t, "afterSetOptions", pT),
                    pk(t, "init", pC))
            }
            getPointPath(t, e) {
        ...
        pP.defaultOptions = pS(pv.defaultOptions, {
            tooltip: {
            ...
            rL.registerSeriesType("ohlc", pP);
        let { column: pO, ohlc: pE } = rL.seriesTypes
            , { crisp: pL, merge: pD } = ts;
        class pB extends pE {
            pointAttribs(t, e) {
                let i = pO.prototype.pointAttribs.call(this, t, e)
                    , s = this.options
                    , o = t.open < t.close
        ...
        pB.defaultOptions = pD(pE.defaultOptions, {
            tooltip: pE.defaultOptions.tooltip
        }, {
            states: {
                hover: {
                    lineWidth: 2
            ...
            rL.registerSeriesType("candlestick", pB);
        let { column: { prototype: { pointClass: pI } } } = rL.seriesTypes
            , { isNumber: pz } = ts
            , pR = class extends pI {
                constructor() {
                    super(...arguments),
                ...
                isValid() {
                    return pz(this.y) || void 0 === this.y
                }
                hasNewShapeType() {
        ...
        let pN = C
            ...
            , { prototype: pG } = hp
            , { prototype: pX } = ae
            , { defined: pH, pushUnique: pF, stableSort: pY } = ts;
        !function (t) {
            function e(t) {
                return pX.getPlotBox.call(this.options.onSeries && this.chart.get(this.options.onSeries) || this, t)
            }
            function i() {
                pG.translate.apply(this);
                ...
                s.forEach((e, i) => {
                    ...
                    e.plotX += m,
                        (void 0 === e.plotY || h) && (e.plotX >= 0 && e.plotX <= l.len ? h ? (e.plotY = l.translate(e.x, 0, 1, 0, 1),
                            e.plotX = pH(e.y) ? d.translate(e.y, 0, 0, 0, 1) : 0) : e.plotY = (l.opposite ? 0 : t.yAxis.len) + l.offset : e.shapeArgs = {}),
        ...
        let pj = P
            , { noop: pU } = D
            , { distribute: pV } = eP
            , { series: p$, seriesTypes: { column: p_ } } = rL
            , { addEvent: pZ, defined: pq, extend: pK, isNumber: pJ, merge: pQ, objectEach: p0, wrap: p1 } = ts;
        class p2 extends p_ {
            animate(t) {
                t && this.setClip()
            }
            drawPoints() {
                let t, e, i, s, o, r, a, n, h, l, d, c = this.points, p = this.chart, u = p.renderer, g = p.inverted, f = this.options, m = f.y, x = this.yAxis, y = {}, b = [], v = pJ(f.borderRadius) ? f.borderRadius : 0;
                for (s = c.length; s--;)
                    o = c[s],
                        ...
                        void 0 !== e && t >= 0 && !l ? (r && o.hasNewShapeType() && (r = r.destroy()),
                            r || (r = o.graphic = u.label("", 0, void 0, i, void 0, void 0, f.useHTML).addClass("highcharts-point").add(this.markerGroup),
                            ...
                            p.styledMode || r.attr(this.pointAttribs(o)).css(pQ(f.style, o.style)).shadow(f.shadow),
                ...
                if (!f.allowOverlapX) {
                    let t = 100;
                    for (let e of (p0(y, function (e) {
                        e.plotX = e.anchorX,
                            b.push(e),
                            t = Math.max(e.size, t)
                    }),
                        pV(b, g ? x.len : this.xAxis.len, t),
                        c)) {
                        let t = e.plotX
                            , i = e.graphic
                            , s = i && y[t];
                        s && i && (pq(s.pos) ? i[i.isNew ? "attr" : "animate"]({
                            x: s.pos + (s.align || 0) * s.size,
                            anchorX: e.anchorX
                        }).show().isNew = !1 : i.hide().isNew = !0)
                    }
                }
                f.useHTML && this.markerGroup && p1(this.markerGroup, "on", function (t) {
                    return e8.prototype.on.apply(t.apply(this, [].slice.call(arguments, 1)), [].slice.call(arguments, 1))
                })
            }
            drawTracker() {
                let t = this.points;
                for (let e of (super.drawTracker(),
                    ...
                    i && (e.unbindMouseOver && e.unbindMouseOver(),
                        e.unbindMouseOver = pZ(i.element, "mouseover", function () {
        ...
        p2.compose = pN.compose,
            p2.defaultOptions = pQ(p_.defaultOptions, {
                borderRadius: 0,
                pointRange: 0,
                allowOverlapX: !1,
                shape: "flag",
            ...
            rL.registerSeriesType("flags", p2);
        let { addEvent: p3, find: p5, fireEvent: p6, isArray: p9, isNumber: p4, pick: p8 } = ts;
        !function (t) {
            function e() {
            ...
            function a() {
                this.drawBreaks(this.xAxis, ["x"]),
                    this.drawBreaks(this.yAxis, p8(this.pointArrayMap, ["y"]))
            }
            function n(t, e) {
                ...
                if (t?.brokenAxis?.hasBreaks) {
                    ...
                    e.forEach(function (e) {
                        i = n?.breakArray || [],
                            s = t.isXAxis ? t.min : p8(r.options.threshold, t.min),
                        ...
                        if (a && !1 !== a.visible || (a = i[r + 1]),
                            ...
                            if (a.x - t.x > o) {
                                ...
                                i.splice(r + 1, 0, {
                                    ...
                                    s.stacking && this.options.stacking && ((s.stacking.stacks[this.stackKey][e] = new nk(s, s.options.stackLabels, !1, e, this.stack)).total = 0)
                            }
                            a = t
                        }
                }
            ...
            t.compose = function (t, l) {
                if (!t.keepProps.includes("brokenAxis")) {
                    t.keepProps.push("brokenAxis"),
                        p3(t, "init", o),
                        p3(t, "afterInit", e),
                        p3(t, "afterSetTickPositions", s),
                        p3(t, "afterSetOptions", i);
                    let d = l.prototype;
                    d.drawBreaks = n,
                        d.gappedPath = h,
                        p3(l, "afterGeneratePoints", r),
                        p3(l, "afterRender", a)
                }
                return t
            }
            ...
            class l {
                static isInBreak(t, e) {
                    let i, s = t.repeat || 1 / 0, o = t.from, r = t.to - t.from, a = e >= o ? (e - o) % s : s - (o - e) % s;
                    return t.inclusive ? a <= r : a < r && 0 !== a
                }
                static lin2Val(t) {
                    let e = this.min || 0
                        , i = this.brokenAxis
                    ...
                    if (o && p4(t)) {
                        for (; o--;)
                            l.isInBreak(s[o], t) && (r = !0,
                                a || (a = p8(s[o].showPoints, !i.isXAxis)));
                        n = r && e ? r && !a : r
                    }
                    return n
                }
                setBreaks(t, e) {
                    ...
                    s.isDirty = (i.hasBreaks ?? !1) !== r,
                        ...
                        r && (s.userOptions.ordinal = !1,
                            ...
                            s.setAxisTranslation = function () {
                                if (s.constructor.prototype.setAxisTranslation.call(this),
                                    ...
                                    p4(s.threshold) && (p = Math.min(p ?? s.threshold, s.threshold),
                                        u = Math.max(u ?? s.threshold, s.threshold)),
                                        s.treeGrid?.tree || t.forEach(function (t) {
                                            h = t.repeat || 1 / 0,
                                                p4(d) && p4(c) && (l.isInBreak(t, d) && (d += t.to % h - d % h),
                                                    l.isInBreak(t, c) && (c -= c % h - t.from % h))
                                        }),
                                        p4(p) && p4(u) && t.forEach(function (t) {
                                            for (g = t.from,
                                        ...
                                        e.forEach(t => {
                                            1 === (n += "in" === t.move ? 1 : -1) && "in" === t.move && (g = t.value),
                                                0 === n && p4(g) && (o.push({
                                                    ...
                                                    p4(d) && p4(c) && g < c && t.value > d && (a += t.value - g - (t.size || 0)))
                                        }
                                        ),
                                        i.breakArray = o,
                                        p4(d) && p4(c) && p4(s.min) && (i.unitLength = c - d - a + r,
                                            p6(s, "afterBreaks"),
                        ...
                        p8(e, !0) && s.chart.redraw()
                }
            }
            t.Additions = l
        }(O || (O = {}));
        let p7 = O;
        D.BrokenAxis = D.BrokenAxis || p7,
            D.BrokenAxis.compose(D.Axis, D.Series);
        let ut = {}
            , { arrayMax: ue, arrayMin: ui, correctFloat: us, extend: uo, isNumber: ur } = ts;
        function ua(t) {
            let e = t.length
                , i = un(t);
            return ur(i) && e && (i = us(i / e)),
                i
        }
        function un(t) {
            let e = t.length, i;
        ...
        let uh = {
            ...
            high: function (t) {
                return t.length ? ue(t) : t.hasNulls ? null : void 0
            },
            hlc: function (t, e, i) {
                if (t = ut.high(t),
                    e = ut.low(e),
            ...
            low: function (t) {
                return t.length ? ui(t) : t.hasNulls ? null : void 0
            },
            ...
            range: function (t, e) {
                return (t = ut.low(t),
                    e = ut.high(e),
                    ur(t) || ur(e)) ? [t, e] : null === t && null === e ? null : void 0
            },
            sum: un
        };
        uo(ut, uh);
        let ul = {
            ...
            , { addEvent: ud, extend: uc, merge: up, pick: uu } = ts;
        function ug(t) {
            let e = this
                , i = e.series;
            i.forEach(function (t) {
        ...
        function uf() {
            ...
            for (; e--;)
                (r = t[e].options.dataGrouping) && (i = Math.max(i, uu(r.groupPixelWidth, ul.common.groupPixelWidth)),
                    o = (t[e].dataTable.modified || t[e].dataTable).rowCount,
        ...
        function ux(t, e) {
            ...
            if (e = uu(e, !0),
                ...
                this.chart.options.series.forEach(function (e) {
                    e.dataGrouping = "boolean" == typeof t ? t : up(t, e.dataGrouping)
                });
        ...
        let uy = {
            compose: function (t) {
                o = t;
                let e = t.prototype;
                e.applyGrouping || (ud(t, "afterSetScale", um),
                    ud(t, "postProcessData", ug),
                    uc(e, {
                        applyGrouping: ug,
                        getGroupPixelWidth: uf,
                        setDataGrouping: ux
                    }))
            }
        }
            , { series: { prototype: ub } } = rL
            , { addEvent: uv, defined: uk, error: uM, extend: uw, isNumber: uS, merge: uA, pick: uT, splat: uC } = ts
            , uP = ub.generatePoints;
        function uO(t) {
            var e, i, s;
            let o, r, a = this.chart, n = this.options.dataGrouping, h = !1 !== this.allowDG && n && uT(n.enabled, a.options.isStock), l = this.reserveSpace(), d = this.currentDataGrouping, c, p, u = !1;
            ...
            let f = n.groupAll ? this.dataTable : this.dataTable.modified || this.dataTable
            ...
            if (k && m && f.rowCount && x && uS(b.min)) {
                ...
                let t = b.min
                    ...
                    , h = k * (e - t) / x * i
                    , d = y.getTimeTicks(s4.Additions.prototype.normalizeTimeTickInterval(h, n.units || ul.units), Math.min(t, m[0]), Math.max(e, m[m.length - 1]), y.options.startOfWeek, m, this.closestPointRange)
                    , u = ub.groupData.apply(this, [f, d, n.approximation])
                    , g = u.modified
                    , M = g.getColumn("x", !0)
                    , w = 0;
                ...
                (c = d.info).gapSize = w,
                    ...
                    l && M && (uk((s = M)[0]) && uS(y.min) && uS(y.dataMin) && s[0] < y.min && ((!uk(y.options.min) && y.min <= y.dataMin || y.min === y.dataMin) && (y.min = Math.min(s[0], y.min)),
                        y.dataMin = Math.min(s[0], y.dataMin)),
                        uk(s[s.length - 1]) && uS(y.max) && uS(y.dataMax) && s[s.length - 1] > y.max && ((!uk(y.options.max) && uS(y.dataMax) && y.max >= y.dataMax || y.max === y.dataMax) && (y.max = Math.max(s[s.length - 1], y.max)),
        ...
        function uB(t, e, i) {
            let s = t.getColumn("x", !0) || [], o = t.getColumn("y", !0), r = this, a = r.data, n = r.options && r.options.data, h = [], l = new rM, d = [], c = t.rowCount, p = !!o, u = [], g = r.pointArrayMap, f = g && g.length, m = ["x"].concat(g || ["y"]), x = (g || ["y"]).map(() => []), y = this.options.dataGrouping && this.options.dataGrouping.groupAll, b, v, k, M = 0, w = 0, S = "function" == typeof i ? i : i && ut[i] ? ut[i] : ut[r.getDGApproximation && r.getDGApproximation() || "average"];
            if (f) {
                let t = g.length;
                for (; t--;)
                    u.push([])
                ...
                if (!(s[t] < e[0])) {
                    for (; void 0 !== e[M + 1] && s[t] >= e[M + 1] || t === c;) {
                        if (b = e[M],
                            ...
                            k = S.apply(r, u),
                            r.pointClass && !uk(r.dataGroupInfo.options) && (r.dataGroupInfo.options = uA(r.pointClass.prototype.optionsToObject.call({
                                series: r
                    ...
                    if (g) {
                        ...
                        for (let t = 0; t < f; t++)
                            uS(e = s[g[t]]) ? u[t].push(e) : null === e && (u[t].hasNulls = !0)
                    } else
                        uS(v = p ? o[t] : null) ? u[0].push(v) : null === v && (u[0].hasNulls = !0)
                }
            let T = {
                x: h
            };
        ...
        function uI(t) {
            let e = t.options
                ...
                , o = this.useCommonDataGrouping && ul.common
                , r = ul.seriesSpecific
                , a = tE.defaultOptions.plotOptions[i].dataGrouping;
            if (s && (r[i] || o)) {
                let t = this.chart.rangeSelector;
                a || (a = uA(ul.common, r[i])),
                    e.dataGrouping = uA(o, a, s.series && s.series.dataGrouping, s[i].dataGrouping, this.userOptions.dataGrouping, !e.isInternal && t && uS(t.selected) && t.buttonOptions[t.selected].dataGrouping)
            }
        }
        let uz = {
            compose: function (t) {
                let e = t.prototype;
                e.applyGrouping || (uv(t.prototype.pointClass, "update", function () {
                    if (this.dataGroup)
                        return uM(24, !1, this.series.chart),
                            !1
                }),
                    uv(t, "afterSetOptions", uI),
                    uv(t, "destroy", uE),
                    uw(e, {
                        applyGrouping: uO,
                        destroyGroupedData: uE,
                        generatePoints: uL,
            ...
            , { format: uR } = eM
            , { composed: uN } = D
            , { addEvent: uW, extend: uG, isNumber: uX, pick: uH, pushUnique: uF } = ts;
        function uY(t) {
            ...
            if (h && "datetime" === h.options.type && n && uX(s.key)) {
                c = o.currentDataGrouping,
                    p = n.dateTimeLabelFormats || ul.common.dateTimeLabelFormats,
                    c ? (u = p[c.unitName],
                        1 === c.count ? l = u[0] : (l = u[1],
                            d = u[2])) : !l && p && h.dateTime && (l = h.dateTime.getXDateFormat(s.x, a.dateTimeLabelFormats));
                let r = uH(o.groupMap?.[s.index].groupStart, s.key)
        ...
        let uj = {
            compose: function (t, e, i) {
                uy.compose(t),
                    uz.compose(e),
                    i && uF(uN, "DataGrouping") && uW(i, "headerFormatter", uY)
            },
            groupData: uz.groupData
        };
        D.dataGrouping = D.dataGrouping || {},
            D.dataGrouping.approximationDefaults = D.dataGrouping.approximationDefaults || uh,
            D.dataGrouping.approximations = D.dataGrouping.approximations || ut,
            uj.compose(D.Axis, D.Series, D.Tooltip);
        let { defined: uU, isNumber: uV, pick: u$ } = ts
            , u_ = {
            ...
            , { addEvent: uZ, isObject: uq, pick: uK, defined: uJ, merge: uQ } = ts
            , { getAssignedAxis: u0 } = {
                annotationsFieldsTypes: u_,
                getAssignedAxis: function (t) {
                    return t.filter(t => {
                        let e = t.axis.getExtremes()
                            , i = e.min
                            , s = e.max
                            , o = u$(t.axis.minPointOffset, 0);
                        return uV(i) && uV(s) && t.value >= i - o && t.value <= s + o && !t.axis.options.isInternal
                    }
                    )[0]
                },
            ...
            , u3 = t => (uq(t) || (t = {
                ...
                uQ(u2, t))
            , u5 = function (t, e, i, s, o, a, n) {
                let h = uK(n.type, t.zooming.type, "")
                    , l = [];
        ...
        function u6() {
            let t = u3(this.zooming.mouseWheel);
            t.enabled && uZ(this.container, "wheel", e => {
                ...
                if (this.isInsidePlot(e.chartX - this.plotLeft, e.chartY - this.plotTop) && s) {
                    let s = t.sensitivity || 1.1
                        ...
                        , r = u0(i.getCoordinates(e).xAxis)
                        , a = u0(i.getCoordinates(e).yAxis);
                    u5(this, Math.pow(s, o), r ? [r.axis] : this.xAxis, a ? [a.axis] : this.yAxis, e.chartX, e.chartY, t) && e.preventDefault?.()
                }
            }
            )
        }
        D.MouseWheelZoom = D.MouseWheelZoom || {
            compose: function (t) {
                -1 === u1.indexOf(t) && (u1.push(t),
                    uZ(t, "afterGetContainer", u6))
            }
        },
            D.MouseWheelZoom.compose(D.Chart),
            D.Navigator = D.Navigator || ca,
            D.OrdinalAxis = D.OrdinalAxis || cm,
            D.RangeSelector = D.RangeSelector || c1,
            D.Scrollbar = D.Scrollbar || dq,
            D.stockChart = D.stockChart || pl.stockChart,
            D.StockChart = D.StockChart || D.stockChart,
            D.extend(D.StockChart, pl),
            lQ.compose(D.Series, D.Axis, D.Point),
            p2.compose(D.Renderer),
            pP.compose(D.Series),
            D.Navigator.compose(D.Chart, D.Axis, D.Series),
            D.OrdinalAxis.compose(D.Axis, D.Series, D.Chart),
            D.RangeSelector.compose(D.Axis, D.Chart),
            D.Scrollbar.compose(D.Axis),
            D.StockChart.compose(D.Chart, D.Axis, D.Series, D.SVGRenderer),
            D.product = "Highstock";
        let u9 = D;
        return L.default
    }
